        ...
        if ($_REQUEST['re']=='dataklaim') {
            ...
            if ($error_1  or $error_3 or $error_4 or $error_5) {
                ...
                if (empty($_REQUEST['status_klaim'])) {
                    echo 'Semua Status Kelengkapan Dokumen';
                } else {
                    echo $_REQUEST['status_klaim'];
                }
                echo '</td>
							</tr>
							<tr>
                ...
                echo '<table border="0" width="100%" cellpadding="1" cellspacing="1"  bgcolor="orange">
					<tr><td bgcolor="#FFF" colspan="2"><a href="e_report_test.php?er='.$s.'&id_cost='.$_REQUEST['id_cost'].'&id_asuransi='.$_REQUEST['id_asuransi'].'&status_klaim='.$_REQUEST['status_klaim'].'&kol='.$_REQUEST['kol'].'&tgl1=' . $_REQUEST ['tglcheck1'] . '&tgl2=' . $_REQUEST ['tglcheck2'] . '&tgl3=' . $_REQUEST ['tglcheck3'] . '&tgl4=' . $_REQUEST ['tglcheck4'] . '&tgl5=' . $_REQUEST ['tglcheck5'] . '&tgl6=' . $_REQUEST ['tglcheck6'] . '"><img src="image/excel.png" width="25" border="0"><br />Excel</a>
							</td>
							<td bgcolor="#FFF">
	  ...
	  <td> : <input type="text" id="fromakad1" name="tglcheck1" value="'.$_REQUEST['tglcheck1'].'" onClick="if(self.gfPop)gfPop.fPopCalendar(document.postform.fromakad1);return false;"/>
        ...
        if ($_REQUEST['re']=='dataklaim') {
            ...
            if ($error_1 or $error_2 or $error_3 or $error_4) {
                ...
                echo '<table border="0" width="100%" cellpadding="1" cellspacing="1"  bgcolor="orange">
					<tr><td bgcolor="#FFF"colspan="24"><a href="e_report_test.php?er=klaim_nonliable&id_cost='.$_REQUEST['id_cost'].'&id_asuransi='.$_REQUEST['id_asuransi'].'&tgl1=' . $_REQUEST ['tglcheck1'] . '&tgl2=' . $_REQUEST ['tglcheck2'] . '"><img src="image/excel.png" width="25" border="0"><br />Excel</a></td></tr>
					<td>No</td>
	  ...
	  <td> : <input type="text" id="fromakad1" name="tglcheck1" value="'.$_REQUEST['tglcheck1'].'" onClick="if(self.gfPop)gfPop.fPopCalendar(document.postform.fromakad1);return false;"/>
        ...
        if ($_REQUEST['re']=='dataklaim') {
            ...
            if ($error_1 or  $error_3 or $error_4) {
                ...
                echo '<table border="0" width="100%" cellpadding="1" cellspacing="1"  bgcolor="orange">
					<tr><td bgcolor="#FFF"colspan="24"><a href="e_report_test.php?er=klaim_tiering&id_cost='.$_REQUEST['id_cost'].'&tgl1=' . $_REQUEST ['tglcheck1'] . '&tgl2=' . $_REQUEST ['tglcheck2'] . '"><img src="image/excel.png" width="25" border="0"><br />Excel</a></td></tr>
					<td>No</td>
					<td>Status</td>
					<td>Debitur</td>
					<td>Plafond</td>
	  ...
	  <td> : <input type="text" id="fromakad1" name="tglcheck1" value="'.$_REQUEST['tglcheck1'].'" onClick="if(self.gfPop)gfPop.fPopCalendar(document.postform.fromakad1);return false;"/>
        ...
        if ($_REQUEST['re']=='dataklaim') {
            ...
            if ($error_1 or  $error_3 or $error_4) {
                ...
                echo '<table border="0" width="100%" cellpadding="1" cellspacing="1"  bgcolor="orange">
					<tr><td bgcolor="#FFF"colspan="24"><a href="e_report_test.php?er=klaim_tiering_as&id_asuransi='.$_REQUEST['id_asuransi'].'&tgl1=' . $_REQUEST ['tglcheck1'] . '&tgl2=' . $_REQUEST ['tglcheck2'] . '"><img src="image/excel.png" width="25" border="0"><br />Excel</a></td></tr>
					<td>No</td>
					<td>Status</td>
					<td>Debitur</td>
					<td>Plafond</td>
            ...
            if ($error_1 or $error_3 or $error_4) {
                ...
                echo '<table border="0" width="100%" cellpadding="5" cellspacing="1" bgcolor="#bde0e6">
					<tr><td bgcolor="#FFF" colspan="2">
							<a href="e_report_test.php?er=klaim_tiering_asuransi&id_cost='.$_REQUEST['id_cost'].'&id_asuransi='.$_REQUEST['id_asuransi'].'&kol='.$_REQUEST['kol'].'&status_klaim='.$_REQUEST['status_klaim'].'&tgl1=' . $_REQUEST ['tglcheck1'] . '&tgl2=' . $_REQUEST ['tglcheck2'] . '&tgl3=' . $_REQUEST ['tglcheck3'] . '&tgl4=' . $_REQUEST ['tglcheck4'] . '&tgl5=' . $_REQUEST ['tglcheck5'] . '&tgl6=' . $_REQUEST ['tglcheck6'] . '"><img src="image/excel.png" width="25" border="0"><br />List Data klaim Tiering (Excel)</a>
							<a href="e_report_test.php?er=klaim_tiering_asuransi_all&id_cost='.$_REQUEST['id_cost'].'&id_asuransi='.$_REQUEST['id_asuransi'].'&kol='.$_REQUEST['kol'].'&status_klaim='.$_REQUEST['status_klaim'].'&tgl1=' . $_REQUEST ['tglcheck1'] . '&tgl2=' . $_REQUEST ['tglcheck2'] . '&tgl3=' . $_REQUEST ['tglcheck3'] . '&tgl4=' . $_REQUEST ['tglcheck4'] . '&tgl5=' . $_REQUEST ['tglcheck5'] . '&tgl6=' . $_REQUEST ['tglcheck6'] . '"><img src="image/excel.png" width="25" border="0"><br />List Data klaim Tiering All Kolom (Excel)</a>
							</td>
	  ...
	  <td> : <input type="text" id="fromakad1" name="tglcheck1" value="'.$_REQUEST['tglcheck1'].'" onClick="if(self.gfPop)gfPop.fPopCalendar(document.postform.fromakad1);return false;"/>
        ...
        if ($_REQUEST['re']=='dataklaim') {
            ...
            if ($error_2 or $error_3 or $error_4) {
                ...
                echo '<table border="0" width="100%" cellpadding="1" cellspacing="1"  bgcolor="orange">
					<tr><td bgcolor="#FFF"colspan="24"><a href="e_report_test.php?er=klaim_tiering_bank&id_cost='.$_REQUEST['id_cost'].'&tgl1=' . $_REQUEST ['tglcheck1'] . '&tgl2=' . $_REQUEST ['tglcheck2'] . '"><img src="image/excel.png" width="25" border="0"><br />Excel</a></td></tr>
					<td>No</td>
					<td>Bukopin Cabang</td>
					<td>Cover Asuransi</td>
					<td>Kategori</td>
	  ...
	  <td> : <input type="text" id="fromakad1" name="tglcheck1" value="'.$_REQUEST['tglcheck1'].'" onClick="if(self.gfPop)gfPop.fPopCalendar(document.postform.fromakad1);return false;"/>
        ...
        if ($_REQUEST['re']=='dataklaim') {
            ...
            if ($error_1 or $error_2 or $error_3 or $error_4) {
                ...
                echo '<table border="0" width="100%" cellpadding="1" cellspacing="1"  bgcolor="orange">
					<tr><td bgcolor="#FFF"colspan="24"><a href="e_report_test.php?er=klaim_tieringkol&id_cost='.$_REQUEST['id_cost'].'&id_asuransi='.$_REQUEST['id_asuransi'].'&tgl1=' . $_REQUEST ['tglcheck1'] . '&tgl2=' . $_REQUEST ['tglcheck2'] . '"><img src="image/excel.png" width="25" border="0"><br />Excel</a></td></tr>
					<td>No</td>
					<td>Cabang</td>
					<td>Cover Asuransi</td>
					<td>Nama Debitur</td>
	  ...
	  <td> : <input type="text" id="fromakad1" name="tglcheck1" value="'.$_REQUEST['tglcheck1'].'" onClick="if(self.gfPop)gfPop.fPopCalendar(document.postform.fromakad1);return false;"/>
        ...
        if ($_REQUEST['re']=='dataklaim') {
            ...
            if ($error_1 or $error_2 or $error_3 or $error_4) {
                ...
                echo '<table border="0" width="100%" cellpadding="1" cellspacing="1"  bgcolor="orange">
					<tr><td bgcolor="#FFF"colspan="44"><a href="e_report_test.php?er=klaim_master&id_cost='.$_REQUEST['id_cost'].'&id_asuransi='.$_REQUEST['id_asuransi'].'&tgl1=' . $_REQUEST ['tglcheck1'] . '&tgl2=' . $_REQUEST ['tglcheck2'] . '"><img src="image/excel.png" width="25" border="0"><br />Excel</a></td></tr>
					<td>No</td>
					<td>Nomor Klaim</td>
					<td>Cabang</td>
					<td>Mitra</td>
...
$metcost = $database->doQuery('SELECT * FROM fu_ajk_costumer ORDER BY name DESC');
	...
	<tr><td align="right">Tanggal Lapor</td>
	  ...
	  <tr><td align="right">Format Report</td>
		...
		<td align="center"colspan="2"><input type="hidden" name="re" value="dataklaim"><input type="submit" name="ere" value="Cari"></td>
    <td align="center"colspan="2"><input type="button" name="export" value="Export" onclick="export()"></td>
    </tr>
	  </table>
	  </form>';
    ...
    //     header("Content-Disposition: attachment; filename=KlaimOutstanding.xls");
    //     header("Expires: 0");
        ...
        if ($_REQUEST['re']=='dataklaim') {
            ...
            if ($error_1 or $error_2 or $error_3 or $error_4) {
                ...
                if ($_REQUEST['format_report']=='1') {
                    $table.= '<table border="0" width="100%" cellpadding="5" cellspacing="1" bgcolor="#bde0e6">
					<tr><td bgcolor="#FFF" colspan="2"><a href="ajk_re_masterklaim_test.php?sh=e_report&
                    ...
                    while ($datanya_ = mysql_fetch_array($sqlKlaim)) {
                        ...
                        $table.= '<tr onmouseover="this.className=\'tbl-over\'" onmouseout="this.className=\'' . $objlass . '\'" class="' . $objlass . '">
						<td width="1%" align="center">'.$no.'</td>
						<td>'.$datanya_['klaim_id'].'</td>
						<td>'.$datanya_['id_cabang'].'</td>
						<td>'.$datanya_['mitra'].'</td>
                    ...
                    $table.= createPageNavigations($file = 'ajk_re_masterklaim.php?sh=klaimoutstanding&re=dataklaim&id_cost='.$_REQUEST['id_cost'].'&
							id_asuransi='.$_REQUEST['id_asuransi'].'&
							id_polis='.$_REQUEST['id_polis'].'&
							tipe_produk='.$_REQUEST['tipe_produk'].'&
							liability='.$_REQUEST['liability'].'&
                    ...
                    $table.= '<b>Total Data : <u>' . $totalRows . '</u></b></td></tr>';
                    $table.= '</table>';
                } elseif ($_REQUEST['format_report']=='2') {
                    $table.= '<table border="0" width="100%" cellpadding="5" cellspacing="1" bgcolor="#bde0e6">
					<tr><td bgcolor="#FFF" colspan="2"><a href="e_report_test.php?er=klaim_outstanding&
							id_cost='.$_REQUEST['id_cost'].'&
							id_asuransi='.$_REQUEST['id_asuransi'].'&
							id_polis='.$_REQUEST['id_polis'].'&
							tipe_produk='.$_REQUEST['tipe_produk'].'&
	  ...
	  <td> : <input type="text" id="fromakad1" name="tglcheck1" value="'.$_REQUEST['tglcheck1'].'" onClick="if(self.gfPop)gfPop.fPopCalendar(document.postform.fromakad1);return false;"/>
        ...
        if ($_REQUEST['re']=='dataklaim') {
            ...
            if ($error_1 or  $error_3 or $error_4) {
                ...
                echo '<table border="0" width="100%" cellpadding="1" cellspacing="1"  bgcolor="orange">
					<tr><td bgcolor="#FFF"colspan="24"><a href="e_report_test.php?er=summary_klaim&id_cost='.$_REQUEST['id_cost'].'&tgl1=' . $_REQUEST ['tglcheck1'] . '&tgl2=' . $_REQUEST ['tglcheck2'] . '"><img src="image/excel.png" width="25" border="0"><br />Excel</a></td></tr>
					<td>No</td>
					<td>Perusahaan</td>
					<td>Kategori</td>
					<td>Kol</td>
	  ...
	  <td> : <input type="text" id="fromakad1" name="tglcheck1" value="'.$_REQUEST['tglcheck1'].'" onClick="if(self.gfPop)gfPop.fPopCalendar(document.postform.fromakad1);return false;"/>
        ...
        if ($_REQUEST['re']=='dataklaim') {
            ...
            if ($error_1 or $error_2 or $error_3 or $error_4) {
                ...
                echo '<table border="0" width="100%" cellpadding="1" cellspacing="1"  bgcolor="orange">
					<tr><td bgcolor="#FFF"colspan="24"><a href="e_report_test.php?er=klaim_summary_asuransi&id_cost='.$_REQUEST['id_cost'].'&id_asuransi='.$_REQUEST['id_asuransi'].'&tgl1=' . $_REQUEST ['tglcheck1'] . '&tgl2=' . $_REQUEST ['tglcheck2'] . '"><img src="image/excel.png" width="25" border="0"><br />Excel</a></td></tr>
					<td>No</td>
					<td>Perusahaan</td>
					<td>Asuransi</td>
					<td>Status Klaim</td>
