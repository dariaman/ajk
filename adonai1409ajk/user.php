...
LEFT JOIN fu_ajk_grupproduk ON user_mobile.namamitra = fu_ajk_grupproduk.nmproduk
...
if ($_REQUEST['ope']=="Simpan") {
	...
	if ($error1 OR $error2 OR $error3 OR $error5 OR $error6 OR $error7 OR $error8 OR $error9)
	{		}
	else
	{
