	...
	if ($error_1 or $error_2 or $error_3 or $error_4) {
		...
		if($_REQUEST['liability']=='ALL'){
			$liability_report='
							...
							<a target="_blank" href="e_report_klaim.php?er=summary_klaim_asuransi_liable_all&
							...
							<td colspan="2" bgcolor="#FFF">
							<a target="_blank" href="e_report_klaim.php?er=summary_klaim_asuransi_nonliable_all&
							id_cost='.$_REQUEST['id_cost'].'&
							id_asuransi='.$_REQUEST['id_asuransi'].'&
							id_polis='.$_REQUEST['id_polis'].'&
							tipe_produk='.$_REQUEST['tipe_produk'].'&
			...
			$liability_report='
							<td colspan="2" bgcolor="#FFF">
							<a target="_blank" href="e_report_klaim.php?er=summary_klaim_asuransi_'.strtolower($_REQUEST['liability']).'_all&
							id_cost='.$_REQUEST['id_cost'].'&
							id_asuransi='.$_REQUEST['id_asuransi'].'&
							id_polis='.$_REQUEST['id_polis'].'&
							tipe_produk='.$_REQUEST['tipe_produk'].'&
			...
			echo '<table border="0" width="100%" cellpadding="5" cellspacing="1" bgcolor="#bde0e6">
					<tr><td bgcolor="#FFF" colspan="3"><a href="e_report.php?er=klaim_outstanding&
							id_cost='.$_REQUEST['id_cost'].'&
							id_asuransi='.$_REQUEST['id_asuransi'].'&
							id_polis='.$_REQUEST['id_polis'].'&
							tipe_produk='.$_REQUEST['tipe_produk'].'&
							...
							status_bayar='.$_REQUEST['status_bayar'].'&
							kol='.$_REQUEST['kol'].'&
							format_report=3"><img src="image/pdf.png" width="25" border="0"><br />Print List data (*.pdf)</a>
							</td>'.$liability_report.'
									
							<td colspan="36" bgcolor="#FFF"></td><td colspan="36" bgcolor="#FFF"></td>
			...
			echo createPageNavigations($file = 'ajk_re_asclaim.php?sh=klaimoutstanding&re=dataklaim&id_cost='.$_REQUEST['id_cost'].'&
							id_asuransi='.$_REQUEST['id_asuransi'].'&
							id_polis='.$_REQUEST['id_polis'].'&
							tipe_produk='.$_REQUEST['tipe_produk'].'&
							liability='.$_REQUEST['liability'].'&
