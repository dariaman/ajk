...
$met_dnklaim_ = mysql_fetch_array($database->doQuery('SELECT 
		...
		FROM fu_ajk_note_as WHERE id_dn="'.$metdn['id'].'"'));
...
echo '<tr onmouseover="this.className=\'tbl-over\'" onmouseout="this.className=\'' . $objlass . '\'" class="' . $objlass . '">
	    ...
	    <td align="center">'.strtoupper($met_dnklaim_['note_paid_date']).'</td>
	    <td align="center">'.$met_dnklaim_['paid_total'].'</td>
	    <td align="center">'.$met_dnklaim_['note_status'].'</td>
