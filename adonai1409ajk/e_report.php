...
switch ($_REQUEST['er']) {
  case "el_peserta_covering":
    ...
    $worksheet1->write_string(0, 0, "DAFTAR PESERTA ASURANSI JIWA KUMPULAN", $fjudul, 1);
    ...
    $worksheet1->set_column(4, 2, 15);	$worksheet1->write_string(4, 2, "PRODUK", $format);
    $worksheet1->set_column(4, 3, 15);	$worksheet1->write_string(4, 3, "NOMOR DN", $format);
    $worksheet1->set_column(4, 4, 15);	$worksheet1->write_string(4, 4, "TGL DN", $format);
    $worksheet1->set_column(4, 5, 15);	$worksheet1->write_string(4, 5, "ID PESERTA", $format);
    $worksheet1->set_column(4, 6, 15);	$worksheet1->write_string(4, 6, "NO PERMOHONAN", $format);
    $worksheet1->set_column(4, 7, 15);	$worksheet1->write_string(4, 7, "NAMA DEBITUR", $format);
    $worksheet1->set_column(4, 8, 10);	$worksheet1->write_string(4, 8, "TGL LAHIR", $format);
    $worksheet1->set_column(4, 9, 10);	$worksheet1->write_string(4, 9, "USIA", $format);
    $worksheet1->set_column(4, 10, 5);		$worksheet1->write_string(4, 10, "PLAFOND", $format);
    $worksheet1->set_column(4, 11, 10);	$worksheet1->write_string(4, 11, "JK.W", $format);
    $worksheet1->set_column(4, 12, 5);	$worksheet1->write_string(4, 12, "MULAI ASURANSI", $format);
    $worksheet1->set_column(4, 13, 15);	$worksheet1->write_string(4, 13, "AKHIR ASURANSI", $format);
    $worksheet1->set_column(4, 14, 15);	$worksheet1->write_string(4, 14, "AKHIR ASURANSI", $format);
    $worksheet1->set_column(4, 15, 15);	$worksheet1->write_string(4, 15, "EM", $format);
    $worksheet1->set_column(4, 16, 15);	$worksheet1->write_string(4, 16, "TOTAL PREMI", $format);
    ...
    $baris = 5;
    //$worksheet1->write_string(5, 0, $satu.' '.$dua.' '.$tiga.' '.$empat.' '.$lima.' '.$enam.' '.$tujuh.' '.$delapan);
    while ($qpeserta_ = mysql_fetch_array($qpeserta)) {
        $worksheet1->write_string($baris, 0, ++$no);
        $worksheet1->write_string($baris, 1, $qpeserta_['cabang']);
        $worksheet1->write_string($baris, 2, $qpeserta_['nmproduk']);
        $worksheet1->write_string($baris, 3, $qpeserta_['dn_kode']);
        $worksheet1->write_string($baris, 4, $qpeserta_['tgl_createdn']);
        $worksheet1->write_string($baris, 5, $qpeserta_['id_peserta']);
        $worksheet1->write_string($baris, 6, $qpeserta_['nopermohonan']);
        $worksheet1->write_string($baris, 7, $qpeserta_['nama']);
        $worksheet1->write_string($baris, 8, $qpeserta_['tgl_lahir']);
        $worksheet1->write_number($baris, 9, $qpeserta_['usia']);
        $worksheet1->write_number($baris, 10, $qpeserta_['kredit_jumlah']);
        $worksheet1->write_number($baris, 11, $qpeserta_['kredit_tenor']);
        $worksheet1->write_string($baris, 12, $qpeserta_['kredit_tgl']);
        $worksheet1->write_string($baris, 13, $qpeserta_['kredit_akhir']);
        $worksheet1->write_number($baris, 14, $qpeserta_['premi']);
        $worksheet1->write_number($baris, 15, $qpeserta_['ext_premi']);
        $worksheet1->write_number($baris, 16, $qpeserta_['totalpremi'], $fjudul1);
        $baris++;
    }
  ...
  case "eL_peserta":
    ...
    if ($_REQUEST['grupprod']) {
        $sembilan = 'AND nama_mitra = "'.$_REQUEST['grupprod'].'"';
    }

    if ($_REQUEST['tgltrans1']) {
        $sepuluh = 'AND tgltransaksi BETWEEN "'.$_REQUEST['tgltrans1'].'" AND "'.$_REQUEST['tgltrans2'].'"';
    }

    $worksheet1->merge_cells(0, 0, 0, 19);	$worksheet1->write_string(0, 0, "DAFTAR PESERTA ASURANSI JIWA KUMPULAN REGULER", $fjudul, 1);
    $worksheet1->merge_cells(1, 0, 1, 19);	$worksheet1->write_string(1, 0, $tgl_data, $fjudul);
    $worksheet1->merge_cells(2, 0, 2, 19);	$worksheet1->write_string(2, 0, strtoupper($met_c['name']), $fjudul);

    $worksheet1->set_row(4, 16);
    $worksheet1->set_column(4, 0, 5);	$worksheet1->write_string(4, 0, "NO", $format);
    $worksheet1->set_column(4, 1, 15);	$worksheet1->write_string(4, 1, "MITRA", $format);
    $worksheet1->set_column(4, 2, 15);	$worksheet1->write_string(4, 2, "SPAJ", $format);
    $worksheet1->set_column(4, 3, 15);	$worksheet1->write_string(4, 3, "PRODUK", $format);
    $worksheet1->set_column(4, 4, 15);	$worksheet1->write_string(4, 4, "NOMOR DN", $format);
    $worksheet1->set_column(4, 5, 15);	$worksheet1->write_string(4, 5, "TGL DN", $format);
    $worksheet1->set_column(4, 6, 15);	$worksheet1->write_string(4, 6, "ID PESERTA", $format);
    $worksheet1->set_column(4, 7, 15);	$worksheet1->write_string(4, 7, "NO PINJAMAN", $format);
    $worksheet1->set_column(4, 8, 15);	$worksheet1->write_string(4, 8, "NAMA DEBITUR", $format);
    $worksheet1->set_column(4, 9, 10);	$worksheet1->write_string(4, 9, "CABANG", $format);
    $worksheet1->set_column(4, 10, 10);	$worksheet1->write_string(4, 10, "TGL LAHIR", $format);
    $worksheet1->set_column(4, 11, 5);	$worksheet1->write_string(4, 11, "USIA", $format);
    $worksheet1->set_column(4, 12, 10);	$worksheet1->write_string(4, 12, "PLAFOND", $format);
    $worksheet1->set_column(4, 13, 5);	$worksheet1->write_string(4, 13, "JK.W", $format);
    $worksheet1->set_column(4, 14, 15);	$worksheet1->write_string(4, 14, "MULAI ASURANSI", $format);
    $worksheet1->set_column(4, 15, 15);	$worksheet1->write_string(4, 15, "AKHIR ASURANSI", $format);
    $worksheet1->set_column(4, 16, 10);	$worksheet1->write_string(4, 16, "RATE TUNGGAL", $format);
    $worksheet1->set_column(4, 17, 5);	$worksheet1->write_string(4, 17, "EM (%)", $format);
    $worksheet1->set_column(4, 18, 15);	$worksheet1->write_string(4, 18, "TOTAL RATE", $format);
    $worksheet1->set_column(4, 19, 15);	$worksheet1->write_string(4, 19, "TOTAL PREMI", $format);
    $worksheet1->set_column(4, 20, 15);	$worksheet1->write_string(4, 20, "ASURANSI", $format);
    $worksheet1->set_column(4, 21, 15);	$worksheet1->write_string(4, 21, "MPP (BULAN)", $format);
    $worksheet1->set_column(4, 22, 10);	$worksheet1->write_string(4, 22, "STATUS", $format);
    $worksheet1->set_column(4, 23, 10);	$worksheet1->write_string(4, 23, "TGL BAYAR", $format);
    $worksheet1->set_column(4, 24, 10);	$worksheet1->write_string(4, 24, "INPUT SPK", $format);
    $worksheet1->set_column(4, 25, 10);	$worksheet1->write_string(4, 25, "TYPE INPUT", $format);

    $baris = 5;

    $query = 'SELECT * FROM v_rpt_rekapbank WHERE id_dn !="" '.$satu.' '.$dua.' '.$tiga.' '.$empat.' '.$lima.' '.$enam.' '.$tujuh.' '.$delapan.' '.$sembilan.' '.$sepuluh;

    $er_dataPeserta = mysql_query($query);
    while ($mamet = mysql_fetch_array($er_dataPeserta)) {
        $mettenornya = $mamet['kredit_tenor'];

        if ($mamet['ext_premi']==0) {
            $mametrate_ext = '';
        } else {
            $mametrate_ext = $mamet['ext_premi'];
        }

        $mettotalrate = $mamet['ratebank'] * (1 + $mamet['em'] / 100);
        ...
        if (is_numeric($mamet['input_by'])) {
            $metUserSPK = mysql_fetch_array(mysql_query('SELECT * FROM user_mobile WHERE id="'.$mamet['input_by'].'" '));
            $metUserSPK_ = $metUserSPK['namalengkap'];
        } else {
            $metUserSPK_ = $mamet['input_by'];
        }
        ...
        if ($mamet['mitra']=="") {
            ...
            $groupProduk = $mamet['mitra'];
        }
        if (substr($mamet['spaj'], 0, 1)=="M" or substr($mamet['spaj'], 0, 1)=="MP" or substr($mamet['spaj'], 0, 1)=="MS" or substr($mamet['spaj'], 0, 1)=="PL" or substr($mamet['spaj'], 0, 1)=="AB") {
            $typeinput = "Tablet";
        } else {
            $typeinput = "Manual";
        }
        ...
        $worksheet1->write_string($baris, 0, ++$no);
        $worksheet1->write_string($baris, 1, $groupProduk);
        $worksheet1->write_string($baris, 2, $mamet['spaj']);
        $worksheet1->write_string($baris, 3, $mamet['nmproduk']);
        $worksheet1->write_string($baris, 4, $mamet['dn_kode']);
        $worksheet1->write_string($baris, 5, _convertDate($mamet['tgl_createdn']));
        $worksheet1->write_string($baris, 6, $mamet['id_peserta']);
        $worksheet1->write_string($baris, 7, $mamet['nopinjaman']);
        $worksheet1->write_string($baris, 8, $mamet['nama']);
        $worksheet1->write_string($baris, 9, $mamet['cabang']);
        $worksheet1->write_string($baris, 10, _convertDate($mamet['tgl_lahir']));
        $worksheet1->write_number($baris, 11, $mamet['usia']);
        $worksheet1->write_number($baris, 12, $mamet['kredit_jumlah'], $fjudul1);
        $worksheet1->write_number($baris, 13, $mamet['bulan']);
        $worksheet1->write_string($baris, 14, _convertDate($mamet['kredit_tgl']));
        $worksheet1->write_string($baris, 15, _convertDate($mamet['kredit_akhir']));
        $worksheet1->write_string($baris, 16, $mamet['ratebank']);
        $worksheet1->write_number($baris, 17, $mamet['em']);
        $worksheet1->write_string($baris, 18, $mettotalrate);
        $worksheet1->write_number($baris, 19, $mamet['totalpremi'], $fjudul1);
        $worksheet1->write_string($baris, 20, $mamet['nmAsuransi']);
        $worksheet1->write_string($baris, 21, $mamet['mppbln']);
        $worksheet1->write_string($baris, 22, $mamet['status_aktif'].' '.$_statuspeserta.'');
        $worksheet1->write_string($baris, 23, $mamet['tgl_bayar']);
        $worksheet1->write_string($baris, 24, $metUserSPK_.'');
        $worksheet1->write_string($baris, 25, $typeinput);
        $baris++;

        $tPlafond += $mamet['kredit_jumlah'];
        $tTotalPremi += $mamet['totalpremi'];
    }
    $worksheet1->merge_cells($baris, 0, $baris, 10);		$worksheet1->write_string($baris, 0, "TOTAL", $fjudul);
    $worksheet1->write_string($baris, 11, $tPlafond, $fjudul1);
    $worksheet1->merge_cells($baris, 12, $baris, 17);	$worksheet1->write_string($baris, 9, "", $fjudul);
    $worksheet1->write_string($baris, 18, $tTotalPremi, $fjudul1);
  ...
  case "eL_peserta_as":
    ...
    $worksheet1->set_column(4, 9, 10);	$worksheet1->write_string(4, 9, "TGL LAHIR", $format);
    $worksheet1->set_column(4, 10, 5);	$worksheet1->write_string(4, 10, "USIA", $format);
    $worksheet1->set_column(4, 11, 10);	$worksheet1->write_string(4, 11, "PLAFOND", $format);
    $worksheet1->set_column(4, 12, 5);	$worksheet1->write_string(4, 12, "JK.W", $format);
    $worksheet1->set_column(4, 13, 15);	$worksheet1->write_string(4, 13, "MULAI ASURANSI", $format);
    $worksheet1->set_column(4, 14, 15);	$worksheet1->write_string(4, 14, "AKHIR ASURANSI", $format);
    $worksheet1->set_column(4, 15, 10);	$worksheet1->write_string(4, 15, "RATE TUNGGAL", $format);
    $worksheet1->set_column(4, 16, 5);	$worksheet1->write_string(4, 16, "EM (%)", $format);
    $worksheet1->set_column(4, 17, 15);	$worksheet1->write_string(4, 17, "TOTAL RATE", $format);
    $worksheet1->set_column(4, 18, 15);	$worksheet1->write_string(4, 18, "TOTAL PREMI", $format);
    $worksheet1->set_column(4, 19, 15);	$worksheet1->write_string(4, 19, "RATE ASURANSI", $format);
    $worksheet1->set_column(4, 20, 15);	$worksheet1->write_string(4, 20, "TOTAL PREMI ASURANSI", $format);
    $worksheet1->set_column(4, 21, 15);	$worksheet1->write_string(4, 21, "ASURANSI", $format);
    $worksheet1->set_column(4, 22, 15);	$worksheet1->write_string(4, 22, "MPP (BULAN)", $format);
    $worksheet1->set_column(4, 23, 10);	$worksheet1->write_string(4, 23, "STATUS", $format);
    $worksheet1->set_column(4, 24, 10);	$worksheet1->write_string(4, 24, "INPUT SPK", $format);
    $worksheet1->set_column(4, 25, 10);	$worksheet1->write_string(4, 25, "TYPE INPUT", $format);
    ...
    while ($mamet = mysql_fetch_array($er_dataPeserta)) {
        ...
        $worksheet1->write_string($baris, 8, $mamet['cabang']);
        $worksheet1->write_string($baris, 9, _convertDate($mamet['tgl_lahir']));
        $worksheet1->write_number($baris, 10, $mamet['usia']);
        $worksheet1->write_number($baris, 11, $mamet['kredit_jumlah'], $fjudul1);
        $worksheet1->write_number($baris, 12, $tenorpeserta);
        $worksheet1->write_string($baris, 13, _convertDate($mamet['kredit_tgl']));
        $worksheet1->write_string($baris, 14, _convertDate($mamet['kredit_akhir']));
        $worksheet1->write_string($baris, 15, $cekdataret['rate']);
        $worksheet1->write_number($baris, 16, $met_emnya_2);
        $worksheet1->write_string($baris, 17, $mettotalrate);
        $worksheet1->write_number($baris, 18, $mamet['totalpremi'], $fjudul1);
        $worksheet1->write_number($baris, 19, $mamet['rateasuransi']);
        $worksheet1->write_number($baris, 20, $mamet['nettpremi']);
        $worksheet1->write_string($baris, 21, $mamet['nmAsuransi']);
        $worksheet1->write_number($baris, 22, $mamet['mppbln']);
        $worksheet1->write_string($baris, 23, $mamet['status_aktif'].' '.$_statuspeserta.'');
        $worksheet1->write_string($baris, 24, $metUserSPK_.'');
        $worksheet1->write_string($baris, 25, $typeinput);
        $baris++;
  ...
  case "eL_peserta_as_summary":
    ...
    $stringcost =  str_replace(" ", "_", $met_c['name']);
    if ($_REQUEST['dncreate']==$_REQUEST['dncreate1']) {
        HeaderingExcel('Laporan_Summary_'.$stringcost.'_'.$_REQUEST['tgldn1'].'-'.$_REQUEST['tgldn2'].'.xls');
    } else {
        HeaderingExcel('Laporan_Summary_'.$stringcost.'_'.$_REQUEST['tgldn1'].'-'.$_REQUEST['tgldn2'].'.xls');
    }
    ...
    $worksheet1->merge_cells(0, 0, 0, 5);	$worksheet1->write_string(0, 0, "DAFTAR PESERTA SUMMARY PRODUKSI", $fjudul, 1);
    $worksheet1->merge_cells(1, 0, 1, 5);	$worksheet1->write_string(1, 0, $tgl_data, $fjudul);
    $worksheet1->merge_cells(2, 0, 2, 5);	$worksheet1->write_string(2, 0, strtoupper($met_c['name']), $fjudul);

    $worksheet1->set_row(4, 16);
    $worksheet1->set_column(4, 0, 10); $worksheet1->write_string(4, 0, "ASURANSI", $format);
    $worksheet1->set_column(4, 1, 20);	$worksheet1->write_string(4, 1, "PRODUK", $format);
    $worksheet1->set_column(4, 2, 20);	$worksheet1->write_string(4, 2, "DEBITUR", $format);
    $worksheet1->set_column(4, 3, 20);	$worksheet1->write_string(4, 3, "PLAFOND", $format);
    $worksheet1->set_column(4, 4, 20);	$worksheet1->write_string(4, 4, "PREMI BANK", $format);
    $worksheet1->set_column(4, 5, 20);	$worksheet1->write_string(4, 5, "PREMI ASURANSI", $format);
    ...
    $query = 'SELECT fu_ajk_asuransi.code,
                      fu_ajk_polis.nmproduk,
                     count(*)as jml_peserta,
                     sum(fu_ajk_peserta.kredit_jumlah)as plafond,
                     sum(fu_ajk_peserta.totalpremi)as premi_bank,
              ...
              FROM fu_ajk_peserta
                   ...
                   INNER JOIN fu_ajk_asuransi ON fu_ajk_dn.id_as = fu_ajk_asuransi.id
              WHERE fu_ajk_peserta.del is NULL '.$satu.' '.$dua.' '.$tiga.' '.$empat.' '.$lima.' '.$enam.' '.$tujuh.' '.$delapan.' '.$sembilan.' '.$sepuluh.' '.$sebelas.' '.$duabelas.'
              GROUP BY fu_ajk_peserta_as.id_asuransi, fu_ajk_peserta.id_polis';

    $er_dataPeserta = mysql_query($query);

    while ($mamet = mysql_fetch_array($er_dataPeserta)) {
        $worksheet1->write_string($baris, 0, $mamet['code']);
        $worksheet1->write_string($baris, 1, $mamet['nmproduk']);
        $worksheet1->write_string($baris, 2, $mamet['jml_peserta']);
        $worksheet1->write_string($baris, 3, duit($mamet['plafond']));
        $worksheet1->write_string($baris, 4, duit($mamet['premi_bank']));
        $worksheet1->write_string($baris, 5, duit($mamet['premi_asuransi']));
  ...
  case "eL_asuransinew":
    ...
    $worksheet1->merge_cells(0, 0, 0, 21);	$worksheet1->write_string(0, 0, "DAFTAR PESERTA ASURANSI JIWA KUMPULAN ".$met_r['nmproduk']."", $fjudul, 1);
    $worksheet1->merge_cells(1, 0, 1, 21);	$worksheet1->write_string(1, 0, "PERIODE "._convertDate($_REQUEST['tgl1'])." S/D "._convertDate($_REQUEST['tgl2'])."", $fjudul);
    $worksheet1->merge_cells(2, 0, 2, 21);	$worksheet1->write_string(2, 0, strtoupper($met_c['name']), $fjudul);

    $worksheet1->set_row(4, 15);
    $worksheet1->set_column(4, 0, 5);	$worksheet1->write_string(4, 0, "NO", $format);
    $worksheet1->set_column(4, 1, 15);	$worksheet1->write_string(4, 1, "ASURANSI", $format);
    $worksheet1->set_column(4, 2, 15);	$worksheet1->write_string(4, 2, "PRODUK", $format);
    $worksheet1->set_column(4, 3, 15);	$worksheet1->write_string(4, 3, "NOMOR DN", $format);
    $worksheet1->set_column(4, 4, 15);	$worksheet1->write_string(4, 4, "TANGGAL DN", $format);
    $worksheet1->set_column(4, 5, 15);	$worksheet1->write_string(4, 5, "ID.PESERTA", $format);
    $worksheet1->set_column(4, 6, 15);	$worksheet1->write_string(4, 6, "NAMA", $format);
    $worksheet1->set_column(4, 7, 15);	$worksheet1->write_string(4, 7, "KTP", $format);
    $worksheet1->set_column(4, 8, 15);	$worksheet1->write_string(4, 8, "JENIS KELAMIN", $format);
    $worksheet1->set_column(4, 9, 15);	$worksheet1->write_string(4, 9, "PEKERJAAN", $format);
    $worksheet1->set_column(4, 10, 15);	$worksheet1->write_string(4, 10, "CABANG", $format);
    $worksheet1->set_column(4, 11, 15);	$worksheet1->write_string(4, 11, "TGL LAHIR", $format);
    $worksheet1->set_column(4, 12, 15);	$worksheet1->write_string(4, 12, "USIA", $format);
    $worksheet1->set_column(4, 13, 15);	$worksheet1->write_string(4, 13, "PLAFOND", $format);
    $worksheet1->set_column(4, 14, 15);	$worksheet1->write_string(4, 14, "MULAI ASURANSI", $format);
    $worksheet1->set_column(4, 15, 10);	$worksheet1->write_string(4, 15, "TENOR", $format);
    $worksheet1->set_column(4, 16, 15);	$worksheet1->write_string(4, 16, "AKHIR ASURANSI", $format);
    $worksheet1->set_column(4, 17, 15);	$worksheet1->write_string(4, 17, "RATE", $format);
    $worksheet1->set_column(4, 18, 15);	$worksheet1->write_string(4, 18, "PREMI", $format);
    $worksheet1->set_column(4, 19, 10);	$worksheet1->write_string(4, 19, "EM(%)", $format);
    $worksheet1->set_column(4, 20, 15);	$worksheet1->write_string(4, 20, "EXT.PREMI", $format);
    $worksheet1->set_column(4, 21, 15);	$worksheet1->write_string(4, 21, "TOTAL PREMI", $format);
    $worksheet1->set_column(4, 22, 15);	$worksheet1->write_string(4, 22, "PEMBAYARAN", $format);
    $worksheet1->set_column(4, 23, 15);	$worksheet1->write_string(4, 23, "MPP(bln)", $format);
    $worksheet1->set_column(4, 24, 15);	$worksheet1->write_string(4, 24, "STATUS", $format);
    ...
    $er_data = mysql_query($query);

    while ($mamet = mysql_fetch_array($er_data)) {
        if ($mamet['gender']=="L") {
            $jnskelamin = 'Laki - Laki';
        } elseif ($mamet['gender']=="P") {
            $jnskelamin = 'Perempuan';
        }

        $worksheet1->write_string($baris, 0, ++$no);
        $worksheet1->write_string($baris, 1, $mamet['nmAsuransi']);
        $worksheet1->write_string($baris, 2, $mamet['nmproduk']);
        $worksheet1->write_string($baris, 3, $mamet['dn_kode']);
        $worksheet1->write_string($baris, 4, _convertDate($mamet['tgl_createdn']));
        $worksheet1->write_string($baris, 5, $mamet['id_peserta']);
        $worksheet1->write_string($baris, 6, $mamet['nama']);
        $worksheet1->write_string($baris, 7, $mamet['no_ktp']);
        $worksheet1->write_string($baris, 8, $jnskelamin);
        $worksheet1->write_string($baris, 9, $mamet['pekerjaan']);
        $worksheet1->write_string($baris, 10, $mamet['cabang']);
        $worksheet1->write_string($baris, 11, _convertDate($mamet['tgl_lahir']));
        $worksheet1->write_number($baris, 12, $mamet['usia']);
        $worksheet1->write_number($baris, 13, $mamet['kredit_jumlah']);
        $worksheet1->write_string($baris, 14, _convertDate($mamet['kredit_tgl']));
        $worksheet1->write_number($baris, 15, $mamet['bulan']);
        $worksheet1->write_string($baris, 16, _convertDate($mamet['kredit_akhir']));
        $worksheet1->write_number($baris, 17, $mamet['rateasuransi']);
        $worksheet1->write_number($baris, 18, $mamet['b_premi']);
        $worksheet1->write_number($baris, 19, duit($mamet['ext_premi']));
        $worksheet1->write_number($baris, 20, $mamet['b_extpremi']);
        $worksheet1->write_number($baris, 21, $mamet['nettpremi']);
        $worksheet1->write_string($baris, 22, strtoupper($mamet['dn_status']));
        $worksheet1->write_number($baris, 23, $mamet['mppbln']);
        $worksheet1->write_string($baris, 24, strtoupper($mamet['status_aktif']).' '.strtoupper($mamet['status_peserta']));
    ...
    */
    ...
    while ($mamet = mysql_fetch_array($er_data)) {
        ...
        */
        ...
        $worksheet1->write_string($baris, 5, $mamet['id_peserta']);
        $worksheet1->write_string($baris, 6, $mamet['nama']);
        $worksheet1->write_string($baris, 7, $qspakform['noidentitas']);
        $worksheet1->write_string($baris, 8, $jnskelamin);
        $worksheet1->write_string($baris, 9, $qspakform['pekerjaan']);
        $worksheet1->write_string($baris, 10, $mamet['cabang']);
        $worksheet1->write_string($baris, 11, _convertDate($mamet['tgl_lahir']));
        $worksheet1->write_number($baris, 12, $mamet['usia']);
        $worksheet1->write_number($baris, 13, $mamet['kredit_jumlah']);
        ...
        $worksheet1->write_number($baris, 15, $mamet['bulan']);
        $worksheet1->write_string($baris, 16, _convertDate($mamet['kredit_akhir']));
        $worksheet1->write_number($baris, 17, $rateAsuransinya);
        $worksheet1->write_number($baris, 18, $metPremiAsuransi['b_premi']);
        $worksheet1->write_number($baris, 19, duit($met_emnya_2['ext_premi']));
        $worksheet1->write_number($baris, 20, $metPremiAsuransi['b_extpremi']);
        $worksheet1->write_number($baris, 21, $metPremiAsuransi['nettpremi']);
        $worksheet1->write_string($baris, 22, strtoupper($mamet['dn_status']));
        $worksheet1->write_number($baris, 23, $mamet['mppbln']);
        $worksheet1->write_string($baris, 24, strtoupper($mamet['status_aktif']).' '.strtoupper($mamet['status_peserta']));
  ...
  case "eL_spk":
    ...
    $worksheet1->merge_cells(0, 0, 0, 27);	$worksheet1->write_string(0, 0, "KONFIRMASI PREMIUM CALCULATION - AJK KONSORSIUM", $fjudul, 1);
    $worksheet1->merge_cells(1, 0, 1, 27);	$worksheet1->write_string(1, 0, strtoupper($met_c['name']), $fjudul);
    ...
    $fjudul =& $workbook->add_format();	$fjudul->set_align('vcenter');	$fjudul->set_align('center');	$fjudul->set_bold();
            ...
            $worksheet1->set_column(2, 1, 15);	$worksheet1->write_string(2, 1, "PRODUK", $format);
            $worksheet1->set_column(2, 2, 15);	$worksheet1->write_string(2, 2, "NAMA DEBITUR", $format);
            $worksheet1->set_column(2, 3, 15);	$worksheet1->write_string(2, 3, "CABANG", $format);
            $worksheet1->set_column(2, 4, 15);	$worksheet1->write_string(2, 4, "NO. SPK", $format);
            $worksheet1->set_column(2, 5, 15);	$worksheet1->write_string(2, 5, "TGL INPUT SPK", $format);
            $worksheet1->set_column(2, 6, 15); $worksheet1->write_string(2, 6, "INPUT BY", $format);
            $worksheet1->set_column(2, 7, 15);	$worksheet1->write_string(2, 7, "TGL APPROVE SPK", $format);
            $worksheet1->set_column(2, 8, 15);  $worksheet1->write_string(2, 8, "TGL ASSIGN", $format);
            $worksheet1->set_column(2, 9, 15);  $worksheet1->write_string(2, 9, "USER ASSIGN", $format);
            $worksheet1->set_column(2, 10, 15);  $worksheet1->write_string(2, 10, "TGL EM", $format);
            $worksheet1->set_column(2, 11, 15);  $worksheet1->write_string(2, 11, "USER EM", $format);
            $worksheet1->set_column(2, 12, 15);	$worksheet1->write_string(2, 12, "TGL LAHIR", $format);
            $worksheet1->set_column(2, 13, 15);	$worksheet1->write_string(2, 13, "TGL ASURANSI", $format);
            $worksheet1->set_column(2, 14, 10);	$worksheet1->write_string(2, 14, "USIA AWAL ", $format);
            $worksheet1->set_column(2, 15, 10);	$worksheet1->write_string(2, 15, "USIA AKHIR", $format);
            $worksheet1->set_column(2, 16, 15);	$worksheet1->write_string(2, 16, "PLAFOND", $format);
            $worksheet1->set_column(2, 17, 15);	$worksheet1->write_string(2, 17, "EM", $format);
            $worksheet1->set_column(2, 18, 5);	$worksheet1->write_string(2, 18, "TENOR", $format);
            $worksheet1->set_column(2, 19, 5);	$worksheet1->write_string(2, 19, "TB", $format);
            $worksheet1->set_column(2, 20, 5);	$worksheet1->write_string(2, 20, "BB", $format);
            $worksheet1->set_column(2, 21, 15);	$worksheet1->write_string(2, 21, "SISTOLIK", $format);
            $worksheet1->set_column(2, 22, 15);	$worksheet1->write_string(2, 22, "DIASTOLIK", $format);
            $worksheet1->set_column(2, 23, 15);	$worksheet1->write_string(2, 23, "NADI", $format);
            $worksheet1->set_column(2, 24, 15);	$worksheet1->write_string(2, 24, "PERNAFASAN", $format);
            $worksheet1->set_column(2, 25, 15);	$worksheet1->write_string(2, 25, "GULA DARAH", $format);
            $worksheet1->set_column(2, 26, 10);	$worksheet1->write_string(2, 26, "MEROKOK", $format);
            $worksheet1->set_column(2, 27, 15);	$worksheet1->write_string(2, 27, "JML ROKOK", $format);
            $worksheet1->set_column(2, 28, 15);	$worksheet1->write_string(2, 28, "CATATAN SKS", $format);
            $worksheet1->set_column(2, 29, 15);	$worksheet1->write_string(2, 29, "STATUS", $format);
            $worksheet1->set_column(2, 30, 15);	$worksheet1->write_string(2, 30, "DEBITNOTE", $format);
            $worksheet1->set_column(2, 31, 15);	$worksheet1->write_string(2, 31, "TANGGAL DEBITNOTE", $format);
            $worksheet1->set_column(2, 32, 15); $worksheet1->write_string(2, 32, "TANGGAL MENINGGAL", $format);
    ...
    */
    ...
    LEFT JOIN fu_ajk_klaim ON fu_ajk_klaim.id_cn = fu_ajk_peserta.id_klaim
    WHERE fu_ajk_peserta.spaj="'.$mamet['spak'].'"'));
        ...
        $worksheet1->write_string($baris, 3, $inputcabang);
        $worksheet1->write_string($baris, 4, $mamet['spak']);
        $worksheet1->write_string($baris, 5, _convertDate($mamet['tglInput']));
        $worksheet1->write_string($baris, 6, $_nmMarketing);
        $worksheet1->write_string($baris, 7, _convertDate($mamet['tglApproveSPV']));
        $worksheet1->write_string($baris, 8, _ConvertDate($mamet['assign_date']));
        $worksheet1->write_string($baris, 9, $mamet['assign_by']);
        $worksheet1->write_string($baris, 10, _convertDate($mamet['approve_em_date']));
        $worksheet1->write_string($baris, 11, $mamet['approve_em_by']);
        $worksheet1->write_string($baris, 12, $mamet['dob']);
        $worksheet1->write_string($baris, 13, _convertDate($mamet['tgl_asuransi']));
        $worksheet1->write_number($baris, 14, $mamet['x_usia']);
        $worksheet1->write_number($baris, 15, $mamet['usiaakhir']);
        $worksheet1->write_number($baris, 16, $mamet['plafond']);
        $worksheet1->write_number($baris, 17, $mamet['ext_premi']);
        $worksheet1->write_number($baris, 18, $mamet['tenor']);
        $worksheet1->write_number($baris, 19, $mamet['tinggibadan']);
        $worksheet1->write_number($baris, 20, $mamet['beratbadan']);
        $worksheet1->write_number($baris, 21, $tolik[0]);
        $worksheet1->write_number($baris, 22, $tolik[1]);
        $worksheet1->write_number($baris, 23, $mamet['nadi']);
        $worksheet1->write_number($baris, 24, $mamet['pernafasan']);
        $worksheet1->write_number($baris, 25, $mamet['guladarah']);
        $worksheet1->write_string($baris, 26, $pertanyaan6);
        $worksheet1->write_string($baris, 27, $mamet['ket6']);
        $worksheet1->write_string($baris, 28, $mamet['catatan']);
        $worksheet1->write_string($baris, 29, $statusDataSPK);
        $worksheet1->write_string($baris, 30, $metDN['dn_kode']);
        $worksheet1->write_string($baris, 31, _convertDate($metDN['tgl_createdn']));
        $worksheet1->write_string($baris, 32, _convertDate($metDN['tgl_klaim']));
        $baris++;
    }
    $workbook->close();
            ;
  ...
  case "eL_RekapSPK":
    function HeaderingExcel($filename)
    {
        ...
        $worksheet1->merge_cells(0, 0, 0, 11);	$worksheet1->write_string(0, 0, "REKAPITULASI DATA SPK", $fjudul, 1);
        $worksheet1->merge_cells(1, 0, 1, 11);	$worksheet1->write_string(1, 0, strtoupper($met_c['name']), $fjudul);
        ...
        $worksheet1->set_row(2, 15);
        $worksheet1->set_column(2, 0, 5);	$worksheet1->write_string(2, 0, "NO", $format);
        $worksheet1->set_column(2, 1, 15);	$worksheet1->write_string(2, 1, "NAMA PRODUK", $format);
        $worksheet1->set_column(2, 2, 15);	$worksheet1->write_string(2, 2, "STATUS", $format);
        $worksheet1->set_column(2, 3, 15);	$worksheet1->write_string(2, 3, "NAMA DEBITUR", $format);
        $worksheet1->set_column(2, 4, 15);	$worksheet1->write_string(2, 4, "NOMOR SPK", $format);
        $worksheet1->set_column(2, 5, 15);	$worksheet1->write_string(2, 5, "PREMI", $format);
        $worksheet1->set_column(2, 6, 15);	$worksheet1->write_string(2, 6, "CABANG", $format);
        $worksheet1->set_column(2, 7, 15);	$worksheet1->write_string(2, 7, "TANGGAL SPK", $format);
        $worksheet1->set_column(2, 8, 15);	$worksheet1->write_string(2, 8, "TANGGAL APPROVE SPV", $format);
        $worksheet1->set_column(2, 9, 15);	$worksheet1->write_string(2, 9, "TANGGAL PERIKSA DOKTER CABANG", $format);
        $worksheet1->set_column(2, 10, 15);  $worksheet1->write_string(2, 10, "TANGGAL ASSIGN", $format);
        $worksheet1->set_column(2, 11, 15);  $worksheet1->write_string(2, 11, "USER ASSIGN", $format);
        $worksheet1->set_column(2, 12, 15);  $worksheet1->write_string(2, 12, "TANGGAL EM", $format);
        $worksheet1->set_column(2, 13, 15);  $worksheet1->write_string(2, 13, "USER EM", $format);
        $worksheet1->set_column(2, 14, 10);	$worksheet1->write_string(2, 14, "TANGGAL APPROVE DOKTER ADONAI", $format);
        $worksheet1->set_column(2, 15, 11);	$worksheet1->write_string(2, 15, "INPUT SPK", $format);
    ...
    while ($mamet = mysql_fetch_array($er_data)) {
        ...
        $worksheet1->write_string($baris, 0, ++$no);
        $worksheet1->write_string($baris, 1, $mamet['nmproduk']);
        $worksheet1->write_string($baris, 2, $mamet['status'], "C");
        $worksheet1->write_string($baris, 3, $mamet['nama']);
        $worksheet1->write_string($baris, 4, $mamet['spak'], "C");
        $worksheet1->write_number($baris, 5, $mamet['x_premi'], "R");
        $worksheet1->write_string($baris, 6, $inputcabang, "C");
        $worksheet1->write_string($baris, 7, _ConvertDate($mamet['tglInput']));
        $worksheet1->write_string($baris, 8, _ConvertDate($mamet['tglApprove']));
        $worksheet1->write_string($baris, 9, _ConvertDate($mamet['ApproveTglDokterCabang']));
        $worksheet1->write_string($baris, 10, _ConvertDate($mamet['assign_date']));
        $worksheet1->write_string($baris, 11, $mamet['assign_by']);
        $worksheet1->write_string($baris, 12, _ConvertDate($mamet['approve_em_date']));
        $worksheet1->write_string($baris, 13, $mamet['approve_em_by']);
        $worksheet1->write_string($baris, 14, _ConvertDate($mamet['ApproveTglDokterUW']));
        $worksheet1->write_string($baris, 15, $_nmMarketing);
    ...
    if ($_REQUEST['dncreate']==$_REQUEST['dncreate1']) {
        ...
        $worksheet1->merge_cells(0, 0, 0, 16);	$worksheet1->write_string(0, 0, "LAPORAN PRODUKSI PESERTA ASURANSI JIWA KUMPULAN REGULER", $fjudul, 1);
        $worksheet1->merge_cells(1, 0, 1, 16);	$worksheet1->write_string(1, 0, "PERIODE "._convertDate($_REQUEST['tgl1'])." S/D "._convertDate($_REQUEST['tgl2'])."", $fjudul);
        $worksheet1->merge_cells(2, 0, 2, 16);	$worksheet1->write_string(2, 0, strtoupper($met_c['name']), $fjudul);
        ...
        $worksheet1->set_column(4, 16, 15);	$worksheet1->write_string(4, 16, "ASURANSI", $format);
    ...
    while ($mamet = mysql_fetch_array($er_data)) {
        ...
        $worksheet1->write_string($baris, 8, $mamet['kredit_jumlah']);
        ...
        $worksheet1->write_string($baris, 13, $mamet['']);
        $worksheet1->write_string($baris, 14, $mamet['']);
        $worksheet1->write_string($baris, 15, $mamet['totalpremi']);
        $worksheet1->write_string($baris, 16, $cekdataAS['name']);
        $baris++;
    }
        $workbook->close();
        ;
    ...
    if ($_REQUEST['dncreate']==$_REQUEST['dncreate1']) {
        ...
        $worksheet1->merge_cells(0, 0, 0, 20);	$worksheet1->write_string(0, 0, "LAPORAN PEMBATALAN PESERTA ASURANSI JIWA KREDIT (AJK)", $fjudul, 1);
        $worksheet1->merge_cells(1, 0, 1, 20);	$worksheet1->write_string(1, 0, "PERIODE "._convertDate($_REQUEST['tgl1'])." S/D "._convertDate($_REQUEST['tgl2'])."", $fjudul);
        $worksheet1->merge_cells(2, 0, 2, 20);	$worksheet1->write_string(2, 0, strtoupper($met_c['name']), $fjudul);


        $worksheet1->set_row(4, 15);
        $worksheet1->set_column(4, 0, 5);	$worksheet1->write_string(4, 0, "NO", $format);
        $worksheet1->set_column(4, 1, 15);	$worksheet1->write_string(4, 1, "ASURANSI", $format);
        $worksheet1->set_column(4, 2, 15);	$worksheet1->write_string(4, 2, "ID PESERTA", $format);
        $worksheet1->set_column(4, 3, 15);	$worksheet1->write_string(4, 3, "NAMA DEBITUR", $format);
        $worksheet1->set_column(4, 4, 15);	$worksheet1->write_string(4, 4, "REGIONAL", $format);
        $worksheet1->set_column(4, 5, 15);	$worksheet1->write_string(4, 5, "CABANG", $format);
        $worksheet1->set_column(4, 6, 10);	$worksheet1->write_string(4, 6, "TGL LAHIR", $format);
        $worksheet1->set_column(4, 7, 5);	$worksheet1->write_string(4, 7, "USIA", $format);
        $worksheet1->set_column(4, 8, 10);	$worksheet1->write_string(4, 8, "PLAFOND", $format);
        $worksheet1->set_column(4, 9, 5);	$worksheet1->write_string(4, 9, "JK.W", $format);
        $worksheet1->set_column(4, 10, 5);	$worksheet1->write_string(4, 10, "Grace Period", $format);
        $worksheet1->set_column(4, 11, 15);	$worksheet1->write_string(4, 11, "TGL AKAD", $format);
        $worksheet1->set_column(4, 12, 15);	$worksheet1->write_string(4, 12, "TGL AKHIR", $format);
        $worksheet1->set_column(4, 13, 10);	$worksheet1->write_string(4, 13, "RATE", $format);
        $worksheet1->set_column(4, 14, 10);	$worksheet1->write_string(4, 14, "PREMI", $format);
        $worksheet1->set_column(4, 15, 10);	$worksheet1->write_string(4, 15, "E.M", $format);
        $worksheet1->set_column(4, 16, 10);	$worksheet1->write_string(4, 16, "TOTAL PREMI", $format);
        $worksheet1->set_column(4, 17, 10);	$worksheet1->write_string(4, 17, "PREMI REFUND", $format);
        $worksheet1->set_column(4, 18, 15);	$worksheet1->write_string(4, 18, "PRODUK", $format);
        $worksheet1->set_column(4, 19, 10);	$worksheet1->write_string(4, 19, "TGL BATAL", $format);
        $worksheet1->set_column(4, 20, 15);	$worksheet1->write_string(4, 20, "ALASAN", $format);
        $worksheet1->set_column(4, 21, 15);	$worksheet1->write_string(4, 21, "DEBIT NOTE", $format);
        $worksheet1->set_column(4, 22, 15);	$worksheet1->write_string(4, 22, "CREDIT NOTE", $format);
    ...
    while ($met_ = mysql_fetch_array($met)) {
        ...
        $worksheet1->write_string($baris, 0, ++$no);
        $worksheet1->write_string($baris, 1, $met_dn_Asuransi['name']);
        $worksheet1->write_string($baris, 2, $met_['id_peserta']);
        $worksheet1->write_string($baris, 3, $met_peserta['nama']);
        $worksheet1->write_string($baris, 4, $met_['id_regional']);
        $worksheet1->write_string($baris, 5, $met_['id_cabang']);
        $worksheet1->write_string($baris, 6, _convertDate($met_peserta['tgl_lahir']));
        $worksheet1->write_number($baris, 7, $met_peserta['usia']);
        $worksheet1->write_number($baris, 8, $met_peserta['kredit_jumlah']);
        $worksheet1->write_string($baris, 9, $met_peserta['kredit_tenor']);
        $worksheet1->write_string($baris, 10, $met_peserta['mppbln']);
        $worksheet1->write_string($baris, 11, _convertDate($met_peserta['kredit_tgl']));
        $worksheet1->write_string($baris, 12, _convertDate($met_peserta['kredit_akhir']));
        $worksheet1->write_string($baris, 13, $cekdataret['rate']);
        $worksheet1->write_number($baris, 14, $met_peserta['premi']);
        $worksheet1->write_string($baris, 15, $met_peserta['ext_premi']);
        $worksheet1->write_number($baris, 16, $met_peserta['totalpremi']);
        $worksheet1->write_number($baris, 17, $met['premi']);
        $worksheet1->write_string($baris, 18, $met_produk['nmproduk']);
        $worksheet1->write_string($baris, 19, $tglbatal[0]);
        $worksheet1->write_string($baris, 20, $tglbatal[1]);
        $worksheet1->write_string($baris, 21, $met_dn['dn_kode']);
        $worksheet1->write_string($baris, 22, $met_['id_cn']);
        $baris++;
    }
        $workbook->close();
        ;
  ...
  case "eL_rmf":
    ...
    if ($_REQUEST['dncreate']==$_REQUEST['dncreate1']) {
        ...
        $fjudul =& $workbook->add_format();	$fjudul->set_align('vcenter');	$fjudul->set_align('center');	$fjudul->set_bold();
        $fjudul1 =& $workbook->add_format();	$fjudul1->set_align('vcenter');	$fjudul1->set_align('center');
        $fjudul2 =& $workbook->add_format();	$fjudul2->set_align('vcenter');	$fjudul2->set_align('right');
        $fjudul3 =& $workbook->add_format();	$fjudul3->set_align('vcenter');	$fjudul3->set_align('center');
    ...
    */
        ...
        $worksheet1->merge_cells(4, 0, 4, 1);	$worksheet1->write_string(4, 0, "Nama Perusahaan", $fjudul, 1);
        $worksheet1->merge_cells(4, 2, 4, 10);	$worksheet1->write_string(4, 2, ": " .$_namaperusahaan['name'], $fjudul, 1);

        $worksheet1->merge_cells(4, 12, 4, 13);	$worksheet1->write_string(4, 12, "Tanggal Akad", $fjudul1, 1);
        $worksheet1->merge_cells(4, 14, 4, 15);	$worksheet1->write_string(4, 14, ": " ._convertDate($_REQUEST['tgl1']).' - '._convertDate($_REQUEST['tgl2']), $fjudul1, 1);

        $worksheet1->merge_cells(5, 0, 5, 1);	$worksheet1->write_string(5, 0, "Nama Produk", $fjudul1, 1);
        $worksheet1->merge_cells(5, 2, 5, 10);	$worksheet1->write_string(5, 2, ": " .$_namaproduknya_, $fjudul1, 1);

        $worksheet1->merge_cells(5, 12, 5, 13);	$worksheet1->write_string(5, 12, "Regional", $fjudul1, 1);
        $worksheet1->merge_cells(5, 14, 5, 15);	$worksheet1->write_string(5, 14, ": " .$regionalnya, $fjudul1, 1);

        $worksheet1->merge_cells(6, 0, 6, 1);	$worksheet1->write_string(6, 0, "Status Peserta", $fjudul1, 1);
        $worksheet1->merge_cells(6, 2, 6, 10);	$worksheet1->write_string(6, 2, ": " .$_statusbayar, $fjudul1, 1);

        $worksheet1->merge_cells(6, 12, 6, 13);	$worksheet1->write_string(6, 12, "Cabang", $fjudul1, 1);
        $worksheet1->merge_cells(6, 14, 6, 15);	$worksheet1->write_string(6, 14, ": " .$cabangnya, $fjudul1, 1);

        $worksheet1->merge_cells(7, 0, 7, 1);	$worksheet1->write_string(7, 0, "Premi RMF", $fjudul, 1);
        $worksheet1->merge_cells(7, 2, 7, 10);	$worksheet1->write_string(7, 2, ": " .ROUND($met_cekdata_paid_rmf), $fjudul, 1);

        $worksheet1->merge_cells(8, 0, 8, 1);	$worksheet1->write_string(8, 0, "Premi dibayar", $fjudul1, 1);
        $worksheet1->merge_cells(8, 2, 8, 10);	$worksheet1->write_string(8, 2, ": " .ROUND($met_cekdata_paid), $fjudul1, 1);

        $worksheet1->merge_cells(9, 0, 9, 1);	$worksheet1->write_string(9, 0, "Premi belum dibayar", $fjudul1, 1);
        $worksheet1->merge_cells(9, 2, 9, 10);	$worksheet1->write_string(9, 2, ": " .ROUND($met_cekdata_unpaid), $fjudul1, 1);

        $worksheet1->merge_cells(10, 0, 10, 1);	$worksheet1->write_string(10, 0, "Total", $fjudul, 1);
        $worksheet1->merge_cells(10, 2, 10, 10);$worksheet1->write_string(10, 2, ": " .ROUND($metRMFtotal), $fjudul, 1);

        $worksheet1->set_row(12, 13);
        $worksheet1->set_column(12, 0, 5);	$worksheet1->write_string(12, 0, "NO", $format);
        $worksheet1->set_column(12, 1, 15);	$worksheet1->write_string(12, 1, "NOMOR DN", $format);
        $worksheet1->set_column(12, 2, 15);	$worksheet1->write_string(12, 2, "TGL DN", $format);
        $worksheet1->set_column(12, 3, 15);	$worksheet1->write_string(12, 3, "ID PESERTA", $format);
        $worksheet1->set_column(12, 4, 15);	$worksheet1->write_string(12, 4, "NAMA DEBITUR", $format);
        $worksheet1->set_column(12, 5, 10);	$worksheet1->write_string(12, 5, "CABANG", $format);
        $worksheet1->set_column(12, 6, 10);	$worksheet1->write_string(12, 6, "TGL LAHIR", $format);
        $worksheet1->set_column(12, 7, 5);	$worksheet1->write_string(12, 7, "USIA", $format);
        $worksheet1->set_column(12, 8, 10);	$worksheet1->write_string(12, 8, "PLAFOND", $format);
        $worksheet1->set_column(12, 9, 5);	$worksheet1->write_string(12, 9, "JK.W", $format);
        $worksheet1->set_column(12, 10, 15);	$worksheet1->write_string(12, 10, "MULAI ASURANSI", $format);
        $worksheet1->set_column(12, 11, 15);	$worksheet1->write_string(12, 11, "AKHIR ASURANSI", $format);
        $worksheet1->set_column(12, 12, 15);	$worksheet1->write_string(12, 12, "STATUS", $format);
        $worksheet1->set_column(12, 13, 15);	$worksheet1->write_string(12, 13, "TOTAL PREMI", $format);
        $worksheet1->set_column(12, 14, 15);	$worksheet1->write_string(12, 14, "RMF (paid)", $format);
        $worksheet1->set_column(12, 15, 15);	$worksheet1->write_string(12, 15, "RMF (unpaid)", $format);
    ...
    while ($mamet = mysql_fetch_array($er_data)) {
        ...
        $worksheet1->write_string($baris, 0, ++$no);
        $worksheet1->write_string($baris, 1, $cekdatadn['dn_kode'], $fjudul3);
        $worksheet1->write_string($baris, 2, $cekdatadn['tgl_createdn'], $fjudul3);
        $worksheet1->write_string($baris, 3, $mamet['id_peserta'], $fjudul3);
        $worksheet1->write_string($baris, 4, $mamet['nama']);
        $worksheet1->write_string($baris, 5, $mamet['cabang'], $fjudul3);
        $worksheet1->write_string($baris, 6, _convertDate($mamet['tgl_lahir']), $fjudul3);
        $worksheet1->write_string($baris, 7, $mamet['usia'], $fjudul3);
        $worksheet1->write_string($baris, 8, $mamet['kredit_jumlah'], $fjudul2);
        $worksheet1->write_string($baris, 9, $mamet['kredit_tenor'], $fjudul3);
        $worksheet1->write_string($baris, 10, _convertDate($mamet['kredit_tgl']), $fjudul3);
        $worksheet1->write_string($baris, 11, _convertDate($mamet['kredit_akhir']), $fjudul3);
        $worksheet1->write_string($baris, 12, $met_bayar, $fjudul3);
        $worksheet1->write_string($baris, 13, ROUND($mamet['totalpremi']), $fjudul2);
        $worksheet1->write_string($baris, 14, ROUND($metrmfnya_paid), $fjudul2);
        $worksheet1->write_string($baris, 15, ROUND($metrmfnya_unpaid), $fjudul2);
        $baris++;
    }
        $workbook->close();
        ;
  ...
  case "eL_dok":
    function HeaderingExcel($filename)
    {
        ...
        $worksheet1->merge_cells(0, 0, 0, 10);	$worksheet1->write_string(0, 0, "LAPORAN DOKTER - SPK REGULER", $fjudul, 1);
        $worksheet1->merge_cells(1, 0, 1, 10);	$worksheet1->write_string(1, 0, strtoupper($met_c['name']), $fjudul);
        $worksheet1->merge_cells(2, 0, 2, 10);	$worksheet1->write_string(2, 0, 'Tanggal Pemeriksaan '._convertDate($_REQUEST['tgl1']) .' s/d '. _convertDate($_REQUEST['tgl2']), $fjudul);
        ...
        $worksheet1->set_column(3, 0, 5);	$worksheet1->write_string(3, 0, "NO", $format);
        $worksheet1->set_column(3, 1, 15);	$worksheet1->write_string(3, 1, "NAMA DOKTER", $format);
        $worksheet1->set_column(3, 2, 15);	$worksheet1->write_string(3, 2, "NAMA DEBITUR", $format);
        $worksheet1->set_column(3, 3, 15);	$worksheet1->write_string(3, 3, "NO.SPK", $format);
        $worksheet1->set_column(3, 4, 15);	$worksheet1->write_string(3, 4, "TANGGAL PERIKSA", $format);
        $worksheet1->set_column(3, 5, 15);	$worksheet1->write_string(3, 5, "USIA", $format);
        $worksheet1->set_column(3, 6, 15);	$worksheet1->write_string(3, 6, "PREMI", $format);
        $worksheet1->set_column(3, 7, 15);	$worksheet1->write_string(3, 7, "EM(%)", $format);
        $worksheet1->set_column(3, 8, 15);	$worksheet1->write_string(3, 8, "NILAI EM", $format);
        $worksheet1->set_column(3, 9, 15);	$worksheet1->write_string(3, 9, "TOTAL PREMI", $format);
        $worksheet1->set_column(3, 10, 15);	$worksheet1->write_string(3, 10, "STATUS", $format);
        $worksheet1->set_column(3, 11, 15);	$worksheet1->write_string(3, 11, "CABANG", $format);
    ...
    while ($mamet = mysql_fetch_array($er_data)) {
        ...
        $worksheet1->write_string($baris, 0, ++$no);
        $worksheet1->write_string($baris, 1, $metUserDok_);
        $worksheet1->write_string($baris, 2, $mamet['nama']);
        $worksheet1->write_string($baris, 3, $mamet['spak'], 'C');
        $worksheet1->write_string($baris, 4, _convertDate($mamet['tgl_periksa']), 'C');
        $worksheet1->write_number($baris, 5, $mamet['x_usia']);
        $worksheet1->write_number($baris, 6, $mamet['x_premi']);
        $worksheet1->write_number($baris, 7, $mamet['ext_premi']);
        $worksheet1->write_number($baris, 8, $mamet['nilai_EM']);
        $worksheet1->write_number($baris, 9, $mamet['TotalPremi']);
        $worksheet1->write_string($baris, 10, $mamet['status']);
        $worksheet1->write_string($baris, 11, $metUserCab_);
        $baris++;
    }
        $workbook->close();
        ;
  ...
  case "eL_refund":
    function HeaderingExcel($filename)
    {
        ...
        $worksheet1->merge_cells(0, 0, 0, 26);	$worksheet1->write_string(0, 0, "LAPORAN DATA REFUND", $fjudul, 1); 
        $worksheet1->merge_cells(1, 0, 1, 26);	$worksheet1->write_string(1, 0, strtoupper($met_c['name']), $fjudul);
        if ($_REQUEST['tgl1']) {
            $worksheet1->merge_cells(2, 0, 2, 26);
            $worksheet1->write_string(2, 0, 'Tanggal Refund '._convertDate($_REQUEST['tgl1']) .' s/d '. _convertDate($_REQUEST['tgl2']), $fjudul);
        } else {
            $worksheet1->merge_cells(2, 0, 2, 26);
            $worksheet1->write_string(2, 0, 'Tanggal Credit Note '._convertDate($_REQUEST['tgl3']) .' s/d '. _convertDate($_REQUEST['tgl4']), $fjudul);
        }
        $format =& $workbook->add_format();
        $format->set_align('vcenter');	$format->set_align('center');	$format->set_color('white');	$format->set_bold();	$format->set_pattern();	$format->set_fg_color('green');
        $fjudul =& $workbook->add_format();	$fjudul->set_align('vcenter');	$fjudul->set_align('center');	$fjudul->set_bold();
        ...
        $worksheet1->set_column(4, 13, 10);	$worksheet1->write_string(4, 13, "RATE", $format);
        $worksheet1->set_column(4, 14, 10);	$worksheet1->write_string(4, 14, "PREMI", $format);
        $worksheet1->set_column(4, 15, 10);	$worksheet1->write_string(4, 15, "EM", $format);
        $worksheet1->set_column(4, 16, 10);	$worksheet1->write_string(4, 16, "TOTAL PREMI", $format);
        $worksheet1->set_column(4, 17, 10);	$worksheet1->write_string(4, 17, "PREMI REFUND", $format);
        $worksheet1->set_column(4, 18, 15);	$worksheet1->write_string(4, 18, "PRODUK", $format);
        $worksheet1->set_column(4, 19, 10);	$worksheet1->write_string(4, 19, "TGL REFUND", $format);
        $worksheet1->set_column(4, 20, 10); $worksheet1->write_string(4, 20, "TGL PROSES", $format); //tambahan hansen
        $worksheet1->set_column(4, 21, 10);	$worksheet1->write_string(4, 21, "TGL CETAK CN", $format); //tambahan hansen
        $worksheet1->set_column(4, 22, 10);	$worksheet1->write_string(4, 22, "TGL DIBAYAR AS", $format); //tambahan hansen
        $worksheet1->set_column(4, 23, 10);	$worksheet1->write_string(4, 23, "TOTAL DIBAYAR AS", $format); //tambahan hansen
        $worksheet1->set_column(4, 24, 15);	$worksheet1->write_string(4, 24, "DEBIT NOTE", $format);
        $worksheet1->set_column(4, 25, 15);	$worksheet1->write_string(4, 25, "CREDIT NOTE", $format);
        $worksheet1->set_column(4, 26, 15);	$worksheet1->write_string(4, 26, "KETERANGAN", $format);
    ...
    $baris = 5;
    $er_data = mysql_query('SELECT *,DATE_FORMAT(input_date,"%Y-%m-%d")as tglproses FROM fu_ajk_cn WHERE id_cn !="" AND type_claim="Refund" AND del is NULL '.$satu.' '.$duaa.' '.$tiga.' '.$empt.' ORDER BY tgl_createcn ASC, id_cabang ASC');
    
    //$worksheet1->write_string(1, 100, 'SELECT *,DATE_FORMAT(input_date,"%Y-%m-%d")as tglproses FROM fu_ajk_cn WHERE id_cn !="" AND type_claim="Refund" AND del is NULL '.$satu.' '.$duaa.' '.$tiga.' '.$empt.' ORDER BY tgl_createcn ASC, id_cabang ASC');
    ...
    while ($mamet = mysql_fetch_array($er_data)) {
        ...
        if ($met_peserta['type_data']=="SPK") {
            if ($met_peserta['danatalangan'] != "") {
                $tenorpeserta = $met_peserta['kredit_tenor'];
            } else {
                $tenorpeserta = $met_peserta['kredit_tenor']*12;
            }
        } else {
            $tenorpeserta = $met_peserta['kredit_tenor'];
        }
        ...
        //                                                                                     THEN 'mpp' END,'')AS datampp
        //                                                                     FROM fu_ajk_spak_form AS F, fu_ajk_spak AS S,fu_ajk_polis AS P
        //                                                                     WHERE S.spak='".$met_peserta['spaj']."' AND F.idspk=S.id
        //                                                                     AND P.id = S.id_polis"));
        ...
        $worksheet1->write_string($baris, 1, $met_dn_Asuransi['name']);
        $worksheet1->write_string($baris, 2, $mamet['id_peserta']);
        $worksheet1->write_string($baris, 3, $met_peserta['nama']);
        $worksheet1->write_string($baris, 4, $mamet['id_regional']);
        $worksheet1->write_string($baris, 5, $mamet['id_cabang']);
        $worksheet1->write_string($baris, 6, _convertDate($met_peserta['tgl_lahir']));
        $worksheet1->write_number($baris, 7, $met_peserta['usia'], "C");
        $worksheet1->write_number($baris, 8, $met_peserta['kredit_jumlah']);
        $worksheet1->write_number($baris, 9, $tenorpeserta);
        $worksheet1->write_number($baris, 10, $met_peserta['mppbln']);
        $worksheet1->write_string($baris, 11, _convertDate($met_peserta['kredit_tgl']));
        $worksheet1->write_string($baris, 12, _convertDate($met_peserta['kredit_akhir']));
        $worksheet1->write_string($baris, 13, $rate);
        $worksheet1->write_number($baris, 14, $met_peserta['premi']);
        $worksheet1->write_number($baris, 15, $met_peserta['ext_premi']);
        $worksheet1->write_number($baris, 16, $met_peserta['totalpremi']);
        $worksheet1->write_number($baris, 17, $mamet['total_claim']);
        $worksheet1->write_string($baris, 18, $met_produk['nmproduk']);
        $worksheet1->write_string($baris, 19, _convertDate($mamet['tgl_claim']));
        $worksheet1->write_string($baris, 20, _convertDate($mamet['tglproses'])); //tambahan hansen
        $worksheet1->write_string($baris, 21, _convertDate($mamet['tgl_createcn'])); //tambahan hansen
        $worksheet1->write_string($baris, 22, _convertDate($mamet['tgl_bayar_asuransi'])); //tambahan hansen
        $worksheet1->write_number($baris, 23, $mamet['total_bayar_asuransi']); //tambahan hansen
        $worksheet1->write_string($baris, 24, $met_dn['dn_kode']);
        $worksheet1->write_string($baris, 25, $mamet['id_cn']);
        $worksheet1->write_string($baris, 26, $ketRefund);
        $baris++;
    }
        $workbook->close();
        ;
  ...
  case "eL_klaim":
    function HeaderingExcel($filename)
    {
        ...
        $worksheet1->merge_cells(0, 0, 0, 19);	$worksheet1->write_string(0, 0, "ALL KLAIM AJK ".  strtoupper($met_c['name']). ' BELUM CLOSE LIFE', $fjudul, 1);
        $worksheet1->merge_cells(1, 0, 1, 19);	$worksheet1->write_string(1, 0, 'PER TANGGAL CREDITNOTE '._convertDate($_REQUEST['tgl3']) .' s/d '. _convertDate($_REQUEST['tgl4']), $fjudul);
        if ($_REQUEST['kat']=="") {
            $worksheet1->merge_cells(2, 0, 2, 19);
            $worksheet1->write_string(2, 0, 'PENYEBAB MENINGGAL : 9 JENIS PENYAKIT ', $fjudul);
        } else {
            $metPenyakit = mysql_fetch_array(mysql_query('SELECT id, namapenyakit FROM fu_ajk_namapenyakit WHERE id="'.$_REQUEST['kat'].'"'));
            $worksheet1->merge_cells(2, 0, 2, 19);
            $worksheet1->write_string(2, 0, 'PENYEBAB MENINGGAL : '.strtoupper($metPenyakit['namapenyakit']), $fjudul);
        }
        ...
        $worksheet1->set_column(4, 0, 5);	$worksheet1->write_string(4, 0, "NO", $format);
        $worksheet1->set_column(4, 1, 15);	$worksheet1->write_string(4, 1, "Cabang", $format);
        $worksheet1->set_column(4, 2, 15);	$worksheet1->write_string(4, 2, "Cover Asuransi", $format);
        $worksheet1->set_column(4, 3, 15);	$worksheet1->write_string(4, 3, "ID Peserta", $format);
        $worksheet1->set_column(4, 4, 15);	$worksheet1->write_string(4, 4, "Nama Debitur", $format);
        ...
        $worksheet1->set_column(4, 7, 15);	$worksheet1->write_string(4, 7, "Jml Kredit", $format);
        ...
        $worksheet1->set_column(4, 10, 15);	$worksheet1->write_string(4, 10, "J.Wkt", $format);
        $worksheet1->set_column(4, 11, 15);	$worksheet1->write_string(4, 11, "DOL", $format);
        $worksheet1->set_column(4, 12, 15);	$worksheet1->write_string(4, 12, "Akad s/d DOL (hari)", $format);
        $worksheet1->set_column(4, 13, 15);	$worksheet1->write_string(4, 13, "Tgl. Lapor Asuransi", $format);
        $worksheet1->set_column(4, 14, 15);	$worksheet1->write_string(4, 14, "Kelengkapan Dok Klaim", $format);
        $worksheet1->set_column(4, 15, 15);	$worksheet1->write_string(4, 15, "Tgl Status Lengkap", $format);
        $worksheet1->set_column(4, 16, 15);	$worksheet1->write_string(4, 16, "Reminder Ke", $format);
        $worksheet1->set_column(4, 17, 15);	$worksheet1->write_string(4, 17, "Tgl Reminder", $format);
        $worksheet1->set_column(4, 18, 15);	$worksheet1->write_string(4, 18, "Dokumen", $format);
        $worksheet1->set_column(4, 19, 15);	$worksheet1->write_string(4, 19, "Status Klaim", $format);
        $worksheet1->set_column(4, 20, 15);	$worksheet1->write_string(4, 20, "Total Bayar dari Asuransi", $format);
        $worksheet1->set_column(4, 21, 15);	$worksheet1->write_string(4, 21, "Tgl Bayar dari Asuransi", $format);
        $worksheet1->set_column(4, 22, 15);	$worksheet1->write_string(4, 22, "Total Bayar ke Bank", $format);
        $worksheet1->set_column(4, 23, 15);	$worksheet1->write_string(4, 23, "Tgl Bayar ke Bank", $format);
        $worksheet1->set_column(4, 24, 15);	$worksheet1->write_string(4, 24, "No SPK", $format);
        $worksheet1->set_column(4, 25, 15);	$worksheet1->write_string(4, 25, "Keterangan Dokter", $format);
        $worksheet1->set_column(4, 26, 15);	$worksheet1->write_string(4, 26, "Keterangan", $format);
        $worksheet1->set_column(4, 27, 15);	$worksheet1->write_string(4, 27, "Produk", $format);
        $worksheet1->set_column(4, 28, 15);	$worksheet1->write_string(4, 28, "Sebab Meninggal", $format);
        $worksheet1->set_column(4, 29, 15);	$worksheet1->write_string(4, 29, "Bln Dol", $format);
        $worksheet1->set_column(4, 30, 15);	$worksheet1->write_string(4, 30, "Thn Dol", $format);
        $worksheet1->set_column(4, 31, 15);	$worksheet1->write_string(4, 31, "Thn Akad", $format);
        $worksheet1->set_column(4, 32, 15);	$worksheet1->write_string(4, 32, "KOL", $format);
        if ($_REQUEST['cat']) {
    ...
    while ($mamet = mysql_fetch_array($er_data)) {
        ...
        $worksheet1->write_number($baris, 0, ++$no);
        $worksheet1->write_string($baris, 1, $mamet['id_cabang']);
        $worksheet1->write_string($baris, 2, $mamet['nmAsuransi']);
        $worksheet1->write_string($baris, 3, $mamet['id_peserta']);
        $worksheet1->write_string($baris, 4, $mamet['nama'], 'C');
        $worksheet1->write_string($baris, 5, _convertDate($mamet['tgl_lahir']));
        $worksheet1->write_number($baris, 6, $mamet['usia'], 'C');
        $worksheet1->write_number($baris, 7, $mamet['kredit_jumlah']);
        $worksheet1->write_number($baris, 8, $mamet['tuntutan_klaim']);
        $worksheet1->write_string($baris, 9, _convertDate($mamet['kredit_tgl']));
        $worksheet1->write_number($baris, 10, $mamet['kredit_tenor'], 'C');
        $worksheet1->write_string($baris, 11, _convertDate($mamet['tgl_claim']));
        $worksheet1->write_number($baris, 12, $mamet['jHari'], 'C');
        $worksheet1->write_string($baris, 13, '');
        $worksheet1->write_string($baris, 14, $jumDok .'-'. $cekDok);
        $worksheet1->write_string($baris, 15, _convertDate($cekTglKlaim['tgl_document_lengkap']));
        $worksheet1->write_string($baris, 16, $reminder_ke);
        $worksheet1->write_string($baris, 17, _convertDate($tgl_reminder));
        $worksheet1->write_string($baris, 18, $statusDokumen);
        $worksheet1->write_string($baris, 19, $mamet['status_klaim']);
        $worksheet1->write_number($baris, 20, $mamet['total_bayar_asuransi']);
        $worksheet1->write_string($baris, 21, _convertDate($mamet['tgl_bayar_asuransi']));
        $worksheet1->write_number($baris, 22, $mamet['total_claim']);
        $worksheet1->write_string($baris, 23, _convertDate($mamet['tgl_byr_claim']));
        $worksheet1->write_string($baris, 24, $mamet['spaj']);
        $worksheet1->write_string($baris, 25, $mamet['ketDokter']);
        $worksheet1->write_string($baris, 26, $mamet['keterangan']);
        $worksheet1->write_string($baris, 27, $mamet['nmproduk']);
        $worksheet1->write_string($baris, 28, strtoupper($mamet['namapenyakit']));
        $worksheet1->write_string($baris, 29, $tgl_klaim[1]);
        $worksheet1->write_string($baris, 30, $tgl_klaim[0]);
        $worksheet1->write_string($baris, 31, $kredit_tgl[0]);
        $worksheet1->write_string($baris, 32, $kol);
        $baris++;
    }
        /* 150515
        $met_c = mysql_fetch_array(mysql_query('SELECT id, name FROM fu_ajk_costumer WHERE id="'.$_REQUEST['cat'].'"'));
        ...
        $worksheet1->merge_cells(0, 0, 0, 10);	$worksheet1->write_string(0, 0, "LAPORAN DATA KLAIM", $fjudul, 1);
        $worksheet1->merge_cells(1, 0, 1, 10);	$worksheet1->write_string(1, 0, strtoupper($met_c['name']), $fjudul);
        $worksheet1->merge_cells(2, 0, 2, 10);	$worksheet1->write_string(2, 0, 'Tanggal Credit Note '._convertDate($_REQUEST['tgl1']) .' s/d '. _convertDate($_REQUEST['tgl2']), $fjudul);
        ...
        $worksheet1->set_row(3, 15);
        $worksheet1->set_column(3, 0, 5);	$worksheet1->write_string(3, 0, "NO", $format);
        $worksheet1->set_column(3, 1, 15);	$worksheet1->write_string(3, 1, "PRODUK", $format);
        $worksheet1->set_column(3, 2, 15);	$worksheet1->write_string(3, 2, "NO.PESERTA", $format);
        $worksheet1->set_column(3, 3, 15);	$worksheet1->write_string(3, 3, "NAMA DEBITUR", $format);
        $worksheet1->set_column(3, 4, 15);	$worksheet1->write_string(3, 4, "DEBIT NOTE", $format);
        $worksheet1->set_column(3, 5, 15);	$worksheet1->write_string(3, 5, "CREDIT NOTE", $format);
        $worksheet1->set_column(3, 6, 15);	$worksheet1->write_string(3, 6, "TGL CN", $format);
        $worksheet1->set_column(3, 7, 15);	$worksheet1->write_string(3, 7, "TGL KLAIM", $format);
        $worksheet1->set_column(3, 8, 15);	$worksheet1->write_string(3, 8, "PREMI", $format);
        $worksheet1->set_column(3, 9, 15);	$worksheet1->write_string(3, 9, "NILAI KLAIM", $format);
        $worksheet1->set_column(3, 10, 15);	$worksheet1->write_string(3, 10, "CABANG", $format);
    ...
    while ($mamet = mysql_fetch_array($er_data))
    {
        ...
        $worksheet1->write_string($baris, 0, ++$no);
        $worksheet1->write_string($baris, 1, $met_produk['nmproduk']);
        $worksheet1->write_string($baris, 2, $mamet['id_peserta']);
        $worksheet1->write_string($baris, 3, $met_peserta['nama']);
        $worksheet1->write_string($baris, 4, $met_dn['dn_kode'], 'C');
        $worksheet1->write_string($baris, 5, $mamet['id_cn']);
        $worksheet1->write_string($baris, 6, _convertDate($mamet['tgl_createcn']));
        $worksheet1->write_string($baris, 7, _convertDate($mamet['tgl_claim']));
        $worksheet1->write_number($baris, 8, $mamet['premi']);
        $worksheet1->write_number($baris, 9, $mamet['total_claim']);
        $worksheet1->write_string($baris, 10, $mamet['id_cabang']);
        $baris++;
    }
           */
        $workbook->close();
  ...
  case "eL_CoveringLetter":
    function HeaderingExcel($filename)
    {
        ...
        $worksheet1->merge_cells(0, 0, 0, 9);	$worksheet1->write_string(0, 0, "COVERING LETTER", $fjudul, 1);
        $worksheet1->merge_cells(1, 0, 1, 9);	$worksheet1->write_string(1, 0, strtoupper($met_c['name']), $fjudul);
        $worksheet1->merge_cells(2, 0, 2, 9);	$worksheet1->write_string(2, 0, 'CABANG '.strtoupper($_REQUEST['cbg']), $fjudul);
        ...
        $worksheet1->set_row(4, 15);
        $worksheet1->set_column(4, 0, 5);	$worksheet1->write_string(4, 0, "NO", $format);
        $worksheet1->set_column(4, 1, 15);	$worksheet1->write_string(4, 1, "NAMA PRODUK", $format);
        $worksheet1->set_column(4, 2, 15);	$worksheet1->write_string(4, 2, "NOMOR DN", $format);
        $worksheet1->set_column(4, 3, 15);	$worksheet1->write_string(4, 3, "TANGGAL DN", $format);
        $worksheet1->set_column(4, 4, 15);	$worksheet1->write_string(4, 4, "NOMOR SPK", $format);
        $worksheet1->set_column(4, 5, 15);	$worksheet1->write_string(4, 5, "ID PESERTA", $format);
        $worksheet1->set_column(4, 6, 15);	$worksheet1->write_string(4, 6, "NAMA DEBITUR", $format);
        $worksheet1->set_column(4, 7, 15);	$worksheet1->write_string(4, 7, "PREMI", $format);
        $worksheet1->set_column(4, 8, 15);	$worksheet1->write_string(4, 8, "EM", $format);
        $worksheet1->set_column(4, 9, 15);	$worksheet1->write_string(4, 9, "JUMLAH", $format);
        $baris = 5;
        ...
        while ($metCL_ = mysql_fetch_array($metCL)) {
            $worksheet1->write_string($baris, 0, ++$no);
            $worksheet1->write_string($baris, 1, $metCL_['nmproduk']);
            $worksheet1->write_string($baris, 2, $metCL_['dn_kode']);
            $worksheet1->write_string($baris, 3, _convertDate($metCL_['tgl_createdn']), 'C');
            $worksheet1->write_string($baris, 4, $metCL_['spaj'], 'C');
            $worksheet1->write_string($baris, 5, $metCL_['id_peserta']);
            $worksheet1->write_string($baris, 6, $metCL_['nama']);
            $worksheet1->write_number($baris, 7, $metCL_['premi']);
            $worksheet1->write_number($baris, 8, $metCL_['ext_premi']);
            $worksheet1->write_number($baris, 9, $metCL_['totalpremi']);
            $baris++;
            $tPlafond += ROUND($metCL_['premi']);
            $tTotalEM += ROUND($metCL_['ext_premi']);
            $tTotalPremi += ROUND($metCL_['totalpremi']);
        }
        $worksheet1->merge_cells($baris, 0, $baris, 6);		$worksheet1->write_string($baris, 0, "TOTAL", $fjudul);
        $worksheet1->write_string($baris, 7, $tPlafond, $fjudul);
        $worksheet1->write_string($baris, 8, $tTotalEM, $fjudul);
        $worksheet1->write_string($baris, 9, $tTotalPremi, $fjudul);
        $workbook->close();
        ;
  break;
  ...
  case "eL_PrintCoveringLetterALLCab":
    function HeaderingExcel($filename)
    {
        ...
        $worksheet1->merge_cells(0, 0, 0, 6);	$worksheet1->write_string(0, 0, "LAPORAN DATA COVERING LETTER CABANG", $fjudul, 1);
        $worksheet1->merge_cells(1, 0, 1, 6);	$worksheet1->write_string(1, 0, strtoupper($met_c['name']), $fjudul);
        if ($_REQUEST['tgl1']) {
            $worksheet1->merge_cells(2, 0, 2, 6);
            $worksheet1->write_string(2, 0, 'Tanggal Debitnote  '._convertDate($_REQUEST['tgl1']) .' s/d '. _convertDate($_REQUEST['tgl2']), $fjudul);
        }
        $format =& $workbook->add_format();
        $format->set_align('vcenter');	$format->set_align('center');	$format->set_color('white');	$format->set_bold();	$format->set_pattern();	$format->set_fg_color('green');
        $fjudul =& $workbook->add_format();	$fjudul->set_align('vcenter');	$fjudul->set_align('center');	$fjudul->set_bold();
        ...
        $worksheet1->set_column(4, 1, 15);	$worksheet1->write_string(4, 1, "CABANG", $format);
        $worksheet1->set_column(4, 2, 15);	$worksheet1->write_string(4, 2, "PRODUK", $format);
        $worksheet1->set_column(4, 3, 15);	$worksheet1->write_string(4, 3, "JUMLAH PESERTA", $format);
        $worksheet1->set_column(4, 4, 15);	$worksheet1->write_string(4, 4, "JUMLAH PLAFOND", $format);
        $worksheet1->set_column(4, 5, 15);	$worksheet1->write_string(4, 5, "PREMI", $format);
        $worksheet1->set_column(4, 6, 10);	$worksheet1->write_string(4, 6, "EM", $format);
        $worksheet1->set_column(4, 7, 5);	$worksheet1->write_string(4, 7, "TOTAL PREMI", $format);
    if ($_REQUEST['id_cost']) {
        $satu = 'AND fu_ajk_dn.id_cost = "'.$_REQUEST['id_cost'].'"';
    }
    if ($_REQUEST['nmProd']) {
    ...
    while ($metCabang_ = mysql_fetch_array($metCabang)) {
        ...
        $worksheet1->write_number($baris, 0, ++$no);
        $worksheet1->write_string($baris, 1, $metCabang_['id_cabang']);
        $worksheet1->write_string($baris, 2, $produknya);
        $worksheet1->write_number($baris, 3, $metCabang_['jDN']);
        $worksheet1->write_number($baris, 4, $metCabang_['tPlafond']);
        $worksheet1->write_number($baris, 5, $metCabang_['tPremi'], "R");
        $worksheet1->write_number($baris, 6, $metCabang_['tEM'], "R");
        $worksheet1->write_number($baris, 7, $metCabang_['tTotalpremi'], "R");
        $baris++;
    }
  ...
  case "eL_HistUser":
    ...
    if ($_REQUEST['tgldn1']) {
        ...
        $worksheet1->merge_cells(0, 0, 0, 8);	$worksheet1->write_string(0, 0, "HISTORY LOG USER WEBSITE", $fjudul, 1);
        $worksheet1->merge_cells(1, 0, 1, 8);	$worksheet1->write_string(1, 0, "TANGGAL LOGIN "._convertDate($_REQUEST['tgldn1'])." s/d "._convertDate($_REQUEST['tgldn2'])."", $fjudul);
        $worksheet1->set_row(3, 15);
        $worksheet1->set_column(3, 0, 5);	$worksheet1->write_string(3, 0, "NO", $format);
        $worksheet1->set_column(3, 1, 10);	$worksheet1->write_string(3, 1, "USER", $format);
        $worksheet1->set_column(3, 2, 10);	$worksheet1->write_string(3, 2, "TANGGAL LOGIN", $format);
        $worksheet1->set_column(3, 3, 10);	$worksheet1->write_string(3, 3, "WAKTU LOGIN", $format);
        $worksheet1->set_column(3, 4, 10);	$worksheet1->write_string(3, 4, "TANGGAL LOGOUT", $format);
        $worksheet1->set_column(3, 5, 10);	$worksheet1->write_string(3, 5, "WAKTU LOGOUT", $format);
        $worksheet1->set_column(3, 6, 10);	$worksheet1->write_string(3, 6, "IP ADDRESS", $format);
        $worksheet1->set_column(3, 7, 25);	$worksheet1->write_string(3, 7, "NAMA KOMPUTER", $format);
        $worksheet1->set_column(3, 8, 25);	$worksheet1->write_string(3, 8, "BROWSER", $format);
        $baris = 4;
    ...
    while ($jangkrik = mysql_fetch_array($kucing)) {
        ...
        $worksheet1->write_number($baris, 0, ++$no);
        $worksheet1->write_string($baris, 1, $userweb['nm_lengkap']);
        $worksheet1->write_string($baris, 2, $jangkrik['lastdate_login']);
        $worksheet1->write_string($baris, 3, $jangkrik['lasttime_login']);
        $worksheet1->write_string($baris, 4, $jangkrik['lastdate_logout']);
        $worksheet1->write_string($baris, 5, $jangkrik['lasttime_logout']);
        $worksheet1->write_string($baris, 6, $jangkrik['user_ip']);
        $worksheet1->write_string($baris, 7, $jangkrik['user_referer']);
        $worksheet1->write_string($baris, 8, $jangkrik['user_browser']);
        $baris++;
    }
  ...
  case "eL_HistSPK":
    ...
    $met_c = mysql_fetch_array(mysql_query('SELECT id, name FROM fu_ajk_costumer WHERE id="'.$_REQUEST['idCost'].'"'));
    $worksheet1->merge_cells(0, 0, 0, 11);	$worksheet1->write_string(0, 0, "LAPORAN HISTORICAL SPK", $fjudul, 1);
    $worksheet1->merge_cells(1, 0, 1, 11);	$worksheet1->write_string(1, 0, strtoupper($met_c['name']), $fjudul);
    $worksheet1->merge_cells(2, 0, 2, 11);	$worksheet1->write_string(2, 0, "PERIODE "._ConvertDate($_REQUEST['tgl1'])." s/d "._ConvertDate($_REQUEST['tgl2']), $fjudul);
    ...
    $worksheet1->set_row(3, 15);
    $worksheet1->set_column(3, 0, 5);	$worksheet1->write_string(3, 0, "NO", $format);
    $worksheet1->set_column(3, 1, 15);	$worksheet1->write_string(3, 1, "NOMOR SPK", $format);
    $worksheet1->set_column(3, 2, 15);	$worksheet1->write_string(3, 2, "ID CN", $format);
    $worksheet1->set_column(3, 3, 15);	$worksheet1->write_string(3, 3, "ID PESERTA", $format);
    $worksheet1->set_column(3, 4, 15);	$worksheet1->write_string(3, 4, "NAMA PESERTA", $format);
    $worksheet1->set_column(3, 5, 15);	$worksheet1->write_string(3, 5, "NAMA MARKETING", $format);
    $worksheet1->set_column(3, 6, 15);	$worksheet1->write_string(3, 6, "TANGGAL SPK", $format);
    $worksheet1->set_column(3, 7, 15);	$worksheet1->write_string(3, 7, "PLAFON", $format);
    $worksheet1->set_column(3, 8, 15);	$worksheet1->write_string(3, 8, "PREMI", $format);
    $worksheet1->set_column(3, 9, 15);	$worksheet1->write_string(3, 9, "NAMA DOKTER PERIKSA", $format);
    $worksheet1->set_column(3, 10, 15);	$worksheet1->write_string(3, 10, "TANGGAL DOKTER PERIKSA", $format);
    $worksheet1->set_column(3, 11, 10);	$worksheet1->write_string(3, 11, "CABANG ", $format);
    ...
    while ($mamet = mysql_fetch_array($er_data)) {
        ...
        $worksheet1->write_number($baris, 0, ++$no);
        $worksheet1->write_string($baris, 1, $mamet['spak']);
        $worksheet1->write_string($baris, 2, $mamet['id_cn']);
        $worksheet1->write_string($baris, 3, $mamet['id_peserta'], "C");
        $worksheet1->write_string($baris, 4, $mamet['nama']);
        $worksheet1->write_string($baris, 5, $_nmMarketing);
        $worksheet1->write_string($baris, 6, _ConvertDate($mamet['input_date']), "C");
        $worksheet1->write_string($baris, 7, $mamet['plafond']);
        $worksheet1->write_string($baris, 8, $mamet['premi']);
        $worksheet1->write_string($baris, 9, $mamet['dokter_pemeriksa']);
        $worksheet1->write_string($baris, 10, _ConvertDate($mamet['tgl_periksa']));
        $worksheet1->write_string($baris, 11, $mamet['cabang']);
        $baris++;
    }
    $workbook->close();
    ;
  ...
  case "eL_HistUserTab":
    ...
    if ($_REQUEST['tgldn1']) {
        ...
        $worksheet1->merge_cells(0, 0, 0, 7);	$worksheet1->write_string(0, 0, "HISTORY LOG USER TABLET", $fjudul, 1);
        $worksheet1->merge_cells(1, 0, 1, 7);	$worksheet1->write_string(1, 0, "TANGGAL LOGIN "._convertDate($_REQUEST['tgldn1'])." s/d "._convertDate($_REQUEST['tgldn2'])."", $fjudul);
        $worksheet1->set_row(3, 15);
        $worksheet1->set_column(3, 0, 5);	$worksheet1->write_string(3, 0, "NO", $format);
        $worksheet1->set_column(3, 1, 10);	$worksheet1->write_string(3, 1, "USER", $format);
        $worksheet1->set_column(3, 2, 10);	$worksheet1->write_string(3, 2, "STATUS", $format);
        $worksheet1->set_column(3, 3, 10);	$worksheet1->write_string(3, 3, "TANGGAL", $format);
        $worksheet1->set_column(3, 4, 10);	$worksheet1->write_string(3, 4, "IP ADDRESS", $format);
        $worksheet1->set_column(3, 5, 10);	$worksheet1->write_string(3, 5, "NOMOR SPK", $format);
        $worksheet1->set_column(3, 6, 10);	$worksheet1->write_string(3, 6, "TANGGAL SPK", $format);
        $worksheet1->set_column(3, 7, 10);	$worksheet1->write_string(3, 7, "CABANG", $format);
        $baris = 4;
    ...
    while ($jangkrik = mysql_fetch_array($kucing)) {
        ...
        */
        $worksheet1->write_number($baris, 0, ++$no);
        $worksheet1->write_string($baris, 1, $jangkrik['namalengkap']);
        $worksheet1->write_string($baris, 2, $jangkrik['type']);
        $worksheet1->write_string($baris, 3, $jangkrik['timestamp']);
        $worksheet1->write_string($baris, 4, $jangkrik['ipuser']);
        $worksheet1->write_string($baris, 5, $jangkrik['spak']);
        $worksheet1->write_string($baris, 6, $jangkrik['input_date']);
        $worksheet1->write_string($baris, 7, $jangkrik['name']);
        $baris++;
    }
  ...
  case "eL_SumSPK":
        ...
        $worksheet1->merge_cells(0, 0, 0, 7);	$worksheet1->write_string(0, 0, "REKAP SUMMERY SPK", $fjudul, 1);
        $worksheet1->merge_cells(1, 0, 1, 7);	$worksheet1->write_string(1, 0, "TANGGAL INPUT "._convertDate($_REQUEST['tgl1'])." s/d "._convertDate($_REQUEST['tgl2'])."", $fjudul);

        $worksheet1->set_row(4, 15);
        $worksheet1->set_column(4, 0, 5);	$worksheet1->write_string(4, 0, "NO", $format);
        $worksheet1->set_column(4, 1, 15);	$worksheet1->write_string(4, 1, "NAMA CABANG", $format);
        $worksheet1->set_column(4, 2, 15);	$worksheet1->write_string(4, 2, "TOTAL SPK", $format);
        $worksheet1->set_column(4, 3, 15);	$worksheet1->write_string(4, 3, "REALISASI", $format);
        $worksheet1->set_column(4, 4, 15);	$worksheet1->write_string(4, 4, "AKTIF", $format);
        $worksheet1->set_column(4, 5, 15);	$worksheet1->write_string(4, 5, "APPROVE", $format);
        $worksheet1->set_column(4, 6, 10);	$worksheet1->write_string(4, 6, "PROSES", $format);
        $worksheet1->set_column(4, 7, 5);	$worksheet1->write_string(4, 7, "PREAPPROVAL", $format);
        $worksheet1->set_column(4, 8, 10);	$worksheet1->write_string(4, 8, "PENDING", $format);
        $worksheet1->set_column(4, 9, 5);	$worksheet1->write_string(4, 9, "BATAL", $format);
        $worksheet1->set_column(4, 10, 5);	$worksheet1->write_string(4, 10, "TOLAK", $format);
        $worksheet1->set_column(4, 11, 5);	$worksheet1->write_string(4, 11, "KADALUARSA", $format);
        $sql="";
        if ($_REQUEST['idReg']!="") {
        ...
        */
        while ($jangkrik = mysql_fetch_array($kucing)) {
            ...
            $worksheet1->write_number($baris, 0, ++$no);
            $worksheet1->write_string($baris, 1, $jangkrik['nama_cabang']);
            $worksheet1->write_number($baris, 2, $totalspk);
            $worksheet1->write_number($baris, 3, $realisasi);
            $worksheet1->write_number($baris, 4, $aktif);
            $worksheet1->write_number($baris, 5, $approve);
            $worksheet1->write_number($baris, 6, $proses);
            $worksheet1->write_number($baris, 7, $preapproval);
            $worksheet1->write_number($baris, 8, $pending);
            $worksheet1->write_number($baris, 9, $batal);
            $worksheet1->write_number($baris, 10, $total);
            $worksheet1->write_number($baris, 11, $kadaluarsa);
            $baris++;
        }
  ...
  case "eL_UserSPK":
        ...
        $worksheet1->merge_cells(0, 0, 0, 7);	$worksheet1->write_string(0, 0, "REKAP USER SPK", $fjudul, 1);
        $worksheet1->merge_cells(1, 0, 1, 7);	$worksheet1->write_string(1, 0, "TANGGAL INPUT "._convertDate($_REQUEST['tgl1'])." s/d "._convertDate($_REQUEST['tgl2'])."", $fjudul);

        $worksheet1->set_row(4, 15);
        $worksheet1->set_column(4, 0, 5);	$worksheet1->write_string(4, 0, "NO", $format);
        $worksheet1->set_column(4, 1, 15);	$worksheet1->write_string(4, 1, "CABANG", $format);
        $worksheet1->set_column(4, 2, 15);	$worksheet1->write_string(4, 2, "USER INPUT", $format);
        $worksheet1->set_column(4, 3, 15);	$worksheet1->write_string(4, 3, "NO SPK", $format);
        $worksheet1->set_column(4, 5, 15);	$worksheet1->write_string(4, 4, "STATUS", $format);
        ...
        while ($jangkrik = mysql_fetch_array($kucing)) {
            ...
            $worksheet1->write_number($baris, 0, ++$no);
            $worksheet1->write_string($baris, 1, $jangkrik['nama_cabang']);
            $worksheet1->write_string($baris, 2, $jangkrik['namalengkap']);
            $worksheet1->write_string($baris, 3, $jangkrik['spak']);
            $worksheet1->write_string($baris, 4, $jangkrik['status']);
            $baris++;
        }
  ...
  case "eL_UserSPKDetail":
        ...
        $fjudul1->set_align('vcenter');
        $fjudul1->set_align('center');
        ...
        $worksheet1->write_string(0, 0, "REKAP USER SPK DETAIL", $fjudul, 1);
        $worksheet1->merge_cells(0, 0, 0, 7);
        $worksheet1->write_string(1, 0, "TANGGAL INPUT "._convertDate($_REQUEST['tgl1'])." s/d "._convertDate($_REQUEST['tgl2'])."", $fjudul);
        $worksheet1->merge_cells(1, 0, 1, 7);

        $worksheet1->set_row(4, 15);
        $worksheet1->set_column(0, 0, 5);	$worksheet1->write_string(4, 0, "NO", $format);
        $worksheet1->set_column(1, 1, 25);	$worksheet1->write_string(4, 1, "CABANG", $format);
        $worksheet1->set_column(2, 2, 25);	$worksheet1->write_string(4, 2, "USER INPUT", $format);
        $worksheet1->set_column(3, 3, 15);	$worksheet1->write_string(4, 3, "JUMLAH SPK", $format);
        $worksheet1->set_column(4, 4, 15);	$worksheet1->write_string(4, 4, "JUMLAH SKKT", $format);
        $worksheet1->set_column(5, 5, 15);	$worksheet1->write_string(4, 5, "JUMLAH PLATINUM", $format);
        $worksheet1->set_column(6, 6, 15);	$worksheet1->write_string(4, 6, "TOTAL", $format);
        ...
        while ($jangkrik = mysql_fetch_array($kucing)) {
            ...
            //Aktif | Proses | Approve | Preapproval | Batal | Tolak | Realisasi
            $worksheet1->write_number($baris, 0, ++$no);
            $worksheet1->write_string($baris, 1, $jangkrik['nm_cabang'], $fjudul1);
            $worksheet1->write_string($baris, 2, $jangkrik['user'], $fjudul1);
            $worksheet1->write_number($baris, 3, $jangkrik['spk_tab'], $fjudul1);
            $worksheet1->write_number($baris, 4, $jangkrik['skkt_tab'], $fjudul1);
            $worksheet1->write_number($baris, 5, $jangkrik['platinum_tab'], $fjudul1);
            $worksheet1->write_number($baris, 6, $jangkrik['spk_tab'] + $jangkrik['skkt_tab'] + $jangkrik['skkt_platinum'], $fjudul);
            $baris++;
        }
  ...
  case "eL_UserSPKSummary":
        ...
        $fdata->set_align('center');

        $ftotal =& $workbook->add_format();
        $ftotal->set_align('center');
        $ftotal->set_bold();

        $worksheet1->write_string(0, 0, "REKAP USER SPK SUMMARY", $fjudul);
        ...
        $worksheet1->set_row(4, 15);
        $worksheet1->set_column(0, 0, 5);	$worksheet1->write_string(4, 0, "NO", $format);
        $worksheet1->set_column(1, 1, 32);	$worksheet1->write_string(4, 1, "CABANG", $format);
        $worksheet1->set_column(2, 2, 14);	$worksheet1->write_string(4, 2, "JML USER", $format);
        $worksheet1->set_column(3, 3, 17);	$worksheet1->write_string(4, 3, "JML SPK TAB", $format);
        $worksheet1->set_column(4, 4, 22);	$worksheet1->write_string(4, 4, "JML SPK MANUAL", $format);
        $worksheet1->set_column(5, 5, 17);	$worksheet1->write_string(4, 5, "JML SKKT TAB", $format);
        $worksheet1->set_column(6, 6, 22);	$worksheet1->write_string(4, 6, "JML SKKT MANUAL", $format);
        $worksheet1->set_column(7, 7, 17);	$worksheet1->write_string(4, 7, "JML PLATINUM TAB", $format);
        $worksheet1->set_column(8, 8, 22);	$worksheet1->write_string(4, 8, "JML PLATINUM MANUAL", $format);
        $worksheet1->set_column(9, 9, 7);	$worksheet1->write_string(4, 9, "TOTAL", $format);
        ...
        while ($jangkrik = mysql_fetch_array($kucing)) {
            ...
            $worksheet1->write_number($baris, 0, ++$no);
            $worksheet1->write_string($baris, 1, $jangkrik['nm_cabang']);
            $worksheet1->write_string($baris, 2, $jangkrik['user'], $fdata);
            $worksheet1->write_number($baris, 3, $jangkrik['spk_tab'], $fdata);
            $worksheet1->write_number($baris, 4, $jangkrik['spk_manual'], $fdata);
            $worksheet1->write_number($baris, 5, $jangkrik['skkt_tab'], $fdata);
            $worksheet1->write_number($baris, 6, $jangkrik['skkt_manual'], $fdata);
            $worksheet1->write_number($baris, 7, $jangkrik['platinum_tab'], $fdata);
            $worksheet1->write_number($baris, 8, $jangkrik['platinum_manual'], $fdata);
            $worksheet1->write_number($baris, 9, $total, $ftotal);
            $baris++;
            $totalall = $totalall + $total;
        }

        $worksheet1->write_string($baris, 0, 'Total', $ftotal);
        $worksheet1->merge_cells($baris, 0, $baris, 8);
        $worksheet1->write_number($baris, 9, $totalall, $ftotal);
        $workbook->close();
  break;
  ...
  case "eL_FeeDokter":
        ...
        $worksheet1->merge_cells(0, 0, 0, 7);	$worksheet1->write_string(0, 0, "REKAP DATA FEE DOKTER", $fjudul, 1);
        $worksheet1->merge_cells(1, 0, 1, 7);	$worksheet1->write_string(1, 0, "TANGGAL PERIKSA "._convertDate($_REQUEST['tgl1'])." s/d "._convertDate($_REQUEST['tgl2'])."", $fjudul);

        $worksheet1->set_row(4, 15);
        $worksheet1->set_column(4, 0, 5);	$worksheet1->write_string(4, 0, "NO", $format);
        $worksheet1->set_column(4, 1, 15);	$worksheet1->write_string(4, 1, "NAMA PERUSAHAAN", $format);
        $worksheet1->set_column(4, 2, 15);	$worksheet1->write_string(4, 2, "REGIONAL", $format);
        $worksheet1->set_column(4, 3, 15);	$worksheet1->write_string(4, 3, "CABANG", $format);
        $worksheet1->set_column(4, 5, 15);	$worksheet1->write_string(4, 4, "NAMA DOKTER", $format);
        $worksheet1->set_column(4, 5, 15);	$worksheet1->write_string(4, 5, "TGL PERIKSA", $format);
        $worksheet1->set_column(4, 5, 15);	$worksheet1->write_string(4, 6, "JUMLAH PERIKSA", $format);
        $worksheet1->set_column(4, 5, 15);	$worksheet1->write_string(4, 7, "FEE DOKTER", $format);
        $worksheet1->set_column(4, 5, 15);	$worksheet1->write_string(4, 8, "TOTAL", $format);
        ...
        while ($jangkrik = mysql_fetch_array($kucing)) {
            ...
            //Aktif | Proses | Approve | Preapproval | Batal | Tolak | Realisasi
            $worksheet1->write_number($baris, 0, ++$no);
            $worksheet1->write_string($baris, 1, $jangkrik['nama_cost']);
            $worksheet1->write_string($baris, 2, $jangkrik['nama_regional']);
            $worksheet1->write_string($baris, 3, $jangkrik['nama_cabang']);
            $worksheet1->write_string($baris, 4, $jangkrik['namalengkap']);
            $worksheet1->write_string($baris, 5, $jangkrik['tgl']);
            $worksheet1->write_number($baris, 6, $jangkrik['jml_pemeriksaan']);
            $worksheet1->write_number($baris, 7, $jangkrik['fee_dokter']);
            $worksheet1->write_number($baris, 8, $jangkrik['total']);
            $baris++;
        }
  ...
  case "eL_FeePemeriksaanDokter":
        ...
        $worksheet1->set_row(4, 15);
        $worksheet1->set_column(4, 0, 5);	$worksheet1->write_string(4, 0, "NO", $format);
        $worksheet1->set_column(4, 1, 15);	$worksheet1->write_string(4, 1, "NAMA DOKTER", $format);
        $worksheet1->set_column(4, 2, 15);	$worksheet1->write_string(4, 2, "JUMLAH SPK", $format);
        $worksheet1->set_column(4, 3, 15);	$worksheet1->write_string(4, 3, "BIAYA", $format);
        $worksheet1->set_column(4, 5, 15);	$worksheet1->write_string(4, 4, "TOTAL", $format);
        $worksheet1->set_column(4, 5, 15);	$worksheet1->write_string(4, 5, "PERIODE PERIKSA", $format);
        $worksheet1->set_column(4, 5, 15);	$worksheet1->write_string(4, 6, "ATAS NAMA", $format);
        $worksheet1->set_column(4, 5, 15);	$worksheet1->write_string(4, 7, "NO REKENING", $format);
        $worksheet1->set_column(4, 5, 15);	$worksheet1->write_string(4, 8, "BANK", $format);
        ...
        while ($jangkrik = mysql_fetch_array($kucing)) {
            $worksheet1->write_number($baris, 0, ++$no);
            $worksheet1->write_string($baris, 1, $jangkrik['namalengkap']);
            $worksheet1->write_number($baris, 2, $jangkrik['jml_pemeriksaan']);
            $worksheet1->write_number($baris, 3, $jangkrik['fee_dokter']);
            $worksheet1->write_number($baris, 4, $jangkrik['total']);
            $worksheet1->write_string($baris, 5, $jangkrik['tgl']);
            $worksheet1->write_string($baris, 6, $jangkrik['atas_nama']);
            $worksheet1->write_string($baris, 7, $jangkrik['norek']);
            $worksheet1->write_string($baris, 8, $jangkrik['bank_rek']);
        ...
        $worksheet1->write_string($baris, 0, '');
        $worksheet1->write_string($baris, 1, '');
        $worksheet1->write_number($baris, 2, $jmlku);
        $worksheet1->write_number($baris, 3, $feeku);
        $worksheet1->write_number($baris, 4, $totalku);
        $worksheet1->write_string($baris, 5, '');
        $worksheet1->write_string($baris, 6, '');
        $worksheet1->write_string($baris, 7, '');
  ...
  case "eL_User_SPK":
            ...
            $worksheet1->set_column(4, 1, 15);	$worksheet1->write_string(4, 1, "CABANG", $format);
            $worksheet1->set_column(4, 2, 15);	$worksheet1->write_string(4, 2, "USER INPUT", $format);
            $worksheet1->set_column(4, 3, 15);	$worksheet1->write_number(4, 3, "JUMLAH DATA", $format);
            ...
            while ($jangkrik = mysql_fetch_array($kucing)) {
                ...
                $worksheet1->write_string($baris, 1, $jangkrik['nama_cabang']);
                $worksheet1->write_string($baris, 2, $jangkrik['namalengkap']);
                $worksheet1->write_number($baris, 3, $jangkrik['jml']);
                $baris++;
            }
  ...
  case "klaim_liable":
        ...
        function bulan_convert($tanggal)
        {
            ...
            if ($dateku!=="") {
                ...
                $worksheet1->merge_cells(0, 0, 0, 23);	$worksheet1->write_string(0, 0, "DATA KLAIM LIABLE ".strtoupper($_REQUEST['status_klaim']), $fjudul, 1);

                $q_tglklaim='';
                if (!empty($_REQUEST['tgl1'])) {
                    $worksheet1->merge_cells(1, 0, 1, 23);
                    $worksheet1->write_string(1, 0, "TANGGAL LAPOR "._convertDate($_REQUEST['tgl1'])." s/d "._convertDate($_REQUEST['tgl2'])."", $fjudul);
                }


                $q_dol='';
                if (!empty($_REQUEST['tgl3'])) {
                    $worksheet1->merge_cells(2, 0, 2, 23);
                    $worksheet1->write_string(1, 0, "DOL "._convertDate($_REQUEST['tgl3'])." s/d "._convertDate($_REQUEST['tgl4'])."", $fjudul);
                }


                $worksheet1->set_row(4, 15);
                $worksheet1->set_column(4, 0, 5);	$worksheet1->write_string(4, 0, "No", $format);
                $worksheet1->set_column(4, 1, 5);	$worksheet1->write_string(4, 1, "Nomor Urut", $format);
                $worksheet1->set_column(4, 2, 5);	$worksheet1->write_string(4, 2, "Bukopin Cabang", $format);
                $worksheet1->set_column(4, 3, 5);	$worksheet1->write_string(4, 3, "Cover Asuransi", $format);
                $worksheet1->set_column(4, 4, 5);	$worksheet1->write_string(4, 4, "Kategori", $format);
                $worksheet1->set_column(4, 5, 5);	$worksheet1->write_string(4, 5, "Produk", $format);
                $worksheet1->set_column(4, 6, 5);	$worksheet1->write_string(4, 6, "ID Peserta", $format);
                $worksheet1->set_column(4, 7, 5);	$worksheet1->write_string(4, 7, "Nama Debitur", $format);
                $worksheet1->set_column(4, 8, 5);	$worksheet1->write_string(4, 8, "Tgl Lahir", $format);
                $worksheet1->set_column(4, 9, 5);	$worksheet1->write_string(4, 9, "Usia", $format);
                $worksheet1->set_column(4, 10, 5);	$worksheet1->write_string(4, 10, "Plafond Kredit ", $format);
                $worksheet1->set_column(4, 11, 5);	$worksheet1->write_string(4, 11, "Tuntutan Klaim ", $format);
                $worksheet1->set_column(4, 12, 5);	$worksheet1->write_string(4, 12, "Tgl Akad", $format);
                $worksheet1->set_column(4, 13, 5);	$worksheet1->write_string(4, 13, "J.Wkt (Th.)", $format);
                $worksheet1->set_column(4, 14, 5);	$worksheet1->write_string(4, 14, "DOL", $format);
                $worksheet1->set_column(4, 15, 5);	$worksheet1->write_string(4, 15, "Akad s/d DOL (hari)", $format);
                $worksheet1->set_column(4, 16, 5);	$worksheet1->write_string(4, 16, "Tgl. Terima Laporan", $format);
                $worksheet1->set_column(4, 17, 5);	$worksheet1->write_string(4, 17, "Kelengkapan Dokumen Klaim", $format);
                $worksheet1->set_column(4, 18, 5);	$worksheet1->write_string(4, 18, "Tgl Lapor Klaim", $format);
                $worksheet1->set_column(4, 19, 5);	$worksheet1->write_string(4, 19, "Tanggal Status Lengkap", $format);
                $worksheet1->set_column(4, 20, 5);	$worksheet1->write_string(4, 20, "Status Klaim", $format);
                $worksheet1->set_column(4, 21, 5);	$worksheet1->write_string(4, 21, "Asuransi Bayar (Rp.)", $format);
                $worksheet1->set_column(4, 22, 5);	$worksheet1->write_string(4, 22, "Tgl Bayar Dari Asuransi", $format);
                $worksheet1->set_column(4, 23, 5);	$worksheet1->write_string(4, 23, "Bayar Ke Bank (Rp.)", $format);
                $worksheet1->set_column(4, 24, 5);	$worksheet1->write_string(4, 24, "Tgl Bayar Ke Client", $format);
                $worksheet1->set_column(4, 25, 5);	$worksheet1->write_string(4, 25, "Selisih Bayar (Rp.)", $format);
                $worksheet1->set_column(4, 26, 5);	$worksheet1->write_string(4, 26, "Kol", $format);
        ...
        $kucing = mysql_query("SELECT
                ...
                while ($kucingkawin = mysql_fetch_array($kucing)) {
                    $worksheet1->write_number($baris, 0, ++$no);
                    $worksheet1->write_string($baris, 1, $kucingkawin['no_urut_klaim']);
                    $worksheet1->write_string($baris, 2, $kucingkawin['id_cabang']);
                    $worksheet1->write_string($baris, 3, $kucingkawin['name']);
                    $worksheet1->write_string($baris, 4, $kucingkawin['kategori']);
                    $worksheet1->write_string($baris, 5, $kucingkawin['nmproduk']);
                    $worksheet1->write_string($baris, 6, $kucingkawin['id_peserta']);
                    $worksheet1->write_string($baris, 7, $kucingkawin['nama']);
                    $worksheet1->write_string($baris, 8, $kucingkawin['tgl_lahir']);
                    $worksheet1->write_number($baris, 9, $kucingkawin['usia']);
                    $worksheet1->write_number($baris, 10, $kucingkawin['kredit_jumlah']);
                    $worksheet1->write_number($baris, 11, $kucingkawin['tuntutan_klaim']);
                    $worksheet1->write_string($baris, 12, $kucingkawin['kredit_tgl']);
                    $worksheet1->write_number($baris, 13, $kucingkawin['kredit_tenor']);
                    $worksheet1->write_string($baris, 14, $kucingkawin['dol']);
                    $worksheet1->write_string($baris, 15, $kucingkawin['akad_dol']);
                    $worksheet1->write_string($baris, 16, $kucingkawin['tgl_lapor_klaim']);
                    $worksheet1->write_string($baris, 17, $kucingkawin['keterangan']);
                    $worksheet1->write_string($baris, 18, $kucingkawin['input_date']);
                    $worksheet1->write_string($baris, 19, $kucingkawin['tgl_document_lengkap']);
                    $worksheet1->write_string($baris, 20, $kucingkawin['status_klaim']);
                    $worksheet1->write_number($baris, 21, $kucingkawin['total_bayar_asuransi']);
                    $worksheet1->write_string($baris, 22, $kucingkawin['tgl_bayar_asuransi']);
                    $worksheet1->write_number($baris, 23, $kucingkawin['bayar_ke_bank']);
                    $worksheet1->write_string($baris, 24, $kucingkawin['tgl_bayar_ke_client']);
                    $worksheet1->write_string($baris, 25, $kucingkawin['selisih']);
                    $worksheet1->write_number($baris, 26, $kucingkawin['kol']);
  ...
  case "klaim_nonliable":
    ...
    $worksheet1->merge_cells(0, 0, 0, 22);	$worksheet1->write_string(0, 0, "DATA KLAIM NONLIABLE ".strtoupper($_REQUEST['status_klaim']), $fjudul, 1);

    $q_tglklaim='';
    if (!empty($_REQUEST['tgl1'])) {
        $worksheet1->merge_cells(1, 0, 1, 22);
        $worksheet1->write_string(1, 0, "TANGGAL LAPOR "._convertDate($_REQUEST['tgl1'])." s/d "._convertDate($_REQUEST['tgl2'])."", $fjudul);
    }
    ...
    $q_dol='';
    if (!empty($_REQUEST['tgl3'])) {
        $worksheet1->merge_cells(2, 0, 2, 22);
        $worksheet1->write_string(1, 0, "DOL "._convertDate($_REQUEST['tgl3'])." s/d "._convertDate($_REQUEST['tgl4'])."", $fjudul);
    }
    ...
    $worksheet1->set_row(4, 15);
    $worksheet1->set_column(4, 0, 5);	$worksheet1->write_string(4, 0, "No", $format);
    $worksheet1->set_column(4, 1, 5);	$worksheet1->write_string(4, 1, "No Urut", $format);
    $worksheet1->set_column(4, 2, 5);	$worksheet1->write_string(4, 2, "Bukopin Cabang", $format);
    $worksheet1->set_column(4, 3, 5);	$worksheet1->write_string(4, 3, "Cover Asuransi", $format);
    $worksheet1->set_column(4, 4, 5);	$worksheet1->write_string(4, 4, "Kategori", $format);
    $worksheet1->set_column(4, 5, 5);	$worksheet1->write_string(4, 5, "Produk", $format);
    $worksheet1->set_column(4, 6, 5);	$worksheet1->write_string(4, 6, "Nama Debitur", $format);
    $worksheet1->set_column(4, 7, 5);	$worksheet1->write_string(4, 7, "Tgl Lahir", $format);
    $worksheet1->set_column(4, 8, 5);	$worksheet1->write_string(4, 8, "Usia", $format);
    $worksheet1->set_column(4, 9, 5);	$worksheet1->write_string(4, 9, "Plafond Kredit ", $format);
    $worksheet1->set_column(4, 10, 5);	$worksheet1->write_string(4, 10, "Tuntutan Klaim ", $format);
    $worksheet1->set_column(4, 11, 5);	$worksheet1->write_string(4, 11, "Tgl Akad", $format);
    $worksheet1->set_column(4, 12, 5);	$worksheet1->write_string(4, 12, "J.Wkt (Th.)", $format);
    $worksheet1->set_column(4, 13, 5);	$worksheet1->write_string(4, 13, "DOL", $format);
    $worksheet1->set_column(4, 14, 5);	$worksheet1->write_string(4, 14, "Akad s/d DOL (hari)", $format);
    $worksheet1->set_column(4, 15, 5);	$worksheet1->write_string(4, 15, "Tgl. Laporan Asuransi", $format);
    $worksheet1->set_column(4, 16, 5);	$worksheet1->write_string(4, 16, "Kelengkapan Dokumen Klaim", $format);
    $worksheet1->set_column(4, 17, 5);	$worksheet1->write_string(4, 17, "Tanggal Status Lengkap", $format);
    $worksheet1->set_column(4, 18, 5);	$worksheet1->write_string(4, 18, "Status Klaim", $format);
    $worksheet1->set_column(4, 19, 5);	$worksheet1->write_string(4, 19, "Tgl Lapor Klaim", $format);
    $worksheet1->set_column(4, 20, 5);	$worksheet1->write_string(4, 20, "Asuransi Bayar (Rp.)", $format);
    $worksheet1->set_column(4, 21, 5);	$worksheet1->write_string(4, 21, "Tgl Bayar Dari Asuransi", $format);
    $worksheet1->set_column(4, 22, 5);	$worksheet1->write_string(4, 22, "Bayar Ke Bank (Rp.)", $format);
    $worksheet1->set_column(4, 23, 5);	$worksheet1->write_string(4, 23, "Tgl Bayar Ke Client", $format);
    $worksheet1->set_column(4, 24, 5);	$worksheet1->write_string(4, 24, "Selisih Bayar (Rp.)", $format);
    $worksheet1->set_column(4, 25, 5);	$worksheet1->write_string(4, 25, "Kol", $format);
    ...
    while ($datanya_ = mysql_fetch_array($kucing)) {
        $worksheet1->write_number($baris, 0, ++$no);
        $worksheet1->write_string($baris, 1, $datanya_['no_urut_klaim']);
        $worksheet1->write_string($baris, 2, $datanya_['id_cabang']);
        $worksheet1->write_string($baris, 3, $datanya_['name']);
        $worksheet1->write_string($baris, 4, $datanya_['kategori']);
        $worksheet1->write_string($baris, 5, $datanya_['nmproduk']);
        $worksheet1->write_string($baris, 6, $datanya_['nama']);
        $worksheet1->write_string($baris, 7, $datanya_['tgl_lahir']);
        $worksheet1->write_number($baris, 8, $datanya_['usia']);
        $worksheet1->write_number($baris, 9, $datanya_['kredit_jumlah']);
        $worksheet1->write_number($baris, 10, $datanya_['tuntutan_klaim']);
        $worksheet1->write_string($baris, 11, $datanya_['kredit_tgl']);
        $worksheet1->write_number($baris, 12, $datanya_['kredit_tenor']);
        $worksheet1->write_string($baris, 13, $datanya_['dol']);
        $worksheet1->write_string($baris, 14, $datanya_['akad_dol']);
        $worksheet1->write_string($baris, 15, $datanya_['tgl_document']);
        $worksheet1->write_string($baris, 16, $datanya_['keterangan']);
        $worksheet1->write_string($baris, 17, $datanya_['tgl_document_lengkap']);
        $worksheet1->write_string($baris, 18, $datanya_['status_klaim']);
        $worksheet1->write_number($baris, 19, $datanya_['input_date']);
        $worksheet1->write_number($baris, 20, $datanya_['total_bayar_asuransi']);
        $worksheet1->write_string($baris, 21, $datanya_['tgl_bayar_asuransi']);
        $worksheet1->write_number($baris, 22, $datanya_['bayar_ke_bank']);
        $worksheet1->write_string($baris, 23, $datanya_['tgl_bayar_ke_client']);
        $worksheet1->write_string($baris, 24, $datanya_['selisih']);
        $worksheet1->write_number($baris, 25, $datanya_['kol']);
  ...
  case "list_pembas":
    ...
    $worksheet1->merge_cells(0, 0, 0, 7);	$worksheet1->write_string(0, 0, "DATA KLAIM NONLIABLE", $fjudul, 1);
    $worksheet1->merge_cells(1, 0, 1, 7);	$worksheet1->write_string(1, 0, "TANGGAL KLAIM "._convertDate($_REQUEST['tgl1'])." s/d "._convertDate($_REQUEST['tgl2'])."", $fjudul);

    $worksheet1->set_row(4, 15);
    $worksheet1->set_column(4, 0, 5);	$worksheet1->write_string(4, 0, "No", $format);
    $worksheet1->set_column(4, 1, 5);	$worksheet1->write_string(4, 1, "Nama Perusahaan", $format);
    $worksheet1->set_column(4, 2, 5);	$worksheet1->write_string(4, 2, "Asuransi", $format);
    $worksheet1->set_column(4, 3, 5);	$worksheet1->write_string(4, 3, "Nomor Polis", $format);
    $worksheet1->set_column(4, 4, 5);	$worksheet1->write_string(4, 4, "Nomor DN", $format);
    $worksheet1->set_column(4, 5, 5);	$worksheet1->write_string(4, 5, "ID Peserta", $format);
    $worksheet1->set_column(4, 6, 5);	$worksheet1->write_string(4, 6, "Nama", $format);
    $worksheet1->set_column(4, 7, 5);	$worksheet1->write_string(4, 7, "DOB", $format);
    $worksheet1->set_column(4, 8, 5);	$worksheet1->write_string(4, 8, "Usia", $format);
    $worksheet1->set_column(4, 9, 5);	$worksheet1->write_string(4, 9, "Kredit Awal", $format);
    $worksheet1->set_column(4, 10, 5);	$worksheet1->write_string(4, 10, "Tenor", $format);
    $worksheet1->set_column(4, 11, 5);	$worksheet1->write_string(4, 11, "Kredit Akhir", $format);
    $worksheet1->set_column(4, 12, 5);	$worksheet1->write_string(4, 12, "U P", $format);
    $worksheet1->set_column(4, 13, 5);	$worksheet1->write_string(4, 13, "Total Klaim", $format);
    $worksheet1->set_column(4, 14, 5);	$worksheet1->write_string(4, 14, "Cabang", $format);
    $worksheet1->set_column(4, 15, 5);	$worksheet1->write_string(4, 15, "Tgl Bayar Dari Asuransi", $format);
    $worksheet1->set_column(4, 16, 5);	$worksheet1->write_string(4, 16, "Total Bayar Dari Asuransi", $format);
    $worksheet1->set_column(4, 17, 5);	$worksheet1->write_string(4, 17, "Outstanding Dari Asuransi", $format);
    ...
    while ($datanya_ = mysql_fetch_array($kucing)) {
        ...
        $worksheet1->write_number($baris, 0, ++$no);
        $worksheet1->write_string($baris, 1, $xperusahaan['name']);
        $worksheet1->write_string($baris, 2, $xAsuransi_['name']);
        $worksheet1->write_string($baris, 3, $xpolis['nopol']);
        $worksheet1->write_string($baris, 4, $xdn['dn_kode']);
        $worksheet1->write_string($baris, 5, $xpeserta['id_peserta']);
        $worksheet1->write_number($baris, 6, $xpeserta['nama']);
        $worksheet1->write_number($baris, 7, $xpeserta['tgl_lahir']);
        $worksheet1->write_number($baris, 8, $xpeserta['usia']);
        $worksheet1->write_string($baris, 9, $xpeserta['kredit_tgl']);
        $worksheet1->write_number($baris, 10, $xpeserta['kredit_tenor']);
        $worksheet1->write_string($baris, 11, $xpeserta['kredit_akhir']);
        $worksheet1->write_string($baris, 12, duit($xpeserta['kredit_jumlah']));
        $worksheet1->write_string($baris, 13, duit($xcn['total_claim']));
        $worksheet1->write_number($baris, 14, $xpeserta['cabang']);
        $worksheet1->write_string($baris, 15, $xpeserta['note_paid_date']);
        $worksheet1->write_string($baris, 16, duit($xpeserta['note_paid_total']));
        $worksheet1->write_number($baris, 17, duit($xpeserta['note_paid_total']-$xcn['total_claim']));
  ...
  case "klaim_tiering_asuransi":
    ...
    $worksheet1->merge_cells(0, 0, 0, 24);	$worksheet1->write_string(0, 0, "DATA KLAIM TIERING ".strtoupper($_REQUEST['status_klaim']), $fjudul, 1);


    if (!empty($_REQUEST['tgl1'])) {
        $worksheet1->merge_cells(1, 0, 1, 24);
        $worksheet1->write_string(1, 0, "TANGGAL LAPOR "._convertDate($_REQUEST['tgl1'])." s/d "._convertDate($_REQUEST['tgl2'])."", $fjudul);
    }


    if (!empty($_REQUEST['tgl3'])) {
        $worksheet1->merge_cells(2, 0, 2, 24);
        $worksheet1->write_string(1, 0, "DOL "._convertDate($_REQUEST['tgl3'])." s/d "._convertDate($_REQUEST['tgl4'])."", $fjudul);
    }
    ...
    $worksheet1->set_column(4, 3, 5); $worksheet1->write_string(4, 3, "Cover Asuransi", $format);
    $worksheet1->set_column(4, 4, 5); $worksheet1->write_string(4, 4, "Kategori", $format);
    $worksheet1->set_column(4, 5, 5); $worksheet1->write_string(4, 5, "Nama Debitur", $format);
    $worksheet1->set_column(4, 6, 5); $worksheet1->write_string(4, 6, "Tgl Lahir", $format);
    $worksheet1->set_column(4, 7, 5); $worksheet1->write_string(4, 7, "Usia", $format);
    $worksheet1->set_column(4, 8, 5); $worksheet1->write_string(4, 8, "Plafond Kredit ", $format);
    $worksheet1->set_column(4, 9, 5); $worksheet1->write_string(4, 9, "Tuntutan Klaim ", $format);
    $worksheet1->set_column(4, 10, 5); $worksheet1->write_string(4, 10, "Presentase Tiering", $format);
    $worksheet1->set_column(4, 11, 5); $worksheet1->write_string(4, 11, "Nilai Tiering ", $format);
    $worksheet1->set_column(4, 12, 5); $worksheet1->write_string(4, 12, "Tgl Akad", $format);
    $worksheet1->set_column(4, 13, 5); $worksheet1->write_string(4, 13, "J.Wkt (Th.)", $format);
    $worksheet1->set_column(4, 14, 5); $worksheet1->write_string(4, 14, "DOL", $format);
    $worksheet1->set_column(4, 15, 5); $worksheet1->write_string(4, 15, "Akad s/d DOL (hari)", $format);
    $worksheet1->set_column(4, 16, 5); $worksheet1->write_string(4, 16, "Tgl. Lapor Asuransi ", $format);
    $worksheet1->set_column(4, 17, 5); $worksheet1->write_string(4, 17, "Kelengkapan Dokumen Klaim", $format);
    $worksheet1->set_column(4, 18, 5); $worksheet1->write_string(4, 18, "Tanggal Status Lengkap", $format);
    $worksheet1->set_column(4, 19, 5); $worksheet1->write_string(4, 19, "Status Klaim", $format);
    $worksheet1->set_column(4, 20, 5); $worksheet1->write_string(4, 20, "Asuransi Bayar (Rp.) ", $format);
    $worksheet1->set_column(4, 21, 5); $worksheet1->write_string(4, 21, "Tanggal Pembayaran dari Asuransi ", $format);
    $worksheet1->set_column(4, 22, 5); $worksheet1->write_string(4, 22, " Bayar ke Bank (Rp.) ", $format);
    $worksheet1->set_column(4, 23, 5); $worksheet1->write_string(4, 23, "Tanggal Pembayaran ke Bank", $format);
    $worksheet1->set_column(4, 24, 5); $worksheet1->write_string(4, 24, " Selisih Bayar (Rp.) ", $format);
    $worksheet1->set_column(4, 25, 5); $worksheet1->write_string(4, 25, "Kol", $format);
    ...
    while ($datanya_ = mysql_fetch_array($kucing)) {
        ...
        $worksheet1->write_string($baris, 2, $datanya_['id_cabang']);
        $worksheet1->write_string($baris, 3, $datanya_['name']);
        $worksheet1->write_string($baris, 4, $datanya_['nmproduk']);
        $worksheet1->write_string($baris, 5, $datanya_['nama']);
        $worksheet1->write_string($baris, 6, $datanya_['tgl_lahir']);
        $worksheet1->write_string($baris, 7, $datanya_['usia']);
        $worksheet1->write_number($baris, 8, $datanya_['kredit_jumlah']);
        $worksheet1->write_number($baris, 9, $datanya_['tuntutan_klaim']);
        $worksheet1->write_string($baris, 10, $datanya_['persentase_tiering']);
        $worksheet1->write_number($baris, 11, $datanya_['nilai_tiering']);
        $worksheet1->write_string($baris, 12, $datanya_['kredit_tgl']);
        $worksheet1->write_string($baris, 13, $datanya_['kredit_tenor']);
        $worksheet1->write_string($baris, 14, $datanya_['dol']);
        $worksheet1->write_string($baris, 15, $datanya_['akad_dol']);
        $worksheet1->write_string($baris, 16, $datanya_['tgl_lapor_klaim']);
        $worksheet1->write_string($baris, 17, $datanya_['keterangan']);
        $worksheet1->write_string($baris, 18, $datanya_['tgl_document_lengkap']);
        $worksheet1->write_string($baris, 19, $datanya_['status_klaim']);
        $worksheet1->write_number($baris, 20, $datanya_['asuransi_bayar']);
        $worksheet1->write_string($baris, 21, $datanya_['tgl_asuransi_bayar']);
        $worksheet1->write_number($baris, 22, $datanya_['bayar_ke_bank']);
        $worksheet1->write_string($baris, 23, $datanya_['tgl_bayar_ke_client']);
        $worksheet1->write_number($baris, 24, $datanya_['selisih']);
        $worksheet1->write_string($baris, 25, $datanya_['kol']);
  ...
  case "eL_Rekap_Klaim":
        ...
        $met = mysql_query('SELECT
				...
				ORDER BY fu_ajk_peserta.id_polis ASC,
						 ...
						 fu_ajk_peserta.cabang ASC,
						 fu_ajk_peserta.nama ASC');
        $worksheet1->merge_cells(0, 0, 0, 7);	$worksheet1->write_string(0, 0, "SUMMARY KLAIM ", $fjudul, 1);
        $worksheet1->merge_cells(1, 0, 1, 7);	$worksheet1->write_string(1, 0, "NAMA PERUSAHAAN : ".$cost, $fjudul);
        $worksheet1->merge_cells(2, 0, 2, 7);	$worksheet1->write_string(2, 0, "NAMA ASURANSI : ".$as, $fjudul);
        $worksheet1->merge_cells(3, 0, 3, 7);	$worksheet1->write_string(3, 0, "NAMA PRODUK : ".$polis, $fjudul);
        $worksheet1->merge_cells(4, 0, 4, 7);	$worksheet1->write_string(4, 0, "PERIODE KLAIM : ".$tgl_klaim, $fjudul);
        $worksheet1->merge_cells(5, 0, 5, 7);	$worksheet1->write_string(5, 0, "STATUS KLAIM : ".$status, $fjudul);
        $worksheet1->merge_cells(6, 0, 6, 7);	$worksheet1->write_string(6, 0, "REGIONAL : ".$regional, $fjudul);
        $worksheet1->merge_cells(7, 0, 7, 7);	$worksheet1->write_string(7, 0, "CABANG : ".$cabang, $fjudul);

        $worksheet1->set_row(9, 15);
        $worksheet1->set_column(9, 0, 5);	$worksheet1->write_string(9, 0, "NO", $format);
        $worksheet1->set_column(9, 1, 15);	$worksheet1->write_string(9, 1, "Asuransi", $format);
        $worksheet1->set_column(9, 2, 15);	$worksheet1->write_string(9, 2, "Produk", $format);
        $worksheet1->set_column(9, 3, 15);	$worksheet1->write_string(9, 3, "Debit Note", $format);
        $worksheet1->set_column(9, 4, 15);	$worksheet1->write_string(9, 4, "Tanggal DN", $format);
        $worksheet1->set_column(9, 5, 15);	$worksheet1->write_string(9, 5, "Mulai Asuransi", $format);
        $worksheet1->set_column(9, 6, 15);	$worksheet1->write_string(9, 6, "Akhir Asuransi", $format);
        $worksheet1->set_column(9, 7, 15);	$worksheet1->write_string(9, 7, "No. Reg", $format);
        $worksheet1->set_column(9, 8, 15);	$worksheet1->write_string(9, 8, "Nama Debitur", $format);
        $worksheet1->set_column(9, 9, 15);	$worksheet1->write_string(9, 9, "Cabang", $format);
        $worksheet1->set_column(9, 10, 15);	$worksheet1->write_string(9, 10, "Tgl Lahir", $format);
        $worksheet1->set_column(9, 11, 15);	$worksheet1->write_string(9, 11, "Usia", $format);
        $worksheet1->set_column(9, 12, 15);	$worksheet1->write_string(9, 12, "Plafond", $format);
        $worksheet1->set_column(9, 13, 15);	$worksheet1->write_string(9, 13, "Total Premi", $format);
        $worksheet1->set_column(9, 14, 15);	$worksheet1->write_string(9, 14, "Nilai Klaim", $format);
        $worksheet1->set_column(9, 15, 15);	$worksheet1->write_string(9, 15, "Asuransi Bayar", $format);
        $worksheet1->set_column(9, 16, 15);	$worksheet1->write_string(9, 16, "Status", $format);
        ...
        while ($jangkrik = mysql_fetch_array($met)) {
            ...
            //Aktif | Proses | Approve | Preapproval | Batal | Tolak | Realisasi
            $worksheet1->write_number($baris, 0, ++$no);
            $worksheet1->write_string($baris, 1, $jangkrik['nmAsuransi']);
            $worksheet1->write_string($baris, 2, $jangkrik['nmproduk']);
            $worksheet1->write_string($baris, 3, $jangkrik['dn_kode']);
            $worksheet1->write_string($baris, 4, $jangkrik['tgl_createdn']);
            $worksheet1->write_string($baris, 5, $jangkrik['kredit_tgl']);
            $worksheet1->write_string($baris, 6, $jangkrik['kredit_akhir']);
            $worksheet1->write_string($baris, 7, $jangkrik['id_peserta']);
            $worksheet1->write_string($baris, 8, $jangkrik['nama']);
            $worksheet1->write_string($baris, 9, $jangkrik['cabang']);
            $worksheet1->write_string($baris, 10, $jangkrik['tgl_lahir']);
            $worksheet1->write_string($baris, 11, $jangkrik['usia']);
            $worksheet1->write_number($baris, 12, $jangkrik['kredit_jumlah']);
            $worksheet1->write_number($baris, 13, $jangkrik['totalpremi']);
            $worksheet1->write_number($baris, 14, $jangkrik['total_claim']);
            $worksheet1->write_number($baris, 15, $jangkrik['total_bayar_asuransi']);
            $worksheet1->write_string($baris, 16, $jangkrik['status_klaim']);
            $baris++;
        }
  ...
  case "feepemeriksaandokterdetail":
    ...
    $worksheet1->merge_cells(0, 0, 0, 7);	$worksheet1->write_string(0, 0, "DATA PEMERIKSAAN DOKTER", $fjudul, 1);
    $worksheet1->merge_cells(1, 0, 1, 7);	$worksheet1->write_string(1, 0, "TANGGAL PEMERIKSAAN "._convertDate($_REQUEST['tgl1'])." s/d "._convertDate($_REQUEST['tgl2'])."", $fjudul);

    $worksheet1->set_row(4, 15);
    $worksheet1->set_column(4, 0, 5);	$worksheet1->write_string(4, 0, "No", $format);
    $worksheet1->set_column(4, 1, 5);	$worksheet1->write_string(4, 1, "Nama", $format);
    $worksheet1->set_column(4, 2, 5);	$worksheet1->write_string(4, 2, "No SPK", $format);
    $worksheet1->set_column(4, 3, 5);	$worksheet1->write_string(4, 3, "Tgl Periksa", $format);
    $worksheet1->set_column(4, 4, 5);	$worksheet1->write_string(4, 4, "Usia", $format);
    $worksheet1->set_column(4, 5, 5);	$worksheet1->write_string(4, 5, "Cabang", $format);
    $worksheet1->set_column(4, 5, 5);	$worksheet1->write_string(4, 6, "No Pensiun", $format);
    $worksheet1->set_column(4, 6, 5);	$worksheet1->write_string(4, 7, "Keterangan", $format);
    ...
    while ($datanya_ = mysql_fetch_array($kucing)) {
        $worksheet1->write_number($baris, 0, ++$no);
        $worksheet1->write_string($baris, 1, $datanya_['nama']);
        $worksheet1->write_string($baris, 2, $datanya_['spak']);
        $worksheet1->write_string($baris, 3, $datanya_['tgl_periksa']);
        $worksheet1->write_string($baris, 4, $datanya_['x_usia']);
        $worksheet1->write_string($baris, 5, $datanya_['name']);
        $worksheet1->write_string($baris, 6, $datanya_['nopermohonan']);
        $worksheet1->write_string($baris, 7, $datanya_['catatan']);
  ...
  case "klaim_outstanding":
    ...
    $workbook = new Workbook("");
    $worksheet1 =& $workbook->add_worksheet('DATA ALL KLAIM');
    $format =& $workbook->add_format();
    $format->set_align('vcenter');
    $format->set_align('center');
    $format->set_color('white');
    ...
    $worksheet1->merge_cells(0, 0, 0, 7);	$worksheet1->write_string(0, 0, "DATA KLAIM OUTSTANDING", $fjudul, 1);
    $worksheet1->merge_cells(1, 0, 1, 7);	$worksheet1->write_string(1, 0, "PERUSAHAAN ", $fjudul);
    $worksheet1->merge_cells(2, 0, 2, 7);	$worksheet1->write_string(2, 0, "PRODUK ", $fjudul);
    $worksheet1->merge_cells(3, 0, 3, 7);	$worksheet1->write_string(3, 0, "ASURANSI ", $fjudul);
    $worksheet1->merge_cells(4, 0, 4, 7);	$worksheet1->write_string(4, 0, "STATUS BAYAR ", $fjudul);
    $worksheet1->merge_cells(5, 0, 5, 7);	$worksheet1->write_string(4, 0, "STATUS KLAIM ", $fjudul);
    $worksheet1->merge_cells(6, 0, 6, 7);	$worksheet1->write_string(4, 0, "KOL ", $fjudul);
    $worksheet1->merge_cells(7, 0, 7, 7);	$worksheet1->write_string(4, 0, "TANGGAL KLAIM "._convertDate($_REQUEST['tgl1'])." s/d "._convertDate($_REQUEST['tgl2'])."", $fjudul);
    ...
    WHERE cn.type_refund = 'Topup' and
          ...
          (select alasan_penolakan from fu_ajk_penolakan where trim(id_peserta) = fu_ajk_cn.id_peserta order by tgl_penolakan limit 1)as alasan_tolak
		FROM
		fu_ajk_cn
		INNER JOIN fu_ajk_dn ON fu_ajk_cn.id_cost = fu_ajk_dn.id_cost AND fu_ajk_cn.id_nopol = fu_ajk_dn.id_nopol AND fu_ajk_cn.id_dn = fu_ajk_dn.id
		INNER JOIN fu_ajk_peserta ON fu_ajk_cn.id_cost = fu_ajk_peserta.id_cost AND fu_ajk_cn.id_nopol = fu_ajk_peserta.id_polis AND fu_ajk_cn.id_peserta = fu_ajk_peserta.id_peserta
		...
		LEFT JOIN fu_ajk_namapenyakit ON fu_ajk_namapenyakit.id=fu_ajk_klaim.sebab_meninggal
		LEFT JOIN fu_ajk_pembayaran_status ON fu_ajk_pembayaran_status.id=fu_ajk_cn.status_bayar
    LEFT JOIN fu_ajk_analisa_klaim ON fu_ajk_analisa_klaim.id_peserta=fu_ajk_peserta.id_peserta
    ...
    if ($_REQUEST['format_report']=='1') {
        $worksheet1->set_row(4, 15);
        $worksheet1->set_column(9, 0, 5);
        $worksheet1->write_string(9, 0, "No", $format);
        $worksheet1->set_column(9, 1, 5);
        $worksheet1->write_string(9, 1, "Urut", $format);
        $worksheet1->set_column(9, 2, 5);
        $worksheet1->write_string(9, 2, "Cabang", $format);
        $worksheet1->set_column(9, 3, 5);
        $worksheet1->write_string(9, 3, "Mitra", $format);
        $worksheet1->set_column(9, 4, 5);
        $worksheet1->write_string(9, 4, "Cover Asuransi", $format);
        $worksheet1->set_column(9, 5, 5);
        $worksheet1->write_string(9, 5, "Produk", $format);
        $worksheet1->set_column(9, 6, 5);
        $worksheet1->write_string(9, 6, "ID Peserta", $format);
        $worksheet1->set_column(9, 7, 5);
        $worksheet1->write_string(9, 7, "Nama Debitur", $format);
        $worksheet1->set_column(9, 8, 5);
        $worksheet1->write_string(9, 8, "Tgl Lahir", $format);
        $worksheet1->set_column(9, 9, 5);
        $worksheet1->write_string(9, 9, "Usia", $format);
        $worksheet1->set_column(9, 10, 5);
        $worksheet1->write_string(9, 10, "Plafond Kredit", $format);
        $worksheet1->set_column(9, 11, 5);
        $worksheet1->write_string(9, 11, "Tuntutan Klaim", $format);
        $worksheet1->set_column(9, 12, 5);
        $worksheet1->write_string(9, 12, "Tgl Akad", $format);
        $worksheet1->set_column(9, 13, 5);
        $worksheet1->write_string(9, 13, "J.Wkt (Th.)", $format);
        $worksheet1->set_column(9, 14, 5);
        $worksheet1->write_string(9, 14, "DOL", $format);
        $worksheet1->set_column(9, 15, 5);
        $worksheet1->write_string(9, 15, "Akad s/d DOL (hari)", $format);
        $worksheet1->set_column(9, 16, 5);
        $worksheet1->write_string(9, 16, "Tgl. Terima Laporan", $format);
        $worksheet1->set_column(9, 17, 5);
        $worksheet1->write_string(9, 17, "Dur", $format);
        $worksheet1->set_column(9, 18, 5);
        $worksheet1->write_string(9, 18, "Tgl. lapor As", $format);
        $worksheet1->set_column(9, 19, 5);
        $worksheet1->write_string(9, 19, "Kelengkapan Dokumen", $format);
        $worksheet1->set_column(9, 20, 5);
        $worksheet1->write_string(9, 20, "Tgl. Status Lengkap", $format);
        $worksheet1->set_column(9, 21, 5);
        $worksheet1->write_string(9, 21, "Tgl. Pengajuan Medical", $format);
        $worksheet1->set_column(9, 22, 5);
        $worksheet1->write_string(9, 22, "R ke", $format);
        $worksheet1->set_column(9, 23, 5);
        $worksheet1->write_string(9, 23, "Tgl R", $format);
        $worksheet1->set_column(9, 24, 5);
        $worksheet1->write_string(9, 24, "Due Date", $format);
        $worksheet1->set_column(9, 25, 5);
        $worksheet1->write_string(9, 25, "Dok As Date", $format);
        $worksheet1->set_column(9, 26, 5);
        $worksheet1->write_string(9, 26, "SLA As", $format);
        $worksheet1->set_column(9, 27, 5);
        $worksheet1->write_string(9, 27, "EM", $format);
        $worksheet1->set_column(9, 28, 5);
        $worksheet1->write_string(9, 28, "EM Keterangan", $format);
        $worksheet1->set_column(9, 29, 5);
        $worksheet1->write_string(9, 29, "Dokter Pemeriksa", $format);
        $worksheet1->set_column(9, 30, 5);
        $worksheet1->write_string(9, 30, "SPAK", $format);
        $worksheet1->set_column(9, 31, 5);
        $worksheet1->write_string(9, 31, "Tgl. Inv", $format);
        $worksheet1->set_column(9, 32, 5);
        $worksheet1->write_string(9, 32, "Hasil investigasi", $format);
        $worksheet1->set_column(9, 33, 5);
        $worksheet1->write_string(9, 33, "Penyebab Kematian", $format);
        $worksheet1->set_column(9, 34, 5);
        $worksheet1->write_string(9, 34, "Liability", $format);
        $worksheet1->set_column(9, 35, 5);
        $worksheet1->write_string(9, 35, "Status", $format);
        $worksheet1->set_column(9, 36, 5);
        $worksheet1->write_string(9, 36, "Paid As", $format);
        $worksheet1->set_column(9, 37, 5);
        $worksheet1->write_string(9, 37, "Paid As Date", $format);
        $worksheet1->set_column(9, 38, 5);
        $worksheet1->write_string(9, 38, "Approve", $format);
        $worksheet1->set_column(9, 39, 5);
        $worksheet1->write_string(9, 39, "Paid B", $format);
        $worksheet1->set_column(9, 40, 5);
        $worksheet1->write_string(9, 40, "Paid C Date", $format);
        $worksheet1->set_column(9, 41, 5);
        $worksheet1->write_string(9, 41, "Selisih", $format);
        $worksheet1->set_column(9, 42, 5);
        $worksheet1->write_string(9, 42, "Kol", $format);
        $worksheet1->set_column(9, 43, 5);
        $worksheet1->write_string(9, 43, "Exp", $format);
        $worksheet1->set_column(9, 44, 5);
        $worksheet1->write_string(9, 44, "Top Up", $format);
        $worksheet1->set_column(9, 45, 5);
    	$worksheet1->write_string(9, 45, "Tempat Meninggal", $format);
    	$worksheet1->set_column(9, 46, 5);
    	$worksheet1->write_string(9, 46, "Batas Kadaluarsa", $format);
        $worksheet1->set_column(9, 47, 5);
        $worksheet1->write_string(9, 47, "Ket. Penolakan", $format);
        ...
        while ($datanya_ = mysql_fetch_array($kucing)) {
            ...
            $worksheet1->write_string($baris, 4, $datanya_['code']);
            $worksheet1->write_string($baris, 5, $datanya_['nmproduk']);
            $worksheet1->write_string($baris, 6, $datanya_['id_peserta']);
            $worksheet1->write_string($baris, 7, $datanya_['nama']);
            $worksheet1->write_string($baris, 8, $datanya_['tgl_lahir']);
            $worksheet1->write_string($baris, 9, $datanya_['usia']);
            $worksheet1->write_number($baris, 10, $datanya_['kredit_jumlah']);
            $worksheet1->write_number($baris, 11, $datanya_['tuntutan_klaim']);
            $worksheet1->write_string($baris, 12, $datanya_['kredit_tgl']);
            $worksheet1->write_number($baris, 13, $datanya_['tenor']);
            $worksheet1->write_string($baris, 14, $datanya_['dol']);
            $worksheet1->write_number($baris, 15, $datanya_['akad_dol']);
            $worksheet1->write_string($baris, 16, $datanya_['tgl_terima_laporan']);
            $worksheet1->write_string($baris, 17, $datanya_['lama_terima_laporan']);
            $worksheet1->write_string($baris, 18, $datanya_['tgl_lapor_asuransi']);
            $worksheet1->write_string($baris, 19, $datanya_['kelengkapan_dokumen']);
            $worksheet1->write_string($baris, 20, $datanya_['tgl_status_lengkap']);
            $worksheet1->write_string($baris, 21, $datanya_['tgl_kirim_analisa']);
            $worksheet1->write_string($baris, 22, $reminder_ke);
            $worksheet1->write_string($baris, 23, $tgl_reminder);
            $worksheet1->write_string($baris, 24, $datanya_['due_date']);
            $worksheet1->write_string($baris, 25, $datanya_['tgl_kirim_dokumen']);
            ...
            $worksheet1->write_string($baris, 29, $datanya_['dokter_pemeriksa']);
            $worksheet1->write_string($baris, 30, $datanya_['spaj']);
            $worksheet1->write_string($baris, 31, $datanya_['tgl_investigasi']);
            $worksheet1->write_string($baris, 32, $datanya_['hasil_investigasi']);
            $worksheet1->write_string($baris, 33, $datanya_['penyebab_meinggal']);
            $worksheet1->write_string($baris, 34, $datanya_['polis_liability']);
            $worksheet1->write_string($baris, 35, $datanya_['status_klaim']);
            $worksheet1->write_number($baris, 36, $datanya_['total_bayar_asuransi']);
            $worksheet1->write_string($baris, 37, $datanya_['tgl_bayar_asuransi']);
            //$worksheet1->write_number($baris, 37,$datanya_['nilai_pengajuan_keuangan']);
            $worksheet1->write_number($baris, 38, $datanya_['approve']);
            $worksheet1->write_number($baris, 39, $datanya_['bayar_ke_bank']);
            $worksheet1->write_string($baris, 40, $datanya_['tgl_bayar_ke_client']);
            $worksheet1->write_number($baris, 41, $datanya_['selisih']);
            $worksheet1->write_string($baris, 42, $datanya_['kol']);
            $worksheet1->write_string($baris, 43, $datanya_['kadaluarsa']);
            $worksheet1->write_string($baris, 44, $datanya_['topup']);
            $worksheet1->write_string($baris, 45, $datanya_['tempat_meninggal']);
            $worksheet1->write_string($baris, 46, $datanya_['date_exp']);
            $worksheet1->write($baris, 47, $datanya_['alasan_tolak']);
            $baris++;
            $no++;
        }
        ...
        $worksheet1->write_string(9, 3, "Mitra", $format);
        $worksheet1->set_column(9, 4, 5);
        $worksheet1->write_string(9, 4, "Asuransi", $format);
        $worksheet1->set_column(9, 5, 5);
        $worksheet1->write_string(9, 5, "Produk", $format);
        $worksheet1->set_column(9, 6, 5);
        $worksheet1->write_string(9, 6, "ID Peserta", $format);
        ...
        $worksheet1->write_string(9, 20, "Tgl. Status Lengkap", $format);
        $worksheet1->set_column(9, 21, 5);
        $worksheet1->write_string(9, 21, "R ke", $format);
        $worksheet1->set_column(9, 22, 5);
        $worksheet1->write_string(9, 22, "Tgl R", $format);
        $worksheet1->set_column(9, 23, 5);
        $worksheet1->write_string(9, 23, "Due Date", $format);
        $worksheet1->set_column(9, 24, 5);
        $worksheet1->write_string(9, 24, "Tgl. kirim Dok. Ke Asuransi", $format);
        $worksheet1->set_column(9, 25, 5);
        $worksheet1->write_string(9, 25, "Status Release Asuransi (hari)", $format);
        $worksheet1->set_column(9, 26, 5);
        $worksheet1->write_string(9, 26, "EM", $format);
        $worksheet1->set_column(9, 27, 5);
        $worksheet1->write_string(9, 27, "EM Keterangan", $format);
        $worksheet1->set_column(9, 28, 5);
        $worksheet1->write_string(9, 28, "Dokter Pemeriksa", $format);
        $worksheet1->set_column(9, 29, 5);
        $worksheet1->write_string(9, 29, "SPAK", $format);
        $worksheet1->set_column(9, 30, 5);
        $worksheet1->write_string(9, 30, "Tgl. Inv", $format);
        $worksheet1->set_column(9, 31, 5);
        $worksheet1->write_string(9, 31, "Hasil investigasi", $format);
        $worksheet1->set_column(9, 32, 5);
        $worksheet1->write_string(9, 32, "Penyebab Kematian", $format);
        $worksheet1->set_column(9, 33, 5);
        $worksheet1->write_string(9, 33, "Liability", $format);
        $worksheet1->set_column(9, 34, 5);
        $worksheet1->write_string(9, 34, "Status", $format);
        $worksheet1->set_column(9, 35, 5);
        $worksheet1->write_string(9, 35, "Approve", $format);
        $worksheet1->set_column(9, 36, 5);
        $worksheet1->write_string(9, 36, "Paid B", $format);
        $worksheet1->set_column(9, 37, 5);
        $worksheet1->write_string(9, 37, "Paid C Date", $format);
        $worksheet1->set_column(9, 38, 5);
        $worksheet1->write_string(9, 38, "Kol", $format);
        $worksheet1->set_column(9, 39, 5);
        $worksheet1->write_string(9, 39, "Exp", $format);
        $baris = 10;
        $no=1;
        while ($datanya_ = mysql_fetch_array($kucing)) {
            if ($datanya_['tgl_surat_reminder3']!='0000-00-00') {
            ...
            $worksheet1->write_string($baris, 19, $datanya_['kelengkapan_dokumen']);
            $worksheet1->write_string($baris, 20, $datanya_['tgl_status_lengkap']);
            $worksheet1->write_string($baris, 21, $reminder_ke);
            $worksheet1->write_string($baris, 22, $tgl_reminder);
            $worksheet1->write_string($baris, 23, $datanya_['due_date']);
            $worksheet1->write_string($baris, 24, $datanya_['tgl_kirim_dokumen']);
            $worksheet1->write_string($baris, 25, $datanya_['status_release']);
            $worksheet1->write_string($baris, 26, $datanya_['EM']);
            $worksheet1->write_string($baris, 27, $datanya_['keterangan_EM']);
            $worksheet1->write_string($baris, 28, $datanya_['dokter_pemeriksa']);
            $worksheet1->write_string($baris, 29, $datanya_['spaj']);
            $worksheet1->write_string($baris, 30, $datanya_['tgl_investigasi']);
            $worksheet1->write_string($baris, 31, $datanya_['hasil_investigasi']);
            $worksheet1->write_string($baris, 32, $datanya_['penyebab_meinggal']);
            $worksheet1->write_string($baris, 33, $datanya_['polis_liability']);
            $worksheet1->write_string($baris, 34, $datanya_['status_klaim']);
            ...
            $worksheet1->write_string($baris, 37, $datanya_['tgl_bayar_ke_client']);
            $worksheet1->write_string($baris, 38, $datanya_['kol']);
            $worksheet1->write_string($baris, 39, $datanya_['kadaluarsa']);
        ...
        $worksheet1->write_string(9, 23, "Due Date", $format);
        $worksheet1->set_column(9, 24, 5);
        $worksheet1->write_string(9, 24, "Dok As Date", $format);
        $worksheet1->set_column(9, 25, 5);
        $worksheet1->write_string(9, 25, "SLA As", $format);
        $worksheet1->set_column(9, 26, 5);
        $worksheet1->write_string(9, 26, "EM", $format);
        $worksheet1->set_column(9, 27, 5);
        $worksheet1->write_string(9, 27, "EM Keterangan", $format);
        ...
        $worksheet1->write_string(9, 34, "Status", $format);
        $worksheet1->set_column(9, 35, 5);
        $worksheet1->write_string(9, 35, "Paid As", $format);
        $worksheet1->set_column(9, 36, 5);
        $worksheet1->write_string(9, 36, "Paid As Date", $format);
        $worksheet1->set_column(9, 37, 5);
        $worksheet1->write_string(9, 37, "Kol", $format);
        $worksheet1->set_column(9, 38, 5);
        $worksheet1->write_string(9, 38, "Exp", $format);
        $baris = 10;
        $no=1;
        while ($datanya_ = mysql_fetch_array($kucing)) {
            $worksheet1->write_string($baris, 0, $no);
            ...
            $worksheet1->write_string($baris, 33, $datanya_['polis_liability']);
            $worksheet1->write_string($baris, 34, $datanya_['status_klaim']);
            $worksheet1->write_number($baris, 35, $datanya_['total_bayar_asuransi']);
            $worksheet1->write_string($baris, 36, $datanya_['tgl_bayar_asuransi']);
            $worksheet1->write_string($baris, 37, $datanya_['kol']);
            $worksheet1->write_string($baris, 38, $datanya_['kadaluarsa']);
  ...
  case "klaim_tiering_asuransi_all":
    ...
    $worksheet1->merge_cells(0, 0, 0, 44);	$worksheet1->write_string(0, 0, "DATA KLAIM TIERING ".strtoupper($_REQUEST['status_klaim']), $fjudul, 1);


    if (!empty($_REQUEST['tgl1'])) {
        $worksheet1->merge_cells(1, 0, 1, 44);
        $worksheet1->write_string(1, 0, "TANGGAL LAPOR "._convertDate($_REQUEST['tgl1'])." s/d "._convertDate($_REQUEST['tgl2'])."", $fjudul);
    }


    if (!empty($_REQUEST['tgl3'])) {
        $worksheet1->merge_cells(2, 0, 2, 44);
        $worksheet1->write_string(1, 0, "DOL "._convertDate($_REQUEST['tgl3'])." s/d "._convertDate($_REQUEST['tgl4'])."", $fjudul);
    }
    ...
    $worksheet1->set_row(4, 15);
    $worksheet1->set_column(9, 0, 5);	$worksheet1->write_string(9, 0, "No", $format);
    $worksheet1->set_column(9, 1, 5);	$worksheet1->write_string(9, 1, "Nomor Urut", $format);
    ...
    $worksheet1->set_column(9, 6, 5);	$worksheet1->write_string(9, 6, "ID Peserta", $format);
    $worksheet1->set_column(9, 7, 5);	$worksheet1->write_string(9, 7, "Nama Debitur", $format);
    $worksheet1->set_column(9, 8, 5);	$worksheet1->write_string(9, 8, "Tgl Lahir", $format);
    $worksheet1->set_column(9, 9, 5);	$worksheet1->write_string(9, 9, "Usia", $format);
    $worksheet1->set_column(9, 10, 5);	$worksheet1->write_string(9, 10, "Plafond Kredit", $format);
    $worksheet1->set_column(9, 11, 5);	$worksheet1->write_string(9, 11, "Tuntutan Klaim", $format);
    $worksheet1->set_column(9, 11, 5);	$worksheet1->write_string(9, 12, "Perc. Tiering", $format);
    $worksheet1->set_column(9, 11, 5);	$worksheet1->write_string(9, 13, "Nilai Tiering", $format);
    $worksheet1->set_column(9, 12, 5);	$worksheet1->write_string(9, 14, "Tgl Akad", $format);
    $worksheet1->set_column(9, 13, 5);	$worksheet1->write_string(9, 15, "J.Wkt (Th.)", $format);
    $worksheet1->set_column(9, 14, 5);	$worksheet1->write_string(9, 16, "DOL", $format);
    $worksheet1->set_column(9, 15, 5);	$worksheet1->write_string(9, 17, "Akad s/d DOL (hari)", $format);
    $worksheet1->set_column(9, 16, 5);	$worksheet1->write_string(9, 18, "Tgl. Terima Laporan", $format);
    $worksheet1->set_column(9, 17, 5);	$worksheet1->write_string(9, 19, "Lama Terima Laporan", $format);
    $worksheet1->set_column(9, 18, 5);	$worksheet1->write_string(9, 20, "Tgl. Update Klaim", $format);
    $worksheet1->set_column(9, 19, 5);	$worksheet1->write_string(9, 21, "Tgl. lapor Asuransi", $format);
    $worksheet1->set_column(9, 20, 5);	$worksheet1->write_string(9, 22, "Kelengkapan Dokumen", $format);
    $worksheet1->set_column(9, 21, 5);	$worksheet1->write_string(9, 23, "Tgl. Status Lengkap", $format);
    $worksheet1->set_column(9, 22, 5);	$worksheet1->write_string(9, 24, "Due Date (PKS)", $format);
    $worksheet1->set_column(9, 23, 5);	$worksheet1->write_string(9, 25, "Tgl. kirim Dok. Ke Asuransi", $format);
    $worksheet1->set_column(9, 24, 5);	$worksheet1->write_string(9, 26, "Today", $format);
    $worksheet1->set_column(9, 25, 5);	$worksheet1->write_string(9, 27, "Status Release Asuransi (hari)", $format);
    $worksheet1->set_column(9, 26, 5);	$worksheet1->write_string(9, 28, "EM", $format);
    $worksheet1->set_column(9, 27, 5);	$worksheet1->write_string(9, 29, "EM Keterangan", $format);
    $worksheet1->set_column(9, 28, 5);	$worksheet1->write_string(9, 30, "Tgl. Investigasi", $format);
    $worksheet1->set_column(9, 29, 5);	$worksheet1->write_string(9, 31, "Hasil investigasi", $format);
    $worksheet1->set_column(9, 30, 5);	$worksheet1->write_string(9, 32, "Penyebab Kematian", $format);
    $worksheet1->set_column(9, 31, 5);	$worksheet1->write_string(9, 33, "policy Liability", $format);
    $worksheet1->set_column(9, 32, 5);	$worksheet1->write_string(9, 34, "Status Klaim", $format);
    $worksheet1->set_column(9, 33, 5);	$worksheet1->write_string(9, 35, "Keterangan Asuransi", $format);
    $worksheet1->set_column(9, 34, 5);	$worksheet1->write_string(9, 36, "Asuransi Bayar", $format);
    $worksheet1->set_column(9, 35, 5);	$worksheet1->write_string(9, 37, "Ref. Pemb Dari Asuransi", $format);
    $worksheet1->set_column(9, 36, 5);	$worksheet1->write_string(9, 38, "Tgl Bayar dari Asuransi", $format);
    $worksheet1->set_column(9, 37, 5);	$worksheet1->write_string(9, 39, "Pengajuan Keuangan", $format);
    $worksheet1->set_column(9, 38, 5);	$worksheet1->write_string(9, 40, "Bayar Ke Bank (Rp)", $format);
    $worksheet1->set_column(9, 39, 5);	$worksheet1->write_string(9, 41, "Ref. Pemb ke bank", $format);
    $worksheet1->set_column(9, 40, 5);	$worksheet1->write_string(9, 42, "Tgl Pembayaran ke Client", $format);
    $worksheet1->set_column(9, 41, 5);	$worksheet1->write_string(9, 43, "Selisih", $format);
    $worksheet1->set_column(9, 42, 5);	$worksheet1->write_string(9, 44, "Kol", $format);
    ...
    while ($datanya_ = mysql_fetch_array($kucing)) {
        ...
        $worksheet1->write_string($baris, 9, $datanya_['usia']);
        $worksheet1->write_number($baris, 10, $datanya_['kredit_jumlah']);
        $worksheet1->write_number($baris, 11, $datanya_['total_claim']);
        $worksheet1->write_string($baris, 12, $datanya_['persentase_tiering']);
        $worksheet1->write_string($baris, 13, $datanya_['nilai_tiering']);
        $worksheet1->write_string($baris, 14, $datanya_['kredit_tgl']);
        $worksheet1->write_number($baris, 15, $datanya_['tenor']);
        $worksheet1->write_string($baris, 16, $datanya_['dol']);
        $worksheet1->write_number($baris, 17, $datanya_['akad_dol']);
        $worksheet1->write_string($baris, 18, $datanya_['tgl_terima_laporan']);
        $worksheet1->write_string($baris, 19, $datanya_['lama_terima_laporan']);
        $worksheet1->write_string($baris, 20, $datanya_['tgl_update_klaim']);
        $worksheet1->write_string($baris, 21, $datanya_['tgl_lapor_asuransi']);
        $worksheet1->write_string($baris, 22, $datanya_['kelengkapan_dokumen']);
        $worksheet1->write_string($baris, 23, $datanya_['tgl_status_lengkap']);
        $worksheet1->write_string($baris, 24, $datanya_['due_date']);
        $worksheet1->write_string($baris, 25, $datanya_['tgl_kirim_dokumen']);
        $worksheet1->write_string($baris, 26, $datanya_['today']);
        $worksheet1->write_string($baris, 27, $datanya_['status_release']);
        $worksheet1->write_string($baris, 28, $datanya_['EM']);
        $worksheet1->write_string($baris, 29, $datanya_['keterangan_EM']);
        $worksheet1->write_string($baris, 30, $datanya_['tgl_investigasi']);
        $worksheet1->write_string($baris, 31, $datanya_['hasil_investigasi']);
        $worksheet1->write_string($baris, 32, $datanya_['penyebab_meinggal']);
        $worksheet1->write_string($baris, 33, $datanya_['polis_liability']);
        $worksheet1->write_string($baris, 34, $datanya_['status_klaim']);
        $worksheet1->write_string($baris, 35, $datanya_['keterangan_asuransi']);
        $worksheet1->write_number($baris, 36, $datanya_['total_bayar_asuransi']);
        $worksheet1->write_string($baris, 37, $datanya_['ref_bayar_asuransi']);
        $worksheet1->write_string($baris, 38, $datanya_['tgl_bayar_asuransi']);
        $worksheet1->write_number($baris, 39, $datanya_['nilai_pengajuan_keuangan']);
        $worksheet1->write_number($baris, 40, $datanya_['bayar_ke_bank']);
        $worksheet1->write_string($baris, 41, $datanya_['ref_pembayaran_ke_bank']);
        $worksheet1->write_string($baris, 42, $datanya_['tgl_bayar_ke_client']);
        $worksheet1->write_number($baris, 43, $datanya_['selisih']);
        $worksheet1->write_string($baris, 44, $datanya_['kol']);
  ...
  case "spkkadaluarsa":
    ...
    $worksheet1->write_string(0, 0, "DATA SPK KADALUARSA", $fjudul, 1);
    $worksheet1->write_string(1, 0, "CABANG ".$_REQUEST['nmcabang'], $fjudul);
    $worksheet1->write_string(2, 0, $_REQUEST['jmlhr']." Hari Sebelum Jatuh Tempo", $fjudul);

    $worksheet1->set_row(5, 15);
    $worksheet1->set_column(5, 0, 5);	$worksheet1->write_string(5, 0, "No", $format);
    $worksheet1->set_column(5, 1, 5);	$worksheet1->write_string(5, 1, "Nama Produk", $format);
    $worksheet1->set_column(5, 2, 5);	$worksheet1->write_string(5, 2, "No SPK", $format);
    $worksheet1->set_column(5, 3, 5);	$worksheet1->write_string(5, 3, "Nama", $format);
    $worksheet1->set_column(5, 4, 5);	$worksheet1->write_string(5, 4, "Plafond", $format);
    $worksheet1->set_column(5, 5, 5);	$worksheet1->write_string(5, 5, "Tenor", $format);
    $worksheet1->set_column(5, 6, 5);	$worksheet1->write_string(5, 6, "Cabang", $format);
    $worksheet1->set_column(5, 7, 5);	$worksheet1->write_string(5, 7, "Tgl Input", $format);
    $worksheet1->set_column(5, 8, 5);	$worksheet1->write_string(5, 8, "Tgl Kadaluarsa", $format);
    $worksheet1->set_column(5, 9, 5);	$worksheet1->write_string(5, 9, "Selisih", $format);
    ...
    while ($datanya_ = mysql_fetch_array($kucing)) {
        $worksheet1->write_number($baris, 0, ++$no);
        $worksheet1->write_string($baris, 1, $datanya_['nmproduk']);
        $worksheet1->write_string($baris, 2, $datanya_['spak']);
        $worksheet1->write_string($baris, 3, $datanya_['nama']);
        $worksheet1->write_string($baris, 4, $datanya_['plafond']);
        $worksheet1->write_string($baris, 5, $datanya_['tenor']);
        $worksheet1->write_string($baris, 6, $datanya_['name']);
        $worksheet1->write_string($baris, 7, $datanya_['input_date']);
        $worksheet1->write_string($baris, 8, $datanya_['tgl_kadaluarsa']);
        $worksheet1->write_string($baris, 9, $datanya_['selisih']);
...
case "eL_FeePemeriksaanDokterDetailAll":
        ...
        $worksheet1->merge_cells(0, 0, 0, 9);	$worksheet1->write_string(0, 0, "REKAP DATA FEE DOKTER DETAIL", $fjudul, 1);
        $worksheet1->merge_cells(1, 0, 1, 9);	$worksheet1->write_string(1, 0, "TANGGAL PERIKSA "._convertDate($_REQUEST['tgl1'])." s/d "._convertDate($_REQUEST['tgl2'])."", $fjudul);

        $worksheet1->set_row(4, 15);
        $worksheet1->set_column(4, 0, 5);	$worksheet1->write_string(4, 0, "NO", $format);
        $worksheet1->set_column(4, 1, 15);	$worksheet1->write_string(4, 1, "NAMA DOKTER", $format);
        $worksheet1->set_column(4, 2, 15);	$worksheet1->write_string(4, 2, "NAMA DEBITUR", $format);
        $worksheet1->set_column(4, 3, 15);	$worksheet1->write_string(4, 3, "NO SPK", $format);
        $worksheet1->set_column(4, 3, 15);  $worksheet1->write_string(4, 4, "EM", $format);
        $worksheet1->set_column(4, 5, 15);	$worksheet1->write_string(4, 5, "TGL PERIKSA", $format);
        $worksheet1->set_column(4, 5, 15);	$worksheet1->write_string(4, 6, "USIA", $format);
        $worksheet1->set_column(4, 5, 15);	$worksheet1->write_string(4, 7, "CABANG", $format);
        $worksheet1->set_column(4, 5, 15);	$worksheet1->write_string(4, 8, "CATATAN", $format);
        $worksheet1->set_column(4, 5, 15);	$worksheet1->write_string(4, 9, "NO PENGAJUAN", $format);
        ...
        while ($jangkrik = mysql_fetch_array($kucing)) {
            $worksheet1->write_number($baris, 0, ++$no);
            $worksheet1->write_string($baris, 1, $jangkrik['namalengkap']);
            $worksheet1->write_string($baris, 2, $jangkrik['nama']);
            $worksheet1->write_string($baris, 3, $jangkrik['spak']);
            $worksheet1->write_string($baris, 4, $jangkrik['ext_premi']);
            $worksheet1->write_string($baris, 5, $jangkrik['tgl_periksa']);
            $worksheet1->write_string($baris, 6, $jangkrik['x_usia']);
            $worksheet1->write_string($baris, 7, $jangkrik['name']);
            $worksheet1->write_string($baris, 8, $jangkrik['catatan']);
            $worksheet1->write_string($baris, 9, $jangkrik['nopermohonan']);
            $baris++;
        }
    ...
    case "klaim_investigasi":
        ...
        $worksheet1->merge_cells(0, 0, 0, 7);	$worksheet1->write_string(0, 0, "REKAP INVESTIGASI KLAIM", $fjudul, 1);
        if ($_REQUEST['tgl1']!=="") {
            $worksheet1->merge_cells(1, 0, 1, 7);
            $worksheet1->write_string(1, 0, "TANGGAL APPROVED INVESTIGASI "._convertDate($_REQUEST['tgl1'])." s/d "._convertDate($_REQUEST['tgl2'])."", $fjudul);
        }

        if ($_REQUEST['tgl3']!=="") {
            $worksheet1->merge_cells(2, 0, 2, 7);
            $worksheet1->write_string(2, 0, "TANGGAL APPROVED MEDICAL "._convertDate($_REQUEST['tgl3'])." s/d "._convertDate($_REQUEST['tgl4'])."", $fjudul);
        }
        ...
        $worksheet1->set_row(4, 15);
        $worksheet1->set_column(4, 0, 5);	$worksheet1->write_string(4, 0, "NO", $format);
        $worksheet1->set_column(4, 1, 15);	$worksheet1->write_string(4, 1, "TGL LAPOR", $format);
        $worksheet1->set_column(4, 2, 15);	$worksheet1->write_string(4, 2, "NO URUT", $format);
        $worksheet1->set_column(4, 3, 15);	$worksheet1->write_string(4, 3, "ASURANSI", $format);
        $worksheet1->set_column(4, 4, 15);	$worksheet1->write_string(4, 4, "ID PESERTA", $format);
        $worksheet1->set_column(4, 5, 15);	$worksheet1->write_string(4, 5, "NAMA DEBITUR", $format);
        $worksheet1->set_column(4, 6, 15);	$worksheet1->write_string(4, 6, "PRODUK", $format);
        $worksheet1->set_column(4, 7, 15);	$worksheet1->write_string(4, 7, "CABANG", $format);
        $worksheet1->set_column(4, 8, 15);	$worksheet1->write_string(4, 8, "AWAL KREDIT", $format);
        $worksheet1->set_column(4, 9, 15);	$worksheet1->write_string(4, 9, "AKHIR KREDIT", $format);
        $worksheet1->set_column(4, 10, 15);	$worksheet1->write_string(4, 10, "DOL", $format);
        $worksheet1->set_column(4, 11, 15);	$worksheet1->write_string(4, 11, "TGL APPROVE", $format);
        $worksheet1->set_column(4, 12, 15);	$worksheet1->write_string(4, 12, "TENOR", $format);
        $worksheet1->set_column(4, 13, 15);	$worksheet1->write_string(4, 13, "PLAFOND", $format);
        $worksheet1->set_column(4, 14, 15);	$worksheet1->write_string(4, 14, "TUNTUTAN KLAIM", $format);
        $worksheet1->set_column(4, 15, 15);	$worksheet1->write_string(4, 15, "TGL APP INVESTIGASI", $format);
        $worksheet1->set_column(4, 16, 15);	$worksheet1->write_string(4, 16, "TGL APP MEDICAL", $format);
        $worksheet1->set_column(4, 17, 15);	$worksheet1->write_string(4, 17, "TEMPAT MENINGGAL", $format);
        $worksheet1->set_column(4, 18, 15);	$worksheet1->write_string(4, 18, "KATEGORI KLAIM", $format);
        $worksheet1->set_column(4, 19, 15);	$worksheet1->write_string(4, 19, "RIWAYAT PENYAKIT", $format);
        $worksheet1->set_column(4, 20, 15);	$worksheet1->write_string(4, 20, "KRONOLOGI", $format);
        $worksheet1->set_column(4, 21, 15);	$worksheet1->write_string(4, 21, "PREEXISTING CONDITION", $format);
        $worksheet1->set_column(4, 22, 15);	$worksheet1->write_string(4, 22, "DIAGNOSA", $format);
        $worksheet1->set_column(4, 23, 15);	$worksheet1->write_string(4, 23, "IC DIAGNOSA", $format);
        $worksheet1->set_column(4, 24, 15);	$worksheet1->write_string(4, 24, "KET DOKTER", $format);
        $worksheet1->set_column(4, 25, 15);	$worksheet1->write_string(4, 25, "HASIL INVESTIGASI", $format);
        $worksheet1->set_column(4, 26, 15);	$worksheet1->write_string(4, 26, "SEBAB MENINGGAL", $format);


        while ($jangkrik = mysql_fetch_array($kucing)) {
            $worksheet1->write_number($baris, 0, ++$no);
            $worksheet1->write_string($baris, 1, $jangkrik['input_date']);
            $worksheet1->write_string($baris, 2, $jangkrik['no_urut_klaim']);
            $worksheet1->write_string($baris, 3, $jangkrik['asuransi']);
            $worksheet1->write_string($baris, 4, $jangkrik['id_peserta']);
            $worksheet1->write_string($baris, 5, $jangkrik['nama']);
            $worksheet1->write_string($baris, 6, $jangkrik['nmproduk']);
            $worksheet1->write_string($baris, 7, $jangkrik['cabang']);
            $worksheet1->write_string($baris, 8, $jangkrik['kredit_tgl']);
            $worksheet1->write_string($baris, 9, $jangkrik['kredit_akhir']);
            $worksheet1->write_string($baris, 10, $jangkrik['tgl_claim']);
            $worksheet1->write_string($baris, 11, $jangkrik['approve_date']);
            $worksheet1->write_number($baris, 12, $jangkrik['tenor']);
            $worksheet1->write_number($baris, 13, $jangkrik['totalpremi']);
            $worksheet1->write_number($baris, 14, $jangkrik['tuntutan_klaim']);
            $worksheet1->write_string($baris, 15, $jangkrik['tgl_app_investigasi']);
            $worksheet1->write_string($baris, 16, $jangkrik['tgl_app_opinimedis']);
            $worksheet1->write_string($baris, 17, $jangkrik['tempat_meninggal']);
            $worksheet1->write_string($baris, 18, $jangkrik['kategori_klaim']);
            $worksheet1->write_string($baris, 19, $jangkrik['riwayat_penyakit']);
            $worksheet1->write_string($baris, 20, $jangkrik['kronologi']);
            $worksheet1->write_string($baris, 21, $jangkrik['preexisting_cond']);
            $worksheet1->write_string($baris, 22, $jangkrik['diagnosa']);
            $worksheet1->write_string($baris, 23, $jangkrik['ic_diagnosis']);
            $worksheet1->write_string($baris, 24, $jangkrik['ket_dokter']);
            $worksheet1->write_string($baris, 25, $jangkrik['hasil_investigasi']);
            $worksheet1->write_string($baris, 26, $jangkrik['namapenyakit']);
            $baris++;
        }
    ...
    case "kadaluarsa":
        ...
        $worksheet1->merge_cells(0, 0, 0, 23);	$worksheet1->write_string(0, 0, "DATA KLAIM PRA KADALUARSA PER TANGGAL ".date("d M Y"), $fjudul, 1);
        ...
        $worksheet1->set_column(4, 25, 5);	$worksheet1->write_string(4, 25, "Selisih Bayar (Rp.)", $format);
        $worksheet1->set_column(4, 26, 5);	$worksheet1->write_string(4, 26, "Kol", $format);
        $worksheet1->set_column(4, 27, 5);	$worksheet1->write_string(4, 27, "Kadalaursa (Hari)", $format);
        ...
        while ($kucingkawin = mysql_fetch_array($kucing)) {
            ...
            $worksheet1->write_string($baris, 15, $kucingkawin['akad_dol']);
            $worksheet1->write_string($baris, 16, $kucingkawin['tgl_lapor_klaim']);
            $worksheet1->write_string($baris, 17, $kucingkawin['kelengkapan_dokumen']);
            $worksheet1->write_string($baris, 18, $kucingkawin['input_date']);
            $worksheet1->write_string($baris, 19, $kucingkawin['tgl_document_lengkap']);
            $worksheet1->write_string($baris, 20, $kucingkawin['status_klaim']);
            $worksheet1->write_number($baris, 21, $kucingkawin['total_bayar_asuransi']);
            ...
            $worksheet1->write_string($baris, 25, $kucingkawin['selisih']);
            $worksheet1->write_number($baris, 26, $kucingkawin['kol']);
            $worksheet1->write_number($baris, 27, $kucingkawin['kadaluarsa1'].' hari sebelum kadaluarsa');
    ...
    case "invklaimfinish":
      ...
      HeaderingExcel('LAPORAN KLAIM SUDAH ANALISA.xls');
      $workbook = new Workbook("");
      $worksheet1 =& $workbook->add_worksheet('Laporan Klaim Sudah Analisa');
      $format =& $workbook->add_format();
      $format->set_align('vcenter');  $format->set_align('center'); $format->set_color('white');  $format->set_bold();  $format->set_pattern(); $format->set_fg_color('green');
      ...
      $worksheet1->write_string(0, 0, "LAPORAN KLAIM SUDAH ANALISA", $fjudul, 1);
      $worksheet1->merge_cells(0, 0, 0, 15);
      $worksheet1->set_column(4, 0, 5);   $worksheet1->write_string(4, 0, "NO", $format);
      $worksheet1->set_column(4, 1, 15);  $worksheet1->write_string(4, 1, "ID PESERTA", $format);
      $worksheet1->set_column(4, 2, 15);  $worksheet1->write_string(4, 2, "PRODUK", $format);
      $worksheet1->set_column(4, 3, 15);  $worksheet1->write_string(4, 3, "NAMA DEBITUR", $format);
      $worksheet1->set_column(4, 4, 15);  $worksheet1->write_string(4, 4, "Diagnosa", $format);
      $worksheet1->set_column(4, 5, 15);  $worksheet1->write_string(4, 5, "Diagnosa Cabang", $format);
      $worksheet1->set_column(4, 6, 15);  $worksheet1->write_string(4, 6, "Kode Diagnosa", $format);
      $worksheet1->set_column(4, 7, 15);  $worksheet1->write_string(4, 7, "CABANG", $format);
      $worksheet1->set_column(4, 8, 10);  $worksheet1->write_string(4, 8, "STATUS", $format);
      $worksheet1->set_column(4, 9, 10);  $worksheet1->write_string(4, 9, "TGL APPROVE", $format);
      $worksheet1->set_column(4, 10, 100);    $worksheet1->write_string(4, 10, "ANALISA BANK", $format);
      $worksheet1->set_column(4, 11, 100); $worksheet1->write_string(4, 11, "ANALISA ASURANSI", $format);

      if($_REQUEST['user']=="Legal"){
        $tipe = " and type_analisa = 'legal'";
      }else{
        $tipe = " and type_analisa = 'medical'";
      }

      $query = "
        SELECT fu_ajk_analisa_klaim.id_peserta,
                fu_ajk_polis.nmproduk,
                fu_ajk_peserta.nama,
                fu_ajk_peserta.cabang,
                ...
                fu_ajk_analisa_klaim.approve_date,
                fu_ajk_analisa_klaim.ext_penyebab,
                fu_ajk_analisa_klaim.kode_diagnosa,
                fu_ajk_namapenyakit.namapenyakit
        FROM fu_ajk_analisa_klaim
        INNER JOIN fu_ajk_peserta
        ON fu_ajk_peserta.id_peserta = fu_ajk_analisa_klaim.id_peserta
        INNER JOIN fu_ajk_polis
        ON fu_ajk_polis.id = fu_ajk_peserta.id_polis
        LEFT JOIN fu_ajk_klaim
        ON fu_ajk_klaim.id_peserta = fu_ajk_peserta.id_peserta and fu_ajk_klaim.del is null
        LEFT JOIN fu_ajk_namapenyakit
        ON fu_ajk_namapenyakit.id = fu_ajk_klaim.sebab_meninggal
        WHERE sts_analisa in ('Finish','Approve Analisa') ".$tipe;
      ...
      while ($qpeserta_ = mysql_fetch_array($qpeserta)) {
          $worksheet1->write_string($baris, 0, ++$no);
          $worksheet1->write_string($baris, 1, $qpeserta_['id_peserta']);
          $worksheet1->write_string($baris, 2, $qpeserta_['nmproduk']);
          $worksheet1->write_string($baris, 3, $qpeserta_['nama']);
          $worksheet1->write_string($baris, 4, $qpeserta_['ext_penyebab']);
          $worksheet1->write_string($baris, 5, $qpeserta_['namapenyakit']);
          $worksheet1->write_string($baris, 6, $qpeserta_['kode_diagnosa']);
          $worksheet1->write_string($baris, 7, $qpeserta_['cabang']);
          $worksheet1->write_string($baris, 8, $qpeserta_['sts_analisa']);
          $worksheet1->write_string($baris, 9, $qpeserta_['approve_date']);
          $worksheet1->write_string($baris, 10, $qpeserta_['analisa_bank']);
          $worksheet1->write_string($baris, 11, $qpeserta_['analisa_asuransi']);
          $baris++;
      }
    ...
    case "klaimkurangdokumen":
      ...
      if($_REQUEST['cab']=='KNS' or $_REQUEST['cab']=='KKB' or $_REQUEST['cab']=='BHAKTI ABADI' or $_REQUEST['cab']=='KOSPPI' or $_REQUEST['cab']=='MEKARSARI' or $_REQUEST['cab']=='KAR' or $_REQUEST['cab']=='GILANG GEMILANG'){
            $where = ' and regional = "'.$cabang.'"';
        }else{
            $where = ' and id_cabang ="'.$cabang.'"';
        }
      function HeaderingExcel($filename)
      {
          header("Content-type: application/vnd.ms-excel");
      ...
      HeaderingExcel('LIST_KLAIM_KURANG_DOC_'.$cabang.date('YmdHis').'.xls');
      $workbook = new Workbook();
      $worksheet1 =& $workbook->add_worksheet($cabang);
      $format =& $workbook->add_format();
      $format->set_align('vcenter');  $format->set_align('center'); $format->set_color('white');  $format->set_bold();  $format->set_pattern(); $format->set_fg_color('green');
      ...
      $worksheet1->set_column(2, 2, 15); $worksheet1->write_string(2, 2, "MITRA", $format);
      $worksheet1->set_column(2, 3, 15); $worksheet1->write_string(2, 3, "ID PESERTA", $format);
      $worksheet1->set_column(2, 4, 15); $worksheet1->write_string(2, 4, "NAMA DEBITUR", $format);
      $worksheet1->set_column(2, 5, 15); $worksheet1->write_string(2, 5, "TGL LAHIR", $format);
      $worksheet1->set_column(2, 6, 15); $worksheet1->write_string(2, 6, "USIA", $format);
      $worksheet1->set_column(2, 7, 15); $worksheet1->write_string(2, 7, "PLAFOND KREDIT", $format);
      $worksheet1->set_column(2, 8, 15); $worksheet1->write_string(2, 8, "TUNTUTAN KLAIM", $format);
      $worksheet1->set_column(2, 9, 15); $worksheet1->write_string(2, 9, "TGL AKAD", $format);
      $worksheet1->set_column(2, 10, 15); $worksheet1->write_string(2, 10, "JK.WKT", $format);
      $worksheet1->set_column(2, 11, 15); $worksheet1->write_string(2, 11, "DOL", $format);
      $worksheet1->set_column(2, 12, 15); $worksheet1->write_string(2, 12, "TGL TERIMA LAPORAN", $format);
      $worksheet1->set_column(2, 13, 15); $worksheet1->write_string(2, 13, "KELENGKAPAN DOKUMEN", $format);
      $worksheet1->set_column(2, 14, 15); $worksheet1->write_string(2, 14, "STATUS", $format);
      $worksheet1->set_column(2, 15, 15); $worksheet1->write_string(2, 15, "KOL", $format);
      $worksheet1->set_column(2, 16, 15); $worksheet1->write_string(2, 16, "EXP", $format);      
      ...
      while ($row = mysql_fetch_array($result)) {
        $worksheet1->write_string($baris, 0, ++$no);
        $worksheet1->write_string($baris, 1, $row['id_cabang']);
        $worksheet1->write_string($baris, 2, $row['mitra']);
        $worksheet1->write_string($baris, 3, $row['id_peserta']);
        ...
        $worksheet1->write_string($baris, 16, $row['date_exp']);        
        $baris++;
      }
      ...
      $mail->Subject = "[App AJK] Kelengkapan Dokumen Klaim an '".$nm_peserta.'('.$qpeserta['cabang'].')'; //Subject od your mail
      //$mail->AddAddress('hansen@adonai.co.id'); //To address who will receive this email
	  $mail->AddAddress('heru@adonaits.co.id'); //To address who will receive this email
    ...
    case "eL_KlaimSPK":
        ...
        HeaderingExcel('LAPORAN KLAIM SPK.xls');
        $workbook = new Workbook("");
        $worksheet1 =& $workbook->add_worksheet('KLAIM SPK');
        $format =& $workbook->add_format();
        $format->set_align('vcenter');	$format->set_align('center');	$format->set_color('white');	$format->set_bold();	$format->set_pattern();	$format->set_fg_color('green');
        $fjudul =& $workbook->add_format();	$fjudul->set_align('vcenter');	$fjudul->set_align('center');	$fjudul->set_bold();

        $worksheet1->merge_cells(0, 0, 0, 17);	$worksheet1->write_string(0, 0, "LAPORAN KLAIM SPK", $fjudul, 1);
        if($_REQUEST['tglakad1']){
          $qs_tgl_akad = ' AND tglakad between "'.$_REQUEST['tglakad1'].'" and "'.$_REQUEST['tglakad2'].'"';
          $worksheet1->merge_cells(1, 0, 1, 17);	$worksheet1->write_string(1, 0, "TANGGAL AKAD "._convertDate($_REQUEST['tglakad1'])." s/d "._convertDate($_REQUEST['tglakad2'])."", $fjudul);
        }
        if($_REQUEST['tgldol1']){
          $qs_tgl_dol = ' AND tgl_klaim between "'.$_REQUEST['tgldol1'].'" and "'.$_REQUEST['tgldol2'].'"';
          $worksheet1->merge_cells(2, 0, 1, 17);	$worksheet1->write_string(1, 0, "TANGGAL DOL "._convertDate($_REQUEST['tgldol1'])." s/d "._convertDate($_REQUEST['tgldol2'])."", $fjudul);
        }        
        ...
        $worksheet1->set_column(4, 4, 15);	$worksheet1->write_string(4, 4, "ID PESERTA", $format);
        $worksheet1->set_column(4, 5, 15);	$worksheet1->write_string(4, 5, "NAMA DEBITUR", $format);
        $worksheet1->set_column(4, 6, 15);	$worksheet1->write_string(4, 6, "TGL LAHIR", $format);
        $worksheet1->set_column(4, 7, 15);	$worksheet1->write_string(4, 7, "USIA", $format);
        $worksheet1->set_column(4, 8, 15);	$worksheet1->write_string(4, 8, "PLAFOND", $format);
        $worksheet1->set_column(4, 9, 15);	$worksheet1->write_string(4, 9, "TUNTUTAN KLAIM", $format);
        $worksheet1->set_column(4, 10, 15);	$worksheet1->write_string(4, 10, "TGL AKAD", $format);
        $worksheet1->set_column(4, 11, 15);	$worksheet1->write_string(4, 11, "J.wkt(th)", $format);
        $worksheet1->set_column(4, 12, 15);	$worksheet1->write_string(4, 12, "DOL", $format);
        $worksheet1->set_column(4, 13, 15);	$worksheet1->write_string(4, 13, "AKAD s/d DOL (hari)", $format);
        $worksheet1->set_column(4, 14, 15);	$worksheet1->write_string(4, 14, "EM", $format);
        $worksheet1->set_column(4, 15, 15);	$worksheet1->write_string(4, 15, "DOKTER PEMERIKSA", $format);
        $worksheet1->set_column(4, 16, 15);	$worksheet1->write_string(4, 16, "DOKTER KLINIK", $format);
        $worksheet1->set_column(4, 17, 15);	$worksheet1->write_string(4, 17, "SPAK", $format);
        ...
        while ($jangkrik = mysql_fetch_array($kucing)) {
            $worksheet1->write_number($baris, 0, ++$no);
            $worksheet1->write_string($baris, 1, $jangkrik['cabang']);
            $worksheet1->write_string($baris, 2, $jangkrik['nmmitra']);
            $worksheet1->write_string($baris, 3, $jangkrik['nmproduk']);
            $worksheet1->write_string($baris, 4, $jangkrik['id_peserta']);
            $worksheet1->write_string($baris, 5, $jangkrik['nama']);
            $worksheet1->write_string($baris, 6, $jangkrik['tgl_lahir']);
            $worksheet1->write_string($baris, 7, $jangkrik['usia']);
            $worksheet1->write_number($baris, 8, $jangkrik['plafond']);
            $worksheet1->write_number($baris, 9, $jangkrik['tuntutan_klaim']);
            $worksheet1->write_string($baris, 10, $jangkrik['tglakad']);
            $worksheet1->write_number($baris, 11, $jangkrik['tenor']);
            $worksheet1->write_string($baris, 12, $jangkrik['tgl_klaim']);
            $worksheet1->write_number($baris, 13, $jangkrik['dolvsakad']);
            $worksheet1->write_string($baris, 14, $jangkrik['ext_premi']);
            $worksheet1->write_string($baris, 15, $jangkrik['dokter']);
            $worksheet1->write_string($baris, 16, $jangkrik['dokter_pemeriksa_klinik']);
            $worksheet1->write_string($baris, 17, $jangkrik['spak']);
