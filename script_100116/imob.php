...
WHERE fu_ajk_spak.`status` ="Pending" AND user_mobile.supervisor ="'.$mb['id'].'" AND fu_ajk_spak.del IS NULL AND fu_ajk_spak_form_temp.del IS NULL ORDER BY fu_ajk_spak.input_date DESC');
...
echo '<table border="0" width="100%">
		  ...
		  <tr><td colspan="4">Nomor Identitas : '.$metVPhoto['noidentitas'].'</td></tr>
		  <tr><td colspan="4">Nomor Token : '.$metVPhoto['token'].'</td></tr>
...
if ($mobUserSPK_['status']=="Aktif" OR $mobUserSPK_['status']=="Tolak") {
$metViewSPK = '<a href="aajk_report.php?er=_spk&ids='.$mobUserSPK_['id'].'" target="_blank">'.$mobUserSPK_['nama'].'</a>';
}else{
...
echo '<tr onmouseover="this.className=\'tbl-over\'" onmouseout="this.className=\'' . $objlass . '\'" class="' . $objlass . '">
		  ...
		  <td align="center">'._convertDate($mobUserSPK_['dob']).'</td>
		  <td align="center">'.$mobUserSPK_['x_usia'].'</td>
		  <td align="center">'.$mobUserSPK_['alamat'].'</td>
		  <td align="center">'._convertDate($mobUserSPK_['tgl_asuransi']).'</td>
		  <td align="center">'.$mobUserSPK_['tenor'].'</td>
		  <td align="center">'._convertDate($mobUserSPK_['tgl_akhir_asuransi']).'</td>
		  <td align="right">'.duit($mobUserSPK_['plafond']).'</td>
