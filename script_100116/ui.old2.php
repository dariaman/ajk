...
out('copyright', '<font size="2"><b>ADONAI | Pialang Asuransi</b><br />
				  Ruko Kalimalang Square No. 24 Blok X Jl. KH Noer Ali, Kalimalang Bekasi <br />
				  T. (021) 8895 0707. F. (021) 8895 5001/06<br />
				  &copy Copyright 2014, All Right Reserved</font></b>');

$met_spaksize = 1024; // max file size (1Mb)
	...
	if ($q['level'] >= 5 AND $q['level'] <= 99 AND $q['id_cost'] !="" AND $q['id_polis']=="1") {	//USER CLIENT//
			$_temp = "<div id='cssmenu'>
				<ul><li><a href='index.php'><span>Home</span></a></li>
					...
					<li class='displayname'>".$q['nm_lengkap']."</li>
				</ul>
			</div><br /><br />";
		}
				...
				<ul><li><a href='index.php'><span>Home</span></a></li>
					...
					<li class='has-sub'><a href='#'><span>Master Upload</span></a>
						<ul><li class='has-sub'><a href='ajk_uploader.php?er=spaj'><span>Upload Data Peserta SPAJ/SPD</span></a>
							<!--<li class='has-sub'><a href='ajk_uploader.php?er=spk'><span>Upload Data Peserta SPK</span></a>-->
							<li class='has-sub'><a href='#'><span>Validasi Data Upload</span></a>
							<ul><li class='last'><a href='ajk_val_upl.php?v=spaj'><span>Data SPAJ/SPD</span></a>
					...
					<li><a href='login.php?op=logout'><span>Logout</span></a></li>
					<li class='displayname'>".$q['nm_lengkap']."</li>
<!--<li class='active has-sub'><a href='#'><span>Master Account</span></a>
		<ul><li class='has-sub'><a href='#'><span>Product 1</span></a>
		<ul><li><a href='#'><span>Sub Product</span></a></li>
