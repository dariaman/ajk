...
*/
		...
		$metpeserta = mysql_fetch_array(mysql_query('SELECT id_cost,
															...
															id_dn
													FROM fu_ajk_peserta
													WHERE fu_ajk_peserta.id_cost="'.$met['id_cost'].'" AND fu_ajk_peserta.id_polis="'.$met['id_nopol'].'" AND fu_ajk_peserta.id_dn="'.$met['id'].'" AND fu_ajk_peserta.status_peserta IS NULL GROUP BY fu_ajk_peserta.id_dn'));
...
$peserta = mysql_query('SELECT *, ROUND(premi, 2) AS premi,
						...
						FROM fu_ajk_peserta WHERE id_dn = "'.$met['id'].'" AND id_cost="'.$met['id_cost'].'" AND id_polis="'.$met['id_nopol'].'"AND status_peserta IS NULL AND del IS NULL');
...
if ($metdata_form['filefotodebitursatu']!="") {
			$mamet_photonya = '../ajkmobilescript/'.$metdata_form['filefotodebiturdua'];
