...
echo '<tr><td colspan="22">';
echo createPageNavigations($file = 'ajk_peserta.php?cat='.$_REQUEST['cat'].'&subcat='.$_REQUEST['subcat'].'&cregional='.$_REQUEST['cregional'].'&snama='.$_REQUEST['snama'].'&tgl='.$_REQUEST['tgl'].'&tgl2='.$_REQUEST['tgl2'].'', $total = $totalRows, $psDeh = 10 , $anchor = '', $perPage = 50);
