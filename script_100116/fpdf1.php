...
function Output($name='', $dest='')
{
	...
	if($dest=='')
	{
		if($name=='')
		{
			if ($_REQUEST['fu']=="ajkpdfcn") {
				$metnamafile = mysql_fetch_array(mysql_query('SELECT * FROM fu_ajk_cn WHERE id="'.$_REQUEST['id'].'"'));	//	UNTUK MERENAME DATA SAAT DI DOWNLOAD
				$name = $metnamafile['id_cn'].'.pdf';
			}else{
				$metnamafile = mysql_fetch_array(mysql_query('SELECT * FROM fu_ajk_dn WHERE id="'.$_REQUEST['id'].'"'));	//	UNTUK MERENAME DATA SAAT DI DOWNLOAD
				$name = $metnamafile['dn_kode'].'.pdf';
			}
