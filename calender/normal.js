...
var gBegin=[2010,1,1];	// calendar date range begin from [Year,Month,Date]. Using gToday here will make it start from today.
var gEnd=[2014,12,31];	// calendar date range end at [Year,Month,Date]
