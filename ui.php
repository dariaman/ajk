...
function generateMenu()
{
	...
	if (isset($_SESSION['nm_user'])) { 
		...
		$q = mysql_fetch_array(mysql_query("SELECT * FROM pengguna WHERE nm_user= '". $_SESSION['nm_user'] ."' "));    
		
		//cek cabang
		$cabang = mysql_fetch_array(mysql_query("select * from fu_ajk_cabang where name = '".$q['cabang']."' and del is NULL and id_cost = '".$q['id_cost']."'"));
		//cek central
		$cabangcentral = mysql_query("select * from fu_ajk_cabang where centralcbg = '".$cabang['id']."' and del is NULL");
		...
		$qoutstanding = mysql_fetch_array(mysql_query("SELECT SUM(totalpremi)as outstanding
																										FROM fu_ajk_peserta 
...
elseif ($q['level'] == 6 AND $q['id_cost'] !="" AND $q['status']=="SUPERVISOR-ADMIN") {	//LEVEL SPV PUSAT//
$_temp = "<div id='cssmenu'>
			<ul><li><a href='index.php'><span>Home</span></a></li>
				<li class='has-sub'><a href='#'><span>Master Validasi</span></a>
					<ul><li class='has-sub'><a href='#'><span>Validasi Data Klaim</span></a>
						<ul><li class='last'><a href='ajk_val_batal.php'><span>Data Pembatalan Peserta</span></a>
							<li class='last'><a href='ajk_klaim.php?er=valRefund'><span>Data Refund Peserta</span></a>
							<li class='last'><a href='ajk_klaim.php?er=valKlaim'><span>Data Pengajuan Klaim</span></a>
						</ul>
					</ul>
				</li>
				<li><a href='ajk_re_claim.php?c=memocn'><span>Memorandum Creditnote</span></a></li>
				<li><a href='login.php?op=logout'><span>Logout</span></a></li>
				<li class='displayname'>".strtoupper($q['nm_lengkap'])." (".$q['cabang'].")</li>
	</ul>
	</div><br /><br />";
...
elseif ($q['level'] == 7 AND $q['id_cost'] !="" AND $q['id_polis']>1 OR $q['id_polis']=="") {	//PRODUK SELAIN SPK//
$_temp = "<div id='cssmenu'>
				<ul><li><a href='index.php'><span>Home</span></a></li>
					<!--<li class='has-sub'><a href='#'><span>Master Account</span></a>
						<ul><li class='has-sub'><a href='ajk_user.php'><span>Administrator</span></a>
					...
					<li class='has-sub'><a href='#'><span>Master Upload</span></a>
						<ul><li class='has-sub'><a href='ajk_uploader.php?er=spaj'><span>Upload Data Peserta SPAJ/SPD</span></a>
							<li class='has-sub'><a href='ajk_uplspak.php?el=fl_spk'><span>Upload Data Pesertaan SPK</span></a>
							<li class='has-sub'><a href='#'><span>Validasi Data</span></a>
							<ul><li class='last'><a href='ajk_val_upl.php?v=spaj'><span>Data Upload SPAJ/SPD</span></a>
								<li class='last'><a href='ajk_val_batal.php'><span>Data Pembatalan Peserta</span></a>
								<li class='last'><a href='ajk_klaim.php?er=valRefund'><span>Data Refund Peserta</span></a>
...
elseif ($q['level'] == 6 AND $q['id_cost'] !="" AND $q['status']=="SUPERVISOR-ADMIN") {	//LEVEL SPV PUSAT//
	...
	<ul><li><a href='index.php'><span>Home</span></a></li>
		...
		<li class='has-sub'><a href='#'><span>Master Data</span></a>
				<ul><li class='has-sub'><a href='ajk_peserta.php'><span>Data Kepesertaan</span></a>
					<li class='has-sub'><a href='ajk_nota.php?er=dn'><span>Data Debit Note</span></a>
					<li class='has-sub'><a href='ajk_nota.php?er=cn&req=btl'><span>Data Credit note (Pembatalan)</span></a>
					<li class='has-sub'><a href='ajk_nota.php?er=cn&req=ref'><span>Data Credit note (Refund)</span></a>
					<li class='has-sub'><a href='ajk_nota.php?er=cn&req=klm'><span>Data Credit note (Klaim)</span></a>
					<li class='has-sub'><a href='ajk_peserta.php?er=pending'><span>Data Pending/Medical SKKT</span></a>
					<li class='has-sub'><a href='ajk_md_spk.php'><span>Data File SPK</span></a>
				</ul>
		</li>
		...
		//elseif ($q['level'] == 7 AND $q['id_cost'] !="" AND $q['id_polis']==1 OR $q['id_polis']==7 OR $q['id_polis']==8 OR $q['id_polis']==9 OR $q['id_polis']==10 OR $q['id_polis']==12) {	//LEVEL 7 PRODUK SPK//
elseif($q['level'] == 98 AND $q['status']=="SUPERVISOR-ADMIN"){
	$_temp = "<div id='cssmenu'>
						<ul><li><a href='index.php'><span>Home</span></a></li>
							<!--<li class='has-sub'><a href='ajk_user.php'><span>Master Account</span></a>
								<ul><li class='has-sub'><a href='ajk_user.php'><span>Administrator</span></a>
							...
							<!--<li class='has-sub'><a href='#'><span>Master Upload SPK</span></a>
								<ul><li class='has-sub'><a href='ajk_uplspak.php'><span>Upload Data File SPK</span></a>
									<li class='has-sub'><a href='ajk_val_upl.php?v=spk'><span>Validasi Data Upload SPK</span></a>
									<li class='has-sub'><a href='ajk_val_upl.php?v=spkForm'><span>Form Data Kepesertaan SPK</span></a>
									<li class='has-sub'><a href='ajk_photo.php'><span>Upload Photo SPK</span></a>
							...
							<li><a href='ajk_acc.php?r=dlFLDK'><span>Download Format Deklarasi</span></a></li>
							-->
							<li class='has-sub'><a href='#'><span>Master Upload Deklarasi</span></a>
								<ul><li class='has-sub'><a href='ajk_uploader.php?er=tab'><span>Upload Data Peserta Tab</span></a>
									<li class='has-sub'><a href='ajk_uploader.php?er=spaj'><span>Upload Data Peserta SKKT</span></a>
									<li class='has-sub'><a href='ajk_uplspak.php?el=fl_spk'><span>Upload Data Kepesertaan SPK</span></a>
									<li class='has-sub'><a href='ajk_val_upl.php?v=fl_spk'><span>Validasi Data Kepesertaan SPK</span></a>
									<li class='has-sub'><a href='ajk_photo.php'><span>Upload Photo SPK</span></a>
								</ul>
							</li>
							<li class='has-sub'><a href='ajk_deklarasi.php'><span>Deklarasi</span></a>
							</li>										
							<li class='has-sub'><a href='#'><span>Master Validasi</span></a>
								<ul><li class='has-sub'><a href='#'><span>Validasi Data</span></a>
									<ul>									
										<!--<li class='last'><a href='ajk_val_upl.php?v=fl_spk'><span>Data Upload Kepesertaan</span></a>-->
										<li class='last'><a href='ajk_val_upl.php?v=spaj'><span>Data Upload Kepesertaan</span></a>
										<li class='last'><a href='ajk_val_batal.php'><span>Data Pembatalan Peserta</span></a>
										<li class='last'><a href='ajk_klaim.php?er=valRefund'><span>Data Refund Peserta</span></a>
										<li class='last'><a href='ajk_klaim.php?er=valKlaim'><span>Data Pengajuan Klaim</span></a>
									</ul>
							...
							<li class='has-sub'><a href='#'><span>Master Data</span></a>
								<ul><!--<li class='has-sub'><a href='ajk_peserta.php?er=_spk'><span>Data SPK</span></a>-->
									...
									<li class='has-sub'><a href='ajk_md_spk.php'><span>Data File SPK</span></a>
									<li class='has-sub'><a href='ajk_peserta.php?er=pending'><span>Data Pending/Medical SKKT</span></a>
									<li class='has-sub'><a href='ajk_peserta.php?er=rejectdata'><span>Data Penolakan Supervisor</span></a>
								</ul>
							</li>
							<li class='has-sub'><a href='#'><span>Master Klaim</span></a>
								<ul><li class='has-sub'><a href='#'><span>Data Refund</span></a>
									<ul><li class='last'><a href='ajk_klaim.php?er=reqrefund&r=tp'><span>Topup</span></a>
										<!--<li class='last'><a href='ajk_klaim.php?er=reqrefund&r=lp'><span>Pelunasan Dipercepat</span></a>-->
									</ul>
									<li class='has-sub'><a href='ajk_pembatalan.php?'><span>Data Pembatalan</span></a>
									<li class='has-sub'><a href='ajk_klaim.php?er=reqklaim'><span>Data Klaim</span></a>
								</ul>
							...
							<li class='has-sub'><a href='#'><span>Master Laporan</span></a>
								<ul><li class='has-sub'><a href='er_peserta.php'><span>Laporan Kepesertaan</span></a>
									<li class='has-sub'><a href='er_peserta.php?er=spk'><span>Laporan SPK</span></a>
									<li class='has-sub'><a href='er_peserta.php?er=pinjaman'><span>Laporan Pinjaman</span></a></ul>
							</li>
							<li class='has-sub'><a href='#'><span>Revisi</span></a>
								<ul>
									<li class='has-sub'><a href='ajk_revisi.php'><span>List Revisi</span></a>
								</ul>
							</li>
							<li class='has-sub'><a href='#'><span>Kalkulator</span></a>							
								<ul>
									<li class='has-sub'><a href='ajk_kalkulator.php'><span>Kalkulator Premi</span></a>
									<li class='has-sub'><a href='ajk_kalkulator.php?k=refund'><span>Kalkulator Refund</span></a>
								</ul>
							</li>
							<!--<li><a href='login.php?op=logout'><span>Logout</span></a></li> 160604 -->
							<li class='displayname has-sub'>".strtoupper($q['nm_lengkap'])." (".$q['cabang'].")
								<ul><li class='has-sub'><a href='ajk_acc.php?r=profile'><span>Profile</span></a></li>
									<li class='has-sub'><a href='ajk_acc.php?r=faq'><span>FAQ</span></a></li>
									<li class='has-sub'><a href='login.php?op=logout'><span>Logout</span></a></li>
								</ul>
							</li>
						</ul>
					</div><br /><br />";
}
elseif ($q['level'] == 7) {	//LEVEL 7 PRODUK SPK//
$_temp = "<div id='cssmenu'>
						<ul><li><a href='index.php'><span>Home</span></a></li>
							<!--<li class='has-sub'><a href='ajk_user.php'><span>Master Account</span></a>
								<ul><li class='has-sub'><a href='ajk_user.php'><span>Administrator</span></a>
							...
							<li class='has-sub'><a href='#'><span>Master Validasi</span></a>
								<ul><li class='has-sub'><a href='#'><span>Validasi Data</span></a>
									<ul><li class='last'><a href='ajk_val_upl.php?v=fl_spk'><span>Data Upload Kepesertaan</span></a>
										<li class='last'><a href='ajk_val_batal.php'><span>Data Pembatalan Peserta</span></a>
										<li class='last'><a href='ajk_klaim.php?er=valRefund'><span>Data Refund Peserta</span></a>
										<li class='last'><a href='ajk_klaim.php?er=valKlaim'><span>Data Pengajuan Klaim</span></a>
									</ul>
...
/*
   elseif ($q['level'] == 7) {	//PRODUK SELAIN SPK//
   $_temp = "<div id='cssmenu'>
   <ul><li><a href='index.php'><span>Home</span></a></li>
   <!--<li class='has-sub'><a href='#'><span>Master Account</span></a>
   <ul><li class='has-sub'><a href='ajk_user.php'><span>Administrator</span></a>
...
*/
elseif ($q['level'] == 6 AND $q['id_cost'] !="" AND $q['status']=="SUPERVISOR") {	//PRODUK SELAIN SPK//
$_temp = "<div id='cssmenu'>
						<ul><li><a href='index.php'><span>Home</span></a></li>
							<!--<li class='has-sub'><a href='#'><span>Master Account</span></a>
								<ul><li class='has-sub'><a href='ajk_user.php'><span>Administrator</span></a>
							...
							<!--<li class='has-sub'><a href='#'><span>Master Upload SPK</span></a>
								<ul><li class='has-sub'><a href='ajk_val_upl.php?v=spk'><span>Validasi Data Upload SPK</span></a>
									<li class='has-sub'><a href='ajk_val_upl.php?v=spkForm'><span>Form Data Kepesertaan SPK</span></a>
								</ul>
							</li>-->
							<li class='has-sub'><a href='#'><span>Master Validasi</span></a>
								<ul><li class='has-sub'><a href='#'><span>Validasi Data</span></a>
									<ul>
										<!--<li class='last'><a href='ajk_val_upl.php?v=spaj'><span>Data Upload Kepesertaan</span></a>-->
										<li class='last'><a href='ajk_deklarasi.php?hn=spaj'><span>Data Upload Kepesertaan</span></a>
										<li class='last'><a href='ajk_val_batal.php'><span>Data Pembatalan Peserta</span></a>
										<li class='last'><a href='ajk_klaim.php?er=valRefund'><span>Data Refund Peserta</span></a>
										<li class='last'><a href='ajk_klaim.php?er=valKlaim'><span>Data Pengajuan Klaim</span></a>
										<!--<li class='last'><a href='ajk_val_upl.php?v=spk'><span>Data SPK</span></a>-->
							...
							<li class='has-sub'><a href='#'><span>Revisi</span></a>
								<ul>
									<li class='has-sub'><a href='ajk_revisi.php?er=approve'><span>Approve Revisi</span></a>
									<li class='has-sub'><a href='ajk_revisi.php'><span>List Revisi</span></a>
								</ul>
							</li>

							<li style='float: center;''><a style='font-weight:bold;font-size: 15px;' href='ajk_outstandingpremi.php'><span>Total Outstanding : ".duit($qoutstanding['outstanding'])."</span></a>
...
/*
$jumProd = strlen($q['id_polis']);	//CARI JUMLAH PRODUK
$jDataProduk = $jumProd / 2;		//MEMBAGI 2 KARAKTER
$x = explode("|", $q['id_polis']); //PECAH PEMBATAS
$p_mamet = 0;
for ($i = 1; $i <= $jDataProduk; $i++) {
if ($p_mamet > 0) {	$_x = "OR";		}
	$mametProdukUser .= ' '.$_x.' id="'.$x[$p_mamet].'"';
	$p_mamet++;
}
*/
if (isset($_SESSION['nm_user'])){
	$charProduk = strpos($q['id_polis'], "|");
	if ($charProduk) {
		$jumProd = strlen($q['id_polis']);	//CARI JUMLAH PRODUK
		$jDataProduk = $jumProd / 2;		//MEMBAGI 2 KARAKTER
		$x = explode("|", $q['id_polis']); //PECAH PEMBATAS
		...
		for ($i = 1; $i <= $jDataProduk; $i++) {
			if ($p_mamet > 0) {	$_x = "OR";		}
			$mametProdukUser .= ' '.$_x.' id="'.$x[$p_mamet].'"';
			$mametProdukDebitur .= ' '.$_x.' id_polis="'.$x[$p_mamet].'"';
			$mametProdukUserDN .= ' '.$_x.' fu_ajk_dn.id_nopol="'.$x[$p_mamet].'"';
			$p_mamet++;
		}
	}
	else {
		//DISABLED AUTO LOGOUT
		//echo '<center><font color="red">User error, silahkan tentukan data produk. !</font></center><meta http-equiv="refresh" content="2; url=login.php?op=logout">';
	}
}
?>
